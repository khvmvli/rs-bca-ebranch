...
/* loaded from: classes-dex2jar.jar:o/setWindowTitle.class */
public class setWindowTitle implements Window.Callback {
    final Window.Callback e;

    public setWindowTitle(Window.Callback callback) {
        if (callback != null) {
            this.e = callback;
            return;
        }
