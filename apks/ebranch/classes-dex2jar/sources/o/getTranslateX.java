...
/* loaded from: classes-dex2jar.jar:o/getTranslateX.class */
public final class getTranslateX implements TypeEvaluator {
    private static final getTranslateX a = new getTranslateX();

    public static getTranslateX b() {
        return a;
    }
