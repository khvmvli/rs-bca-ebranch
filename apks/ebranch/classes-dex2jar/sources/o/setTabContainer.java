package o;
/* loaded from: classes-dex2jar.jar:o/setTabContainer.class */
final class setTabContainer {
    static setTabContainer a;
    public int b;
    public long c;
    public long e;
    ...
    public final void c(long j, double d, double d2) {
        ...
        if (sin2 >= 1.0d) {
            ...
            this.e = Math.round((round + acos) * 8.64E7d) + 946728000000L;
            long round2 = Math.round((round - acos) * 8.64E7d) + 946728000000L;
            this.c = round2;
            if (round2 >= j || this.e <= j) {
                this.b = 1;
            } else {
                this.b = 0;
            }
