...
/* loaded from: classes-dex2jar.jar:io/github/inflationx/calligraphy3/Calligraphy.class */
public class Calligraphy {
    ...
    protected static boolean isActionBarSubTitle(TextView textView) {
        ...
        if (parentIsToolbarV7(textView)) {
            return TextUtils.equals(((setInputType) textView.getParent()).h, textView.getText());
        }
        return false;
    }
    ...
    protected static boolean isActionBarTitle(TextView textView) {
        ...
        if (parentIsToolbarV7(textView)) {
            return TextUtils.equals(((setInputType) textView.getParent()).f, textView.getText());
        }
        return false;
    }
    ...
    protected static boolean parentIsToolbarV7(View view) {
        return CalligraphyUtils.canCheckForV7Toolbar() && view.getParent() != null && (view.getParent() instanceof setInputType);
    }
    ...
    void onViewCreatedInternal(View view, Context context, AttributeSet attributeSet) {
        if (view instanceof TextView) {
            ...
            if (!TypefaceUtils.isLoaded(textView.getTypeface())) {
                ...
                if (TextUtils.isEmpty(resolveFontPath)) {
                    ...
                    str = i != -1 ? CalligraphyUtils.pullFontPathFromTheme(context, styleForTextView[0], i, this.mAttributeId) : CalligraphyUtils.pullFontPathFromTheme(context, styleForTextView[0], this.mAttributeId);
                }
        ...
        if (CalligraphyUtils.canCheckForV7Toolbar() && (view instanceof setInputType)) {
            setInputType setinputtype = (setInputType) view;
            setinputtype.getViewTreeObserver().addOnGlobalLayoutListener(new ToolbarLayoutListener(this, context, setinputtype, (1) null));
        }
        if (view instanceof HasTypeface) {
            ...
            if (method != null && defaultTypeface2 != null) {
                ReflectionUtils.invokeMethod(view, method, new Object[]{defaultTypeface2});
            }
        }
    }
}
