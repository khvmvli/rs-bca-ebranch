...
/* loaded from: classes-dex2jar.jar:io/realm/internal/ObserverPairList.class */
public class ObserverPairList<T extends ObserverPair> {
    private List<T> pairs = new CopyOnWriteArrayList();
    private boolean cleared = false;

    /* loaded from: classes-dex2jar.jar:io/realm/internal/ObserverPairList$Callback.class */
    public interface Callback<T extends ObserverPair> {
        void onCalled(T t, Object obj);
    }

    /* loaded from: classes-dex2jar.jar:io/realm/internal/ObserverPairList$ObserverPair.class */
