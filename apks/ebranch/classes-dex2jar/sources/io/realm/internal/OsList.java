...
/* loaded from: classes-dex2jar.jar:io/realm/internal/OsList.class */
public class OsList implements NativeObject, ObservableCollection, OsCollection {
    ...
    public void addDecimal128(@Nullable Decimal128 decimal128) {
        if (decimal128 == null) {
            ...
            nativeAddDecimal128(this.nativePtr, decimal128.f, decimal128.g);
        }
    }
    ...
    public void insertDecimal128(long j, @Nullable Decimal128 decimal128) {
        if (decimal128 == null) {
            ...
            nativeInsertDecimal128(this.nativePtr, j, decimal128.f, decimal128.g);
        }
    }
