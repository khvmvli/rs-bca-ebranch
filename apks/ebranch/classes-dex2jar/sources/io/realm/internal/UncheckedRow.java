...
/* loaded from: classes-dex2jar.jar:io/realm/internal/UncheckedRow.class */
public class UncheckedRow implements NativeObject, Row {
    ...
    public long createEmbeddedObject(long j, RealmFieldType realmFieldType) {
        int i = 1.$SwitchMap$io$realm$RealmFieldType[realmFieldType.ordinal()];
        if (i == 1) {
            ...
            StringBuilder sb = new StringBuilder("Wrong parentPropertyType, expected OBJECT or LIST but received ");
    ...
    public void setDecimal128(long j, @Nullable Decimal128 decimal128) {
        ...
        if (decimal128 == null) {
            ...
            nativeSetDecimal128(this.nativePtr, j, decimal128.f, decimal128.g);
        }
    }
