...
/* loaded from: classes-dex2jar.jar:io/realm/exceptions/RealmFileException.class */
public class RealmFileException extends RuntimeException {
    private final Kind kind;

    /* loaded from: classes-dex2jar.jar:io/realm/exceptions/RealmFileException$Kind.class */
    public enum Kind {
        ACCESS_ERROR,
        BAD_HISTORY,
        PERMISSION_DENIED,
    ...
    public String toString() {
        return String.format(Locale.US, "%s Kind: %s.", toString(), this.kind);
    }
}
