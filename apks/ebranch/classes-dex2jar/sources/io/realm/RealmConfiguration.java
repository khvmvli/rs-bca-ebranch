...
/* loaded from: classes-dex2jar.jar:io/realm/RealmConfiguration.class */
public class RealmConfiguration {
    ...
    /* loaded from: classes-dex2jar.jar:io/realm/RealmConfiguration$Builder.class */
    public static class Builder {
        ...
        public Builder directory(File file) {
            if (file == null) {
                ...
                StringBuilder sb = new StringBuilder("'dir' is a file, not a directory: ");
                sb.append(file.getAbsolutePath());
                sb.append(".");
                throw new IllegalArgumentException(sb.toString());
            } else if (!file.exists() && !file.mkdirs()) {
                StringBuilder sb2 = new StringBuilder("Could not create the specified directory: ");
                ...
                StringBuilder sb3 = new StringBuilder("Realm directory is not writable: ");
        ...
        public Builder maxNumberOfActiveVersions(long j) {
            ...
            StringBuilder sb = new StringBuilder("Only positive numbers above 0 are allowed. Yours was: ");
            sb.append(j);
            throw new IllegalArgumentException(sb.toString());
        }
        ...
        public Builder schemaVersion(long j) {
            ...
            StringBuilder sb = new StringBuilder("Realm schema version numbers must be 0 (zero) or higher. Yours was: ");
            sb.append(j);
            throw new IllegalArgumentException(sb.toString());
        }
    }
    ...
    protected static RealmConfiguration forRecovery(String str, @Nullable byte[] bArr, RealmProxyMediator realmProxyMediator) {
        return new RealmConfiguration(new File(str), null, bArr, 0, null, false, OsRealmConfig.Durability.FULL, realmProxyMediator, null, null, null, true, null, true, Long.MAX_VALUE, false, true);
    }
    ...
    private static RealmProxyMediator getModuleMediator(String str) {
        ...
        try {
            ...
            StringBuilder sb2 = new StringBuilder("Could not create an instance of ");
            sb2.append(format);
            throw new RealmException(sb2.toString(), e2);
        } catch (InstantiationException e3) {
            StringBuilder sb3 = new StringBuilder("Could not create an instance of ");
            sb3.append(format);
            throw new RealmException(sb3.toString(), e3);
        } catch (InvocationTargetException e4) {
            StringBuilder sb4 = new StringBuilder("Could not create an instance of ");
            sb4.append(format);
    ...
    public int hashCode() {
        ...
        CompactOnLaunchCallback compactOnLaunchCallback = this.compactOnLaunch;
        int hashCode11 = compactOnLaunchCallback != null ? compactOnLaunchCallback.hashCode() : 0;
        boolean z3 = this.isRecoveryConfiguration;
        long j2 = this.maxNumberOfActiveVersions;
        return (((((((((((((((((((((((((((((hashCode * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + hashCode5) * 31) + i) * 31) + hashCode6) * 31) + (z ? 1 : 0)) * 31) + hashCode7) * 31) + hashCode8) * 31) + hashCode9) * 31) + hashCode10) * 31) + (z2 ? 1 : 0)) * 31) + hashCode11) * 31) + (z3 ? 1 : 0)) * 31) + ((int) ((j2 >>> 32) ^ j2));
    }
