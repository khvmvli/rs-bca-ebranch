...
/* loaded from: classes-dex2jar.jar:org/joda/time/field/FieldUtils.class */
public class FieldUtils {
    ...
    public static int safeAdd(int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder("The calculation caused an overflow: ");
        sb.append(i);
        sb.append(" + ");
        sb.append(i2);
    ...
    public static long safeDivide(long j, long j2) {
        ...
        StringBuilder sb = new StringBuilder("Multiplication overflows a long: ");
        sb.append(j);
        sb.append(" / ");
        sb.append(j2);
        throw new ArithmeticException(sb.toString());
    ...
    public static int safeMultiply(int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder("Multiplication overflows an int: ");
        sb.append(i);
        sb.append(" * ");
        sb.append(i2);
        throw new ArithmeticException(sb.toString());
    ...
    public static long safeMultiply(long j, int i) {
        if (i != -1) {
            ...
            StringBuilder sb2 = new StringBuilder("Multiplication overflows a long: ");
            sb2.append(j);
            sb2.append(" * ");
            sb2.append(i);
    ...
    public static int safeToInt(long j) {
        ...
        StringBuilder sb = new StringBuilder("Value cannot fit in an int: ");
        sb.append(j);
        throw new ArithmeticException(sb.toString());
    }
