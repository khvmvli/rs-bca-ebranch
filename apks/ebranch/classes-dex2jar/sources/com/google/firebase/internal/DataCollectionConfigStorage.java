...
public class DataCollectionConfigStorage {
    ...
    public DataCollectionConfigStorage(Context context, String str, Publisher publisher) {
        ...
        StringBuilder sb = new StringBuilder(FIREBASE_APP_PREFS);
        sb.append(str);
    ...
    private static Context directBootSafe(Context context) {
        return Build.VERSION.SDK_INT < 24 ? context : copyWindowDataInto.d(context);
    }
    ...
    private boolean readManifestDataCollectionEnabled() {
        ...
        try {
            ...
            if (packageManager == null || (applicationInfo = packageManager.getApplicationInfo(this.deviceProtectedContext.getPackageName(), Property.TYPE_ARRAY)) == null || applicationInfo.metaData == null || !applicationInfo.metaData.containsKey(DATA_COLLECTION_DEFAULT_ENABLED)) {
                return true;
            }
