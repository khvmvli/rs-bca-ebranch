...
import o.SyaratKetentuanActivity_ViewBinding;
import o.documentProvider;
import o.setOnStartEnterTransitionListener;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/ValueTodayDialog.class */
public class ValueTodayDialog extends BaseDialog {
    private YesNoAdapter a;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new SyaratKetentuanActivity_ViewBinding(this.data[this.a.b]));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.a = new YesNoAdapter(getContext(), this.d);
