...
import o.ReservasiSuccessEChannelActivity;
import o.documentProvider;
import o.setOnStartEnterTransitionListener;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/StatusPendudukDialog.class */
public class StatusPendudukDialog extends BaseDialog {
    private List<DaftarTransferAdapter$DaftarTransferVH> c = new ArrayList();
    private StatusNPWPAdapter d;
    @BindArray(2130903091)
    String[] data;
    private Unbinder e;
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131822268)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void bindViews(View view) {
        ...
        this.d = new StatusNPWPAdapter(getContext(), this.c);
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new ReservasiSuccessEChannelActivity(this.c.get(this.d.e).e));
    }
