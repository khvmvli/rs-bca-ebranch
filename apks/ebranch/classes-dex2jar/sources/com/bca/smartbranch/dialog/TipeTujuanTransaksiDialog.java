...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/TipeTujuanTransaksiDialog.class */
public class TipeTujuanTransaksiDialog extends BaseDialog {
    private List<DaftarTransferAdapter$DaftarTransferVH> b = new ArrayList();
    private Unbinder c;
    @BindArray(2130903100)
    String[] data;
    private StatusNPWPAdapter e;
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131822279)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void bindViews(View view) {
        ...
        this.e = new StatusNPWPAdapter(getContext(), this.b);
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new ResetAccountActivity(this.b.get(this.e.e).e));
    }
