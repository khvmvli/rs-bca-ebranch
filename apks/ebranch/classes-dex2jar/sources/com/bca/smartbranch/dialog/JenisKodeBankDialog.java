...
import com.bca.smartbranch.adapter.JenisKodeBankAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/JenisKodeBankDialog.class */
public class JenisKodeBankDialog extends BaseDialog {
    private JenisKodeBankAdapter a;
    private List<DaftarTransferAdapter$DaftarTransferVH> b = new ArrayList();
    private Unbinder d;
    @BindArray(2130903069)
    String[] jenisKartus;
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131821629)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new onClickMinus(this.jenisKartus[this.a.e]));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.a = new JenisKodeBankAdapter(getContext(), this.b);
