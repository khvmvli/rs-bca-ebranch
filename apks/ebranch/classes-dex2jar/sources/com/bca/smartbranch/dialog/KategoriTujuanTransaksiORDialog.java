...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/KategoriTujuanTransaksiORDialog.class */
public class KategoriTujuanTransaksiORDialog extends BaseDialog {
    private Unbinder a;
    private String[] b;
    private TujuanTransaksiAdapter d;
    private List<DaftarTransferAdapter$DaftarTransferVH> e = new ArrayList();
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131822233)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        if (this.d.e >= 0) {
            documentProvider.b().d(new onExitForm(this.d.e));
        }
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (arguments != null) {
            this.b = arguments.getStringArray("listdata");
            int i2 = 0;
            int i3 = 0;
            while (true) {
                i = i2;
                ...
                if (arguments.getString(Constants$ScionAnalytics$MessageType.DATA_MESSAGE, "").equals(this.b[i3])) {
                    i2 = i3;
                }
                i3++;
            }
        ...
        this.d = new TujuanTransaksiAdapter(getContext(), this.e);
