...
import com.bca.smartbranch.adapter.HariAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/HariDialog.class */
public class HariDialog extends BaseDialog {
    private HariAdapter c;
    private Unbinder d;
    ...
    public void bindViews(View view) {
        ...
        this.c = new HariAdapter(getContext(), this.e);
    ...
    public void onClickOk(View view) {
        ...
        this.tvError.setText("Hari belum dipilih");
    ...
    public void onSelectHari(UbahPINActivity ubahPINActivity) {
        this.tvError.setVisibility(8);
    }
