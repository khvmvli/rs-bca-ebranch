...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/PilihJenisIdentitasPemilikSumberDanaDialog.class */
public class PilihJenisIdentitasPemilikSumberDanaDialog extends BaseDialog {
    ...
    public void bindViews(View view) {
        ...
        if (arguments.getString("owner_id_type").equals("Perusahaan")) {
            this.c = getResources().getStringArray(2130903066);
        } else {
            this.c = getResources().getStringArray(2130903065);
        }
        if (arguments != null) {
            int i2 = 0;
            int i3 = 0;
            while (true) {
                ...
                if (arguments.getString(Constants$ScionAnalytics$MessageType.DATA_MESSAGE, "").equalsIgnoreCase(this.c[i3])) {
                    i2 = i3;
                }
                i3++;
            }
        ...
        this.b = new StatusNPWPAdapter(getContext(), this.a);
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new ReservasiCSOActivity(this.a.get(this.b.e).e));
    }
