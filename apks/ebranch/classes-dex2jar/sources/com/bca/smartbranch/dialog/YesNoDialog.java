...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/YesNoDialog.class */
public class YesNoDialog extends BaseDialog {
    private Unbinder a;
    private YesNoAdapter c;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new agree100JutaTarikan(this.data[this.c.b]));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.c = new YesNoAdapter(getContext(), this.d);
