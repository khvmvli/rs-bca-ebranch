...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/TujuanTransaksiORDialog.class */
public class TujuanTransaksiORDialog extends BaseDialog {
    private TujuanTransaksiAdapter b;
    private List<DaftarTransferAdapter$DaftarTransferVH> d = new ArrayList();
    @BindArray(2130903107)
    String[] dataTujuanTransaksi;
    private Unbinder e;
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131822314)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new SyaratKetentuanActivity(this.b.e));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            while (true) {
                i = i2;
                if (i3 >= this.dataTujuanTransaksi.length) {
                    break;
                }
                if (arguments.getString(Constants$ScionAnalytics$MessageType.DATA_MESSAGE, "").equals(this.dataTujuanTransaksi[i3])) {
                    i2 = i3;
                }
                i3++;
            }
        ...
        String[] strArr = this.dataTujuanTransaksi;
        int i4 = 0;
        ...
        this.b = new TujuanTransaksiAdapter(getContext(), this.d);
