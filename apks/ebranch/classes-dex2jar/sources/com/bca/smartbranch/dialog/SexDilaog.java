...
import com.bca.smartbranch.adapter.SexAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/SexDilaog.class */
public class SexDilaog extends BaseDialog {
    private Unbinder b;
    private SexAdapter c;
    private List<DaftarTransferAdapter$DaftarTransferVH> e = new ArrayList();
    @BindArray(2130903088)
    String[] listDataJenkel;
    @BindView(2131298321)
    setOnStartEnterTransitionListener rvContent;
    @BindString(2131822230)
    String title;
    @BindView(2131299615)
    TextView tvTitle;
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new onClickPilih(getTag(), this.c.e, this.listDataJenkel[this.c.e]));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            while (true) {
                i = i2;
                if (i3 >= this.listDataJenkel.length) {
                    break;
                }
                if (arguments.getString(Constants$ScionAnalytics$MessageType.DATA_MESSAGE, "").equals(this.listDataJenkel[i3])) {
                    i2 = i3;
                }
                i3++;
            }
        ...
        String[] strArr = this.listDataJenkel;
        int i4 = 0;
        ...
        this.c = new SexAdapter(getContext(), this.e);
