...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/TapresDialog.class */
public class TapresDialog extends BaseDialog {
    private Unbinder a;
    private Bundle c;
    private String d;
    @BindView(2131299282)
    TextView tvInfo;
    @BindString(2131822162)
    String txtInfo;
    ...
    public void fillForm(View view) {
        ...
        if (this.d.equals("Y")) {
            ...
            intent.putExtra("old_cust", this.d);
            startActivity(intent);
            return;
        }
        Intent intent2 = new Intent(getActivity(), AskAccountActivity.class);
        intent2.putExtra("product_type", "Tapres BCA");
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.c = arguments;
        this.d = arguments.getString("old_cust", "N");
    }
