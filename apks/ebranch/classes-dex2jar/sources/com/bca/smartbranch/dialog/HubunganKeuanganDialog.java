...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/HubunganKeuanganDialog.class */
public class HubunganKeuanganDialog extends BaseDialog {
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new togglePINConfirm(this.data[this.a.b]));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.a = new YesNoAdapter(getContext(), this.c);
