...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/PilihJenisIdentitasDialog.class */
public class PilihJenisIdentitasDialog extends BaseDialog {
    private StatusNPWPAdapter a;
    private Unbinder b;
    private List<DaftarTransferAdapter$DaftarTransferVH> d = new ArrayList();
    @BindArray(2130903067)
    String[] data;
    @BindView(2131298321)
    ...
    public void bindViews(View view) {
        ...
        this.a = new StatusNPWPAdapter(getContext(), this.d);
    ...
    public void clickPilih(View view) {
        getDialog().dismiss();
        documentProvider.b().d(new onRetry(this.d.get(this.a.e).e));
    }
