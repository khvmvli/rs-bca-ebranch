...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/BCADollarDialog.class */
public class BCADollarDialog extends BaseDialog {
    private Bundle c;
    private Unbinder d;
    private String e;
    @BindView(2131299282)
    TextView tvInfo;
    @BindString(2131821361)
    String txtInfo;
    ...
    public void fillForm(View view) {
        ...
        if (this.e.equals("Y")) {
            ...
            intent.putExtra("old_cust", this.e);
            startActivity(intent);
            return;
        }
        Intent intent2 = new Intent(getActivity(), AskAccountActivity.class);
        intent2.putExtra("product_type", "BCA Dollar");
    ...
    public void infoProduct(View view) {
        ...
        intent.putExtra("product_type", "BCA Dollar");
        intent.putExtra("old_cust", this.e);
        intent.putExtra("is_member", this.c.getBoolean("is_member", false));
        startActivity(intent);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.c = arguments;
        this.e = arguments.getString("old_cust", "N");
    }
