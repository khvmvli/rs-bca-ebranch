...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/dialog/TahapanXpresiDialog.class */
public class TahapanXpresiDialog extends BaseDialog {
    private String b;
    private Bundle c;
    private Unbinder d;
    @BindView(2131299282)
    TextView tvInfo;
    @BindString(2131822149)
    String txtInfo;
    ...
    public void fillForm(View view) {
        ...
        intent2.putExtra("product_type", "Tahapan Xpresi");
