...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiSFragment.class */
public class Page6DTahapanXpresiSFragment extends BaseFragment implements Validator.ValidationListener, CompoundButton.OnCheckedChangeListener, TextWatcher, CheckUserPresenter.RemoteActionCompatParcelizer {
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6DTahapanXpresiSFragment.5
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6DTahapanXpresiSFragment.this.getActivity()).n.setEmailIB("");
                ((FormActivity) Page6DTahapanXpresiSFragment.this.getActivity()).n.setFlagMB("");
                ((FormActivity) Page6DTahapanXpresiSFragment.this.getActivity()).n.setHphoneMB("");
            }
        });
        ...
        if (id != 2131298443) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00e2: IPUT  
                 ...
                 o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.Page6DTahapanXpresiSFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiSFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanXpresiSFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void");
        }
            ...
            if (this.etNoHp.getVisibility() == 0) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00b6: INVOKE  
                      (r0v135 'validator2' com.mobsandgeeks.saripaar.Validator)
                      (r0v137 'editText' android.widget.EditText)
                      (wrap: com.mobsandgeeks.saripaar.QuickRule[] : ?: FILLED_NEW_ARRAY  (r2v7 com.mobsandgeeks.saripaar.QuickRule[] A[REMOVE]) = 
                      (wrap: o.getPromotion$2 : 0x00b2: CONSTRUCTOR  
                      (r0v137 'editText' android.widget.EditText)
                      (r0v129 'confirmSubBCACardAdapter$ViewHolder' o.ConfirmSubBCACardAdapter$ViewHolder)
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.Page6DTahapanXpresiSFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiSFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanXpresiSFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
