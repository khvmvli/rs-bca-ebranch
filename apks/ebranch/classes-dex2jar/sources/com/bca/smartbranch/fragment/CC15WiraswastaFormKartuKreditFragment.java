...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC15WiraswastaFormKartuKreditFragment.class */
public class CC15WiraswastaFormKartuKreditFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher {
    private List<CategoryResponse> a;
    private List<CategoryResponse> d;
    @BindView(2131296931)
    @NotEmpty(messageResId = 2131820751, trim = true)
    @Order(6)
    EditText etAlamat;
    @BindView(2131296967)
    ...
    @BindView(2131297074)
    @NotEmpty(messageResId = 2131820755, trim = true)
    @Order(1)
    EditText etNama;
    @BindView(2131297219)
    ...
    static /* synthetic */ void a(CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment, EditText editText) {
        getPromotion.b(cC15WiraswastaFormKartuKreditFragment.tvErrors, cC15WiraswastaFormKartuKreditFragment.tilForms, cC15WiraswastaFormKartuKreditFragment.etFields, editText);
    }
    ...
    public void SubscribeExpired(final AgamaAdapter$AgamaVH_ViewBinding agamaAdapter$AgamaVH_ViewBinding) {
        ...
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC15WiraswastaFormKartuKreditFragment.5
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                CreditCard creditCard = ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n;
    ...
    public void afterTextChanged(final Editable editable) {
        ...
        if (!this.c.isInTransaction()) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC15WiraswastaFormKartuKreditFragment.3
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    if (editable == CC15WiraswastaFormKartuKreditFragment.this.etNama.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment, cC15WiraswastaFormKartuKreditFragment.etNama);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyName(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etAlamat.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment2 = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment2, cC15WiraswastaFormKartuKreditFragment2.etAlamat);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeAddress(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etKota.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment3 = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment3, cC15WiraswastaFormKartuKreditFragment3.etKota);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeCity(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etKodePos.getEditableText()) {
                        if (CC15WiraswastaFormKartuKreditFragment.this.tvErrors.get(CC15WiraswastaFormKartuKreditFragment.this.etFields.indexOf(CC15WiraswastaFormKartuKreditFragment.this.etKodePos)).getVisibility() == 0) {
                            if (CC15WiraswastaFormKartuKreditFragment.this.tvErrors.get(CC15WiraswastaFormKartuKreditFragment.this.etFields.indexOf(CC15WiraswastaFormKartuKreditFragment.this.etKodePos)).getText().toString().equals(CC15WiraswastaFormKartuKreditFragment.this.getString(2131820979))) {
                                if (CC15WiraswastaFormKartuKreditFragment.this.etKodePos.getText().toString().length() == 5) {
                                    List<TextView> list = CC15WiraswastaFormKartuKreditFragment.this.tvErrors;
                                    List<LogoutDialog_ViewBinding> list2 = CC15WiraswastaFormKartuKreditFragment.this.tilForms;
                                    int indexOf = CC15WiraswastaFormKartuKreditFragment.this.etFields.indexOf(CC15WiraswastaFormKartuKreditFragment.this.etKodePos);
                                    list.get(indexOf).setVisibility(8);
                                    list2.get(indexOf).setBackgroundResource(2131230847);
                                }
                            } else if (!CC15WiraswastaFormKartuKreditFragment.this.etKodePos.getText().toString().isEmpty()) {
                                List<TextView> list3 = CC15WiraswastaFormKartuKreditFragment.this.tvErrors;
                                List<LogoutDialog_ViewBinding> list4 = CC15WiraswastaFormKartuKreditFragment.this.tilForms;
                                int indexOf2 = CC15WiraswastaFormKartuKreditFragment.this.etFields.indexOf(CC15WiraswastaFormKartuKreditFragment.this.etKodePos);
                                list3.get(indexOf2).setVisibility(8);
                                list4.get(indexOf2).setBackgroundResource(2131230847);
                            }
                        }
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficePostCode(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etTlpKantor.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment4 = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment4, cC15WiraswastaFormKartuKreditFragment4.etTlpKantor);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficePhoneNumber(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etExtKantor.getEditableText()) {
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeExtensionNumber(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etJabatan.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment5 = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment5, cC15WiraswastaFormKartuKreditFragment5.etJabatan);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyPosition(editable.toString());
                    } else if (editable == CC15WiraswastaFormKartuKreditFragment.this.etJenisUsaha.getEditableText()) {
                        CC15WiraswastaFormKartuKreditFragment cC15WiraswastaFormKartuKreditFragment6 = CC15WiraswastaFormKartuKreditFragment.this;
                        CC15WiraswastaFormKartuKreditFragment.a(cC15WiraswastaFormKartuKreditFragment6, cC15WiraswastaFormKartuKreditFragment6.etJenisUsaha);
                        ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyBusinessType(editable.toString());
                    }
                }
            });
        }
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC15WiraswastaFormKartuKreditFragment.2
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyName("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyBusinessType("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrCompanyPosition("");
                if (((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.getCurrOfficeBusinessField() != null) {
                    ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.getCurrOfficeBusinessField().deleteFromRealm();
                }
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrWorkPeriod("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeAddress("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeCity("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficePostCode("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficePhoneNumber("");
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeExtensionNumber("");
            }
        });
    ...
    public void onChooseCategoryEvent(final CategoryListDialog.write write) {
        ...
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC15WiraswastaFormKartuKreditFragment.1
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                if (((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.getCurrOfficeBusinessField() != null) {
                    ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.getCurrOfficeBusinessField().deleteFromRealm();
                ...
                ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.setCurrOfficeBusinessField(category);
            }
        });
    ...
    public void onChooseValueSimpanDraft(ReservasiSuccessEChannelActivity_ViewBinding reservasiSuccessEChannelActivity_ViewBinding) {
        if (reservasiSuccessEChannelActivity_ViewBinding.d.equals("N")) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC15WiraswastaFormKartuKreditFragment.4
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    ((CC8FormKartuKreditActivity) CC15WiraswastaFormKartuKreditFragment.this.getActivity()).n.cascadeDelete();
                }
            });
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.d = ((CC8FormKartuKreditActivity) getActivity()).r;
