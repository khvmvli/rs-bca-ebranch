...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC25BFormKartuKreditFragment.class */
public class CC25BFormKartuKreditFragment extends BaseFragment {
    ...
    private ReviewBCACardAdapter i;
    private CreditCard j;
    private ReviewVisaAdapter k;
    ...
    private ReviewMastercardAdapter n;
    @BindView(2131298317)
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        e(2131296811, new CC23BFormKartuKreditFragment(), "CC23BFormKartuKreditFragment");
    }
    ...
    public void next(View view) {
        ...
        c(2131296811, new CC26BFormKartuKreditFragment(), "CC26BFormKartuKreditFragment");
    }
    ...
    public void onChooseValueSimpanDraft(ReservasiSuccessEChannelActivity_ViewBinding reservasiSuccessEChannelActivity_ViewBinding) {
        if (reservasiSuccessEChannelActivity_ViewBinding.d.equals("N")) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC25BFormKartuKreditFragment.4
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    ((CC8FormKartuKreditActivity) CC25BFormKartuKreditFragment.this.getActivity()).n.cascadeDelete();
                }
            });
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (((CC8FormKartuKreditActivity) getActivity()).n.getCreditCardSupplements().size() >= 2) {
            CreditCardSupplement creditCardSupplement = this.j.getCreditCardSupplements().get(1);
            ...
            this.h = this.g.getSupplementCardOptions().where().equalTo("cardGroupType", CardType.MASTER).findAll();
            this.l = this.g.getSupplementCardOptions().where().equalTo("cardGroupType", CardType.VISA).findAll();
        }
        this.i = new ReviewBCACardAdapter();
        this.n = new ReviewMastercardAdapter();
        this.k = new ReviewVisaAdapter();
        ...
        this.rvBcaCard.setAdapter(this.i);
        this.rvMasterCard.setAdapter(this.n);
        this.rvVisaCard.setAdapter(this.k);
        ReviewBCACardAdapter reviewBCACardAdapter = this.i;
        reviewBCACardAdapter.b = this.a;
        reviewBCACardAdapter.a.b();
        ReviewMastercardAdapter reviewMastercardAdapter = this.n;
        reviewMastercardAdapter.e = this.h;
        reviewMastercardAdapter.a.b();
        ReviewVisaAdapter reviewVisaAdapter = this.k;
    ...
    public void subscribeRemoveBCACardEvent(final BenefitAdapter$MyViewHolder benefitAdapter$MyViewHolder) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC25BFormKartuKreditFragment.5
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) CC25BFormKartuKreditFragment.this.a.where().equalTo("cardID", benefitAdapter$MyViewHolder.a).findFirst())).deleteFromRealm();
                CC25BFormKartuKreditFragment.this.i.a.b();
            }
        });
    }
    ...
    public void subscribeRemoveMasterCardEvent(final BenefitAdapter$MyViewHolder_ViewBinding benefitAdapter$MyViewHolder_ViewBinding) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC25BFormKartuKreditFragment.2
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) CC25BFormKartuKreditFragment.this.h.where().equalTo("cardID", benefitAdapter$MyViewHolder_ViewBinding.a).findFirst())).deleteFromRealm();
                CC25BFormKartuKreditFragment.this.n.a.b();
            }
        });
        if (this.n.c() <= 0) {
            this.llMasterCard.setVisibility(8);
    ...
    public void subscribeRemoveVisaCardEvent(final BidangPekerjaanAdapter$BidangPekerjaanVH bidangPekerjaanAdapter$BidangPekerjaanVH) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC25BFormKartuKreditFragment.1
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) CC25BFormKartuKreditFragment.this.l.where().equalTo("cardID", bidangPekerjaanAdapter$BidangPekerjaanVH.c).findFirst())).deleteFromRealm();
                CC25BFormKartuKreditFragment.this.k.a.b();
            }
        });
        if (this.k.c() <= 0) {
            this.llVisaCard.setVisibility(8);
    ...
    public void ubahBcaCard() {
        ...
        intent.putExtra("INDEX_CARD_SUPPLEMENT", 1);
