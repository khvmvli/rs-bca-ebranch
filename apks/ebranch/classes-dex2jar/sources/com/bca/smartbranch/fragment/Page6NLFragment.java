...
import o.setPadding;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6NLFragment.class */
public class Page6NLFragment extends BaseFragment implements TextWatcher, Validator.ValidationListener {
    private Validator d;
    @BindView(2131296944)
    @NotEmpty(messageResId = 2131820751, sequence = 3, trim = true)
    @Order(4)
    EditText etAlamat;
    @BindView(2131296967)
    @NotEmpty(messageResId = 2131820753, sequence = 2, trim = true)
    @Order(3)
    EditText etBidangUsaha;
    @BindViews({2131297078, 2131296992, 2131296967, 2131296944, 2131297033, 2131297022, 2131297161})
    List<View> etFields;
    @BindView(2131296992)
    ...
    @Order(6)
    @BindView(2131297022)
    @NotEmpty(messageResId = 2131820978, sequence = 5, trim = true)
    @Length(messageResId = 2131820979, min = 5, sequence = 6)
    EditText etKodePos;
    @BindView(2131297033)
    @NotEmpty(messageResId = 2131820761, sequence = 4, trim = true)
    @Order(5)
    EditText etKota;
    @BindView(2131297078)
    @NotEmpty(messageResId = 2131820755, sequence = 1, trim = true)
    @Order(1)
    EditText etNama;
    @BindView(2131297161)
    ...
    LinearLayout llMain;
    @BindView(2131298493)
    LogoutDialog_ViewBinding tilAlamatTempatUsaha;
    @BindView(2131298517)
    LogoutDialog_ViewBinding tilBidangUsaha;
    @BindViews({2131298624, 2131298541, 2131298517, 2131298493, 2131298580, 2131298568, 2131298697})
    ...
    @BindView(2131298624)
    LogoutDialog_ViewBinding tilNamaTempatUsaha;
    @BindView(2131298697)
    LogoutDialog_ViewBinding tilProvinsi;
    @BindViews({2131299100, 2131299016, 2131298996, 2131298972, 2131299056, 2131299045, 2131299164})
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6NLFragment.2
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6NLFragment.this.getActivity()).n.setOfficeName("");
                ((FormActivity) Page6NLFragment.this.getActivity()).n.setOfficeAddress("");
                ((FormActivity) Page6NLFragment.this.getActivity()).n.setOfficeProvince("");
                ((FormActivity) Page6NLFragment.this.getActivity()).n.setOfficeCity("");
                ((FormActivity) Page6NLFragment.this.getActivity()).n.setOfficePostCode("");
            }
        });
        e(2131296811, new Page6KL2Fragment(), "Page6KL2Fragment");
    }

    @OnFocusChange({2131297078, 2131296944, 2131296992, 2131296967})
    public void inputChange(View view, boolean z) {
        if (z) {
            switch (view.getId()) {
                case 2131296944:
                    this.tilAlamatTempatUsaha.setHintEnabled(true);
                    return;
                case 2131296967:
                ...
                case 2131296992:
                    ...
                    return;
                case 2131297078:
                    this.tilNamaTempatUsaha.setHintEnabled(true);
                    return;
                default:
                    return;
            }
            ...
            switch (view.getId()) {
                case 2131296944:
                    if (this.etAlamat.getText().toString().isEmpty()) {
                        this.tilAlamatTempatUsaha.setHintEnabled(false);
                        return;
                    }
                    return;
                case 2131296967:
                ...
                case 2131297078:
                    if (this.etNama.getText().toString().isEmpty()) {
                        this.tilNamaTempatUsaha.setHintEnabled(false);
                        return;
                    }
                    return;
                default:
    ...
    @OnClick({2131296992, 2131296967})
    public void onChoose(View view) {
    }

    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseBidangUsaha(ProfileActivity_ViewBinding profileActivity_ViewBinding) {
        this.tilBidangUsaha.setHintEnabled(true);
        this.etBidangUsaha.setText(profileActivity_ViewBinding.c);
    }

    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseJabatan(PilihKantorCabangEChannelActivity pilihKantorCabangEChannelActivity) {
        this.tilJabatan.setHintEnabled(true);
        this.etJabatan.setText(pilihKantorCabangEChannelActivity.e);
        this.tilBidangUsaha.setHintEnabled(false);
        this.etBidangUsaha.setText("");
    }
            ...
            if (view instanceof EditText) {
                ...
                switch (view.getId()) {
                    case 2131296944:
                        ...
                        this.tilAlamatTempatUsaha.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131296967:
                    ...
                    case 2131297078:
                        ...
                        this.tilNamaTempatUsaha.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131297161:
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((FormActivity) getActivity()).n.setCurrentPage("Page6NLFragment");
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x01b6: INVOKE  
              (wrap: android.widget.EditText : 0x01ac: IGET  (r0v68 android.widget.EditText A[REMOVE]) = (r4v0 'this' com.bca.smartbranch.fragment.Page6NLFragment A[IMMUTABLE_TYPE, THIS]) com.bca.smartbranch.fragment.Page6NLFragment.etAlamat android.widget.EditText)
             ...
             type: VIRTUAL call: android.view.View.setOnTouchListener(android.view.View$OnTouchListener):void in method: com.bca.smartbranch.fragment.Page6NLFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6NLFragment.class
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6NLFragment.onViewCreated(android.view.View, android.os.Bundle):void");
    }
}
