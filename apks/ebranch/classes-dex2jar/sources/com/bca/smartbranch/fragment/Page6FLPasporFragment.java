...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6FLPasporFragment.class */
public class Page6FLPasporFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher, showInfoValueTodayOR.MediaBrowserCompat.CustomActionResultReceiver, RadioGroup.OnCheckedChangeListener {
    private Validator a;
    private int d;
    @BindViews({2131297103, 2131297044, 2131297077, 2131297080})
    List<View> etFields;
    @BindView(2131296981)
    EditText etFotoDiri;
    @BindView(2131296982)
    EditText etFotoID;
    @BindView(2131297044)
    @NotEmpty(messageResId = 2131820785, trim = true)
    @Order(4)
    EditText etMasaBerlaku;
    @BindView(2131297077)
    @NotEmpty(messageResId = 2131820873, trim = true)
    @Order(1)
    EditText etNamaSesuai;
    @BindView(2131297080)
    @NotEmpty(messageResId = 2131820772, trim = true)
    @Order(3)
    EditText etNegaraPaspor;
    @BindView(2131297103)
    @NotEmpty(messageResId = 2131820917, trim = true)
    @Order(2)
    ...
    @BindViews({2131298649, 2131298591, 2131298623, 2131298626})
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6FLPasporFragment.1
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setFotoKtp("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setNumberID("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setExpID("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setName("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setFotoPribadi("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setSex("");
                ((FormActivity) Page6FLPasporFragment.this.getActivity()).n.setCitizenValue("");
            }
        });
    ...
    public void onChooseNegara(PilihNegaraActivity_ViewBinding pilihNegaraActivity_ViewBinding) {
        d(this.etFields.indexOf(this.etNegaraPaspor));
        this.etNegaraPaspor.setError(null);
        this.tilNegaraPaspor.setHintEnabled(true);
        this.etNegaraPaspor.setText(pilihNegaraActivity_ViewBinding.e);
        ((FormActivity) getActivity()).n.setCitizen(pilihNegaraActivity_ViewBinding.a);
        ((FormActivity) getActivity()).n.setCitizenValue(pilihNegaraActivity_ViewBinding.e);
    ...
    @OnClick({2131297080})
    public void onClickNegaraPaspor(View view) {
            ...
            if (view instanceof EditText) {
                ...
                switch (view.getId()) {
                    ...
                    case 2131297080:
                        ...
                        this.tilNegaraPaspor.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131297103:
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((FormActivity) getActivity()).n.setCurrentPage("Page6FLPasporFragment");
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00a8: INVOKE  
             ...
             type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.Page6FLPasporFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6FLPasporFragment.class
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6FLPasporFragment.onViewCreated(android.view.View, android.os.Bundle):void");
    }
