...
import o.setPadding;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6ILFragment.class */
public class Page6ILFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher {
    private Validator a;
    @BindView(2131296927)
    @NotEmpty(messageResId = 2131820719, sequence = 2, trim = true)
    @Order(2)
    EditText etAlamat;
    @BindViews({2131296927, 2131297167, 2131297170, 2131297014, 2131297011, 2131297033, 2131297022, 2131297161, 2131297080})
    List<View> etFields;
    @BindView(2131297011)
    ...
    @BindView(2131297014)
    @NotEmpty(messageResId = 2131821029, sequence = 6, trim = true)
    @Order(6)
    ...
    EditText etKodePos;
    @BindView(2131297033)
    @NotEmpty(messageResId = 2131820761, sequence = 8, trim = true)
    @Order(8)
    EditText etKota;
    @BindView(2131297080)
    @NotEmpty(messageResId = 2131820981, sequence = 1, trim = true)
    @Order(1)
    EditText etNegara;
    @BindView(2131297161)
    ...
    @BindViews({2131298476, 2131298703, 2131298706, 2131298560, 2131298557, 2131298580, 2131298568, 2131298697, 2131298626})
    ...
    @BindViews({2131298956, 2131299171, 2131299174, 2131299037, 2131299034, 2131299056, 2131299045, 2131299164, 2131299102})
    ...
    private void a(EditText editText) {
        if (this.tvErrors.get(this.etFields.indexOf(editText)).getVisibility() == 0 && !editText.getText().toString().isEmpty()) {
            c(this.etFields.indexOf(editText));
        }
    }
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (editable == this.etAlamat.getEditableText()) {
            ...
            ((FormActivity) getActivity()).n.setHmVillage(editable.toString());
        } else if (editable == this.etKecamatan.getEditableText()) {
            ((FormActivity) getActivity()).n.setHmSubDistrict(editable.toString());
        } else if (editable == this.etKota.getEditableText()) {
            ((FormActivity) getActivity()).n.setHmCity(editable.toString());
        } else if (editable == this.etKodePos.getEditableText()) {
            ((FormActivity) getActivity()).n.setHmPostCode(editable.toString());
        } else if (editable == this.etProvinsi.getEditableText()) {
            ((FormActivity) getActivity()).n.setHmProvince(editable.toString());
        } else if (editable == this.etNegara.getEditableText()) {
            ((FormActivity) getActivity()).n.setHmCountry(editable.toString());
        }
    }
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6ILFragment.1
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmAddress("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmRT("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmRW("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmVillage("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmSubDistrict("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmCity("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmPostCode("");
                ((FormActivity) Page6ILFragment.this.getActivity()).n.setHmProvince("");
            }
        });
        e(2131296811, new Page6HLFragment(), "Page6HLFragment");
    }
    ...
    public void onChooseKecamatan(onChooseKelurahan onchoosekelurahan) {
        c(this.etFields.indexOf(this.etKecamatan));
        c(this.etFields.indexOf(this.etKelurahan));
        c(this.etFields.indexOf(this.etKodePos));
        ...
        ((FormActivity) getActivity()).n.setHmSubDistrict(onchoosekelurahan.a);
    ...
    public void onChooseKelurahan(PilihKecamatanActivity_ViewBinding pilihKecamatanActivity_ViewBinding) {
        ...
        ((FormActivity) getActivity()).n.setHmVillage(pilihKecamatanActivity_ViewBinding.e);
        ((FormActivity) getActivity()).n.setHmPostCode("");
    }
    ...
    public void onChooseKodePos(onChooseKodePosHome onchoosekodeposhome) {
        ...
        ((FormActivity) getActivity()).n.setHmPostCode(onchoosekodeposhome.e);
    }

    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseKota(onChooseKotaKantor onchoosekotakantor) {
        c(this.etFields.indexOf(this.etKota));
        c(this.etFields.indexOf(this.etKecamatan));
        c(this.etFields.indexOf(this.etKelurahan));
        c(this.etFields.indexOf(this.etKodePos));
        ...
        ((FormActivity) getActivity()).n.setHmCity(onchoosekotakantor.a);
    ...
    public void onChooseNegara(PilihNegaraActivity_ViewBinding pilihNegaraActivity_ViewBinding) {
        c(this.etFields.indexOf(this.etNegara));
        ...
        ((FormActivity) getActivity()).n.setHmCountry(pilihNegaraActivity_ViewBinding.e);
    }

    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseProvinsi(PilihNegaraORActivity pilihNegaraORActivity) {
        c(this.etFields.indexOf(this.etProvinsi));
        c(this.etFields.indexOf(this.etKota));
        c(this.etFields.indexOf(this.etKecamatan));
        c(this.etFields.indexOf(this.etKelurahan));
        c(this.etFields.indexOf(this.etKodePos));
        ...
        ((FormActivity) getActivity()).n.setHmProvince(pilihNegaraORActivity.b);
    ...
    public void onClickNegara(View view) {
        Intent intent = new Intent(getContext(), PilihNegaraActivity.class);
        if (((FormActivity) getActivity()).n.getTypeID().equals("Paspor")) {
            intent.putExtra("type", "Paspor");
        }
        startActivity(intent);
    }
                ...
                switch (view.getId()) {
                    case 2131296927:
                        ...
                        if (((FormActivity) getActivity()).n.getTypeID().equals("KTP")) {
                            TextView textView = this.tvErrors.get(0);
                            StringBuilder sb = new StringBuilder();
                            sb.append(getString(2131821060));
                            sb.append(" belum diisi");
                            textView.setText(sb.toString());
                        } else if (((FormActivity) getActivity()).n.getTypeID().equals("Paspor")) {
                            TextView textView2 = this.tvErrors.get(0);
                            StringBuilder sb2 = new StringBuilder();
                            sb2.append(getString(2131821061));
                            sb2.append(" belum diisi");
                            textView2.setText(sb2.toString());
                        } else if (((FormActivity) getActivity()).n.getTypeID().equals("Kartu Pelajar")) {
                            TextView textView3 = this.tvErrors.get(0);
                            StringBuilder sb3 = new StringBuilder();
                            sb3.append(getString(2131821059));
                    ...
                    case 2131297080:
                        ...
                        TextView textView4 = this.tvErrors.get(8);
                        StringBuilder sb4 = new StringBuilder();
                        sb4.append(getString(2131821156));
                        sb4.append(" belum dipilih");
    ...
    public void onValidationSucceeded() {
        ...
        c(2131296811, new Page6JLFragment(), "Page6JLFragment");
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((FormActivity) getActivity()).n.setCurrentPage("Page6ILFragment");
        if (((FormActivity) getActivity()).n.getTypeID().equals("KTP")) {
            this.tvTitle.setText(getActivity().getResources().getString(2131821835));
            this.etAlamat.setHint(getActivity().getResources().getString(2131821060));
            this.tilNegara.setVisibility(8);
            this.llKtp.setVisibility(0);
        } else if (((FormActivity) getActivity()).n.getTypeID().equals("Paspor")) {
            this.tvTitle.setText(getActivity().getResources().getString(2131821836));
            this.etAlamat.setHint(getActivity().getResources().getString(2131821061));
            this.tilNegara.setVisibility(0);
            this.tilNegara.setHint(getActivity().getResources().getString(2131821156));
            this.llKtp.setVisibility(8);
        } else if (((FormActivity) getActivity()).n.getTypeID().equals("Kartu Pelajar")) {
            this.tvTitle.setText(getActivity().getResources().getString(2131821834));
            this.etAlamat.setHint(getActivity().getResources().getString(2131821059));
            this.tilNegara.setVisibility(8);
            this.llKtp.setVisibility(0);
        }
        this.etNegara.setText(((FormActivity) getActivity()).n.getHmCountry());
        if (!((FormActivity) getActivity()).n.getHmCountry().isEmpty()) {
            this.tilNegara.setHintEnabled(true);
        }
        this.etAlamat.setText(((FormActivity) getActivity()).n.getHmAddress());
        if (!((FormActivity) getActivity()).n.getHmAddress().isEmpty()) {
            this.tilAlamat.setHintEnabled(true);
        }
        this.etAlamat.setOnTouchListener(
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x01d5: INVOKE  
              (wrap: android.widget.EditText : 0x01cb: IGET  (r0v46 android.widget.EditText A[REMOVE]) = (r4v0 'this' com.bca.smartbranch.fragment.Page6ILFragment A[IMMUTABLE_TYPE, THIS]) com.bca.smartbranch.fragment.Page6ILFragment.etAlamat android.widget.EditText)
              (wrap: o.getPromotion$4 : 0x01d2: CONSTRUCTOR  (r1v21 o.getPromotion$4 A[REMOVE]) =  call: o.getPromotion.4.<init>():void type: CONSTRUCTOR)
             type: VIRTUAL call: android.view.View.setOnTouchListener(android.view.View$OnTouchListener):void in method: com.bca.smartbranch.fragment.Page6ILFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6ILFragment.class
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6ILFragment.onViewCreated(android.view.View, android.os.Bundle):void");
    }
}
