...
import o.setBranchName;
import o.setMessage;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/TReviewTarikanFragment.class */
public class TReviewTarikanFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher {
    ...
    public void onClickInfo(View view) {
        ...
        bundle.putString("MessageDialogTitle", getString(2131821716));
        bundle.putString("MessageDialogContent", getString(2131821727));
    ...
    public void onClickUbahDataTransaksi(View view) {
        ...
        setBranchName setbranchname = new Runnable() { // from class: o.setBranchName
            @Override // java.lang.Runnable
            public final void run() {
                TReviewTarikanFragment tReviewTarikanFragment = TReviewTarikanFragment.this;
                EditText editText = null;
                for (int size = tReviewTarikanFragment.viewGroupTransaksi.size() - 1; size >= 0; size--) {
                    tReviewTarikanFragment.viewGroupTransaksi.get(size).setEnabled(true);
                    editText = editText;
                    if (tReviewTarikanFragment.viewGroupTransaksi.get(size).getVisibility() == 0) {
                        editText = editText;
                        if (tReviewTarikanFragment.viewGroupTransaksi.get(size).isFocusable()) {
                            editText = (EditText) tReviewTarikanFragment.viewGroupTransaksi.get(size);
                        }
                    }
                }
                if (editText != null) {
        ...
        if (this.llLayoutDataTransaksi.getVisibility() == 8) {
            ...
            new Handler().postDelayed(setbranchname, 300);
        } else {
            setbranchname.run();
        }
    ...
    public void onValidationSucceeded() {
        ...
        c(2131296811, new ProsesTarikanFragment(), "ProsesTarikanFragment");
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.etEmail.setText(((TarikanTransaksiActivity) getActivity()).f.getEmail());
        EditText editText = this.etJumlah;
        StringBuilder sb = new StringBuilder();
        sb.append(getPromotion.i(((TarikanTransaksiActivity) getActivity()).f.getJumlah()));
        sb.append(" IDR");
        ...
        if (((TarikanTransaksiActivity) getActivity()).r != null) {
            ...
            sb2.append(((TarikanTransaksiActivity) getActivity()).r.getBranchName());
            sb2.append(" (");
            sb2.append(((TarikanTransaksiActivity) getActivity()).r.getBranchType());
            sb2.append(")");
    ...
    public void showDataTransaksi(View view) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x006f: IPUT  
             ...
             o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.TReviewTarikanFragment.showDataTransaksi(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/TReviewTarikanFragment.class
        ...
        L_0x0053:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.TReviewTarikanFragment.showDataTransaksi(android.view.View):void");
    }
}
