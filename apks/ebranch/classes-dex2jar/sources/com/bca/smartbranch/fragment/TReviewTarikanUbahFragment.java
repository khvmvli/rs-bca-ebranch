...
import o.setMessage;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/TReviewTarikanUbahFragment.class */
public class TReviewTarikanUbahFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher {
    ...
    public void onClickUbahDataTransaksi(View view) {
        ...
        setLatitude setlatitude = new Runnable() { // from class: o.setLatitude
            @Override // java.lang.Runnable
            public final void run() {
                TReviewTarikanUbahFragment tReviewTarikanUbahFragment = TReviewTarikanUbahFragment.this;
                EditText editText = null;
                for (int size = tReviewTarikanUbahFragment.viewGroupTransaksi.size() - 1; size >= 0; size--) {
                    tReviewTarikanUbahFragment.viewGroupTransaksi.get(size).setEnabled(true);
                    editText = editText;
                    if (tReviewTarikanUbahFragment.viewGroupTransaksi.get(size).getVisibility() == 0) {
                        editText = editText;
                        if (tReviewTarikanUbahFragment.viewGroupTransaksi.get(size).isFocusable()) {
                            editText = (EditText) tReviewTarikanUbahFragment.viewGroupTransaksi.get(size);
                        }
                    }
                }
                if (editText != null) {
        ...
        if (this.llLayoutDataTransaksi.getVisibility() == 8) {
            ...
            new Handler().postDelayed(setlatitude, 300);
        } else {
            setlatitude.run();
        }
    ...
    public void onValidationSucceeded() {
        ...
        ((TarikanUbahTransaksiActivity) getActivity()).s();
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.etEmail.setText(((TarikanUbahTransaksiActivity) getActivity()).f.getTxnDetail().getEmail());
        EditText editText = this.etJumlah;
        StringBuilder sb = new StringBuilder();
        sb.append(getPromotion.i(((TarikanUbahTransaksiActivity) getActivity()).f.getTxnDetail().getTxnAmount()));
        sb.append(" IDR");
        ...
        int i = 0;
        if (((TarikanUbahTransaksiActivity) getActivity()).q != null) {
            this.llCabang.setVisibility(0);
            this.tilEmail.setVisibility(8);
            this.llEmailDisabled.setVisibility(8);
            this.d.removeRules(this.etEmail);
            TextView textView = this.tvCabang;
            StringBuilder sb2 = new StringBuilder("BCA ");
            sb2.append(((TarikanUbahTransaksiActivity) getActivity()).q.getBranchType());
            sb2.append(" ");
            sb2.append(((TarikanUbahTransaksiActivity) getActivity()).q.getBranchName());
    ...
    public void showDataTransaksi(View view) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x006f: IPUT  
             ...
             o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.TReviewTarikanUbahFragment.showDataTransaksi(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/TReviewTarikanUbahFragment.class
        ...
        L_0x0053:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.TReviewTarikanUbahFragment.showDataTransaksi(android.view.View):void");
    }
}
