...
import o.setPadding;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6LLFragment.class */
public class Page6LLFragment extends BaseFragment implements TextWatcher, Validator.ValidationListener {
    private Validator a;
    @BindView(2131296943)
    @NotEmpty(messageResId = 2131820990, sequence = 2, trim = true)
    @Order(4)
    EditText etAlamat;
    @BindView(2131296967)
    ...
    @BindViews({2131297076, 2131296943, 2131297033, 2131297022, 2131296992, 2131296967, 2131297161})
    List<View> etFields;
    @BindView(2131296992)
    ...
    @Order(6)
    @BindView(2131297022)
    @NotEmpty(messageResId = 2131820978, sequence = 4, trim = true)
    @Length(messageResId = 2131820979, min = 5, sequence = 5)
    EditText etKodePos;
    @BindView(2131297033)
    @NotEmpty(messageResId = 2131820761, sequence = 3, trim = true)
    @Order(5)
    EditText etKota;
    @BindView(2131297076)
    @NotEmpty(messageResId = 2131820992, sequence = 1, trim = true)
    @Order(1)
    EditText etNama;
    @BindView(2131297161)
    ...
    LinearLayout llMain;
    @BindView(2131298492)
    LogoutDialog_ViewBinding tilAlamatSekolah;
    @BindView(2131298517)
    LogoutDialog_ViewBinding tilBidangUsaha;
    @BindViews({2131298622, 2131298492, 2131298580, 2131298568, 2131298541, 2131298517, 2131298697})
    ...
    @BindView(2131298622)
    LogoutDialog_ViewBinding tilNamaSekolah;
    @BindView(2131298697)
    LogoutDialog_ViewBinding tilProvinsi;
    @BindViews({2131299098, 2131298971, 2131299056, 2131299045, 2131299016, 2131298996, 2131299164})
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6LLFragment.1
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6LLFragment.this.getActivity()).n.setOfficeName("");
                ((FormActivity) Page6LLFragment.this.getActivity()).n.setOfficeAddress("");
                ((FormActivity) Page6LLFragment.this.getActivity()).n.setOfficeProvince("");
                ((FormActivity) Page6LLFragment.this.getActivity()).n.setOfficeCity("");
                ((FormActivity) Page6LLFragment.this.getActivity()).n.setOfficePostCode("");
            }
        });
        e(2131296811, new Page6KL2Fragment(), "Page6KL2Fragment");
    }

    @OnFocusChange({2131297076, 2131296943, 2131296992, 2131296967})
    public void inputChange(View view, boolean z) {
        if (z) {
            switch (view.getId()) {
                case 2131296943:
                    this.tilAlamatSekolah.setHintEnabled(true);
                    return;
                case 2131296967:
                ...
                case 2131296992:
                    ...
                    return;
                case 2131297076:
                    this.tilNamaSekolah.setHintEnabled(true);
                    return;
                default:
                    return;
            }
            ...
            switch (view.getId()) {
                case 2131296943:
                    if (this.etAlamat.getText().toString().isEmpty()) {
                        this.tilAlamatSekolah.setHintEnabled(false);
                        return;
                    }
                    return;
                case 2131296967:
                ...
                case 2131297076:
                    if (this.etNama.getText().toString().isEmpty()) {
                        this.tilNamaSekolah.setHintEnabled(false);
                        return;
                    }
                    return;
                default:
            ...
            if (view instanceof EditText) {
                ...
                switch (view.getId()) {
                    case 2131296943:
                        ...
                        this.tilAlamatSekolah.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131296967:
                    ...
                    case 2131297076:
                        ...
                        this.tilNamaSekolah.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131297161:
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((FormActivity) getActivity()).n.setCurrentPage("Page6LLFragment");
        if (!((FormActivity) getActivity()).n.getOccupationFlagFreeText().equals("N")) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x01b6: INVOKE  
              (wrap: android.widget.EditText : 0x01ac: IGET  (r0v68 android.widget.EditText A[REMOVE]) = (r4v0 'this' com.bca.smartbranch.fragment.Page6LLFragment A[IMMUTABLE_TYPE, THIS]) com.bca.smartbranch.fragment.Page6LLFragment.etAlamat android.widget.EditText)
             ...
             type: VIRTUAL call: android.view.View.setOnTouchListener(android.view.View$OnTouchListener):void in method: com.bca.smartbranch.fragment.Page6LLFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6LLFragment.class
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6LLFragment.onViewCreated(android.view.View, android.os.Bundle):void");
    }
}
