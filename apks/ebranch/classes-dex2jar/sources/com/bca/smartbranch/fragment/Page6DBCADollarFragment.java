...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DBCADollarFragment.class */
public class Page6DBCADollarFragment extends BaseFragment implements Validator.ValidationListener, CompoundButton.OnCheckedChangeListener, TextWatcher, RadioGroup.OnCheckedChangeListener, CheckUserPresenter.RemoteActionCompatParcelizer, GetAcctOpeningCategoryDataPresenter.RemoteActionCompatParcelizer {
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6DBCADollarFragment.2
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setLanguage("");
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setFlagIB("");
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setEmailIB("");
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setFlagMB("");
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setHphoneMB("");
                ((FormActivity) Page6DBCADollarFragment.this.getActivity()).n.setDollarCurrCode("");
            }
        });
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        if (id != 2131298443) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00e3: IPUT  
                 ...
                 o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.Page6DBCADollarFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DBCADollarFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DBCADollarFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void");
        }
        ...
        public void onViewCreated(android.view.View r11, android.os.Bundle r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DBCADollarFragment.onViewCreated(android.view.View, android.os.Bundle):void");
        }
