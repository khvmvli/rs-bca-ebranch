...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiFragment.class */
public class Page6DTahapanXpresiFragment extends BaseFragment implements Validator.ValidationListener, CompoundButton.OnCheckedChangeListener, TextWatcher, CheckUserPresenter.RemoteActionCompatParcelizer, GetAcctOpeningCategoryDataPresenter.RemoteActionCompatParcelizer {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (editable == this.etEmail.getEditableText()) {
            ...
            if (this.tvErrors.get(this.etFields.indexOf(this.etNoHp)).getVisibility() == 0 && !this.etNoHp.getText().toString().isEmpty()) {
                a(this.etFields.indexOf(this.etNoHp));
            }
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6DTahapanXpresiFragment.5
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6DTahapanXpresiFragment.this.getActivity()).n.setEmailIB("");
                ((FormActivity) Page6DTahapanXpresiFragment.this.getActivity()).n.setFlagMB("");
                ((FormActivity) Page6DTahapanXpresiFragment.this.getActivity()).n.setHphoneMB("");
            }
        });
        ...
        if (id != 2131298443) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00e3: IPUT  
                 ...
                 o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.Page6DTahapanXpresiFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanXpresiFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void");
        }
            ...
            if (this.etNoHp.getVisibility() == 0) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00cc: INVOKE  
                      (r0v138 'validator2' com.mobsandgeeks.saripaar.Validator)
                      (r0v140 'editText' android.widget.EditText)
                      (wrap: com.mobsandgeeks.saripaar.QuickRule[] : ?: FILLED_NEW_ARRAY  (r2v7 com.mobsandgeeks.saripaar.QuickRule[] A[REMOVE]) = 
                      (wrap: o.getPromotion$2 : 0x00c8: CONSTRUCTOR  
                      (r0v140 'editText' android.widget.EditText)
                      (r0v132 'confirmSubBCACardAdapter$ViewHolder' o.ConfirmSubBCACardAdapter$ViewHolder)
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.Page6DTahapanXpresiFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanXpresiFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanXpresiFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
