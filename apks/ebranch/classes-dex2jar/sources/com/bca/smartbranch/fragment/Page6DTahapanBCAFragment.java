...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanBCAFragment.class */
public class Page6DTahapanBCAFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener, TextWatcher, Validator.ValidationListener, CheckUserPresenter.RemoteActionCompatParcelizer, GetAcctOpeningCategoryDataPresenter.RemoteActionCompatParcelizer {
    ...
    private GetAcctOpeningCategoryDataPresenter j;
    @BindView(2131297691)
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (editable == this.etEmail.getEditableText()) {
            if (this.tvErrors.get(this.etFields.indexOf(this.etEmail)).getVisibility() == 0 && getPromotion.a(getContext(), this.tvErrors.get(this.etFields.indexOf(this.etEmail)).getText().toString(), this.etEmail)) {
                b(this.etFields.indexOf(this.etEmail));
            }
            ...
            if (this.tvErrors.get(this.etFields.indexOf(this.etNoHp)).getVisibility() == 0 && !this.etNoHp.getText().toString().isEmpty()) {
                b(this.etFields.indexOf(this.etNoHp));
            }
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6DTahapanBCAFragment.4
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setLanguage("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setDebitCardType("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setFlagIB("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setEmailIB("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setFlagMB("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setHphoneMB("");
                ((FormActivity) Page6DTahapanBCAFragment.this.getActivity()).n.setDollarCurrCode("");
            }
        });
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        if (id != 2131298443) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00e3: IPUT  
                 ...
                 o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.Page6DTahapanBCAFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanBCAFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanBCAFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void");
        }
        ...
        public void onDestroyView() {
            ...
            GetAcctOpeningCategoryDataPresenter getAcctOpeningCategoryDataPresenter = this.j;
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            this.j = getAcctOpeningCategoryDataPresenter;
            getAcctOpeningCategoryDataPresenter.c = this;
            this.tvTitleFasilitas.setText(Html.fromHtml(this.titleFasilitas));
            ...
            if (this.etNoHp.getVisibility() == 0) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00e5: INVOKE  
                      (r0v183 'validator2' com.mobsandgeeks.saripaar.Validator)
                      (r0v185 'editText' android.widget.EditText)
                      (wrap: com.mobsandgeeks.saripaar.QuickRule[] : ?: FILLED_NEW_ARRAY  (r2v10 com.mobsandgeeks.saripaar.QuickRule[] A[REMOVE]) = 
                      (wrap: o.getPromotion$2 : 0x00e1: CONSTRUCTOR  
                      (r0v185 'editText' android.widget.EditText)
                      (r0v177 'confirmSubBCACardAdapter$ViewHolder' o.ConfirmSubBCACardAdapter$ViewHolder)
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.Page6DTahapanBCAFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTahapanBCAFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTahapanBCAFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
