...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC10PasporFormKartuKreditFragment.class */
public class CC10PasporFormKartuKreditFragment extends BaseFragment implements Validator.ValidationListener, TextWatcher, CheckCCValidApplicantPresenter.RemoteActionCompatParcelizer {
    ...
    EditText etFotoID;
    @BindView(2131297060)
    @NotEmpty(messageResId = 2131820857, trim = true)
    @Order(2)
    ...
    EditText etNoHP;
    @BindView(2131297103)
    @NotEmpty(messageResId = 2131820945, trim = true)
    @Order(1)
    EditText etNoIdentitas;
    private int f;
    @BindString(2131820965)
    String invalidFotoPaspor;
    ...
    @BindView(2131298531)
    LogoutDialog_ViewBinding tilFotoPaspor;
    @BindView(2131298609)
    LogoutDialog_ViewBinding tilNamaLengkap;
    @BindView(2131298607)
    LogoutDialog_ViewBinding tilNamaPaspor;
    @BindView(2131298640)
    LogoutDialog_ViewBinding tilNoHp;
    @BindView(2131298649)
    LogoutDialog_ViewBinding tilNoPaspor;
    @BindView(2131299009)
    TextView tvErrorFotoId;
    @BindViews({2131299122, 2131299084, 2131299086, 2131299115, 2131299006})
    List<TextView> tvErrors;

    static /* synthetic */ void a(CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment, EditText editText) {
        getPromotion.b(cC10PasporFormKartuKreditFragment.tvErrors, cC10PasporFormKartuKreditFragment.tilForms, cC10PasporFormKartuKreditFragment.etFields, editText);
    }

    static /* synthetic */ void b(CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment, EditText editText) {
        getPromotion.d(cC10PasporFormKartuKreditFragment.getContext(), cC10PasporFormKartuKreditFragment.tvErrors, cC10PasporFormKartuKreditFragment.tilForms, cC10PasporFormKartuKreditFragment.etFields, editText);
    }
    ...
    static /* synthetic */ void d(CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment, EditText editText) {
        getPromotion.c(cC10PasporFormKartuKreditFragment.getContext(), cC10PasporFormKartuKreditFragment.tvErrors, cC10PasporFormKartuKreditFragment.tilForms, cC10PasporFormKartuKreditFragment.etFields, editText);
    }
    ...
    public void afterTextChanged(final Editable editable) {
        ...
        if (!this.c.isInTransaction()) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.1
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    if (editable == CC10PasporFormKartuKreditFragment.this.etNoIdentitas.getEditableText()) {
                        CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment = CC10PasporFormKartuKreditFragment.this;
                        CC10PasporFormKartuKreditFragment.b(cC10PasporFormKartuKreditFragment, cC10PasporFormKartuKreditFragment.etNoIdentitas);
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setIdentityCardNumber(editable.toString());
                    } else if (editable == CC10PasporFormKartuKreditFragment.this.etNamaIdentitas.getEditableText()) {
                        CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment2 = CC10PasporFormKartuKreditFragment.this;
                        CC10PasporFormKartuKreditFragment.a(cC10PasporFormKartuKreditFragment2, cC10PasporFormKartuKreditFragment2.etNamaIdentitas);
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setCustomerName(editable.toString());
                    } else if (editable == CC10PasporFormKartuKreditFragment.this.etNamaLengkap.getEditableText()) {
                        CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment3 = CC10PasporFormKartuKreditFragment.this;
                        CC10PasporFormKartuKreditFragment.a(cC10PasporFormKartuKreditFragment3, cC10PasporFormKartuKreditFragment3.etNamaLengkap);
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setCustomerFullName(editable.toString());
                    } else if (editable == CC10PasporFormKartuKreditFragment.this.etNoHP.getEditableText()) {
                        CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment4 = CC10PasporFormKartuKreditFragment.this;
                        CC10PasporFormKartuKreditFragment.a(cC10PasporFormKartuKreditFragment4, cC10PasporFormKartuKreditFragment4.etNoHP);
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setMobileNumber(editable.toString());
                    } else if (editable == CC10PasporFormKartuKreditFragment.this.etEmail.getEditableText()) {
                        CC10PasporFormKartuKreditFragment cC10PasporFormKartuKreditFragment5 = CC10PasporFormKartuKreditFragment.this;
                        CC10PasporFormKartuKreditFragment.d(cC10PasporFormKartuKreditFragment5, cC10PasporFormKartuKreditFragment5.etEmail);
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setEmailAddr(editable.toString());
                    }
                }
            });
        }
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.3
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setIdentityCardImg("");
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setIdentityCardNumber("");
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setCustomerName("");
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setCustomerFullName("");
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setMobileNumber("");
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setEmailAddr("");
            }
        });
    ...
    public void lanjut(View view) {
        ...
        this.tilFotoPaspor.setBackgroundResource(2131230847);
        ...
        if (((CC8FormKartuKreditActivity) getActivity()).n.getIdentityCardImg().isEmpty()) {
            ...
            this.tvErrorFotoId.setText(this.invalidFotoPaspor);
            this.tilFotoPaspor.setBackgroundResource(2131230870);
        }
        this.d.validate();
    }
        ...
        if (z) {
            switch (view.getId()) {
                case 2131296976:
                    ...
                    return;
                case 2131297060:
                    this.tilNamaPaspor.setHintEnabled(true);
                    return;
                case 2131297062:
                ...
                case 2131297094:
                    ...
                    return;
                case 2131297103:
                    this.tilNoPaspor.setHintEnabled(true);
                    return;
                default:
                    return;
            }
            ...
            switch (view.getId()) {
                ...
                case 2131297060:
                    if (this.etNamaIdentitas.getText().toString().isEmpty()) {
                        this.tilNamaPaspor.setHintEnabled(false);
                        return;
                    }
                    return;
                case 2131297062:
                ...
                case 2131297103:
                    if (this.etNoIdentitas.getText().toString().isEmpty()) {
                        this.tilNoPaspor.setHintEnabled(false);
                        return;
                    }
                    return;
                default:
    ...
    public void onChooseCameraEvent(PilihKantorCabangActivity pilihKantorCabangActivity) {
        if (pilihKantorCabangActivity.c) {
            ...
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.8
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    if (CC10PasporFormKartuKreditFragment.this.f == 2) {
                        ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setIdentityCardImg("");
                        CC10PasporFormKartuKreditFragment.this.etFotoID.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2131231142, 0);
                        CC10PasporFormKartuKreditFragment.this.ivFotoID.setVisibility(8);
                        CC10PasporFormKartuKreditFragment.this.tilFotoPaspor.setHintEnabled(false);
                        CC10PasporFormKartuKreditFragment.this.etFotoID.setText("");
                    }
                }
            });
        }
    ...
    public void onChooseValueFotoID(ubahProfil ubahprofil) {
        ...
        this.tilFotoPaspor.setHintEnabled(true);
        ...
        this.c.executeTransaction(new Realm.Transaction(ubahprofil) { // from class: o.setPpuNumber
            public final /* synthetic */ ubahProfil a;
            ...
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.setIdentityCardImg(getPromotion.b(this.a.e));
            }
        });
    }
    ...
    public void onChooseValueSimpanDraft(ReservasiSuccessEChannelActivity_ViewBinding reservasiSuccessEChannelActivity_ViewBinding) {
        if (reservasiSuccessEChannelActivity_ViewBinding.d.equals("N")) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.4
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.cascadeDelete();
                }
            });
    ...
    public void onChooseValueYakinKeluar(TarikanReservasiUbahTransaksiActivity_ViewBinding tarikanReservasiUbahTransaksiActivity_ViewBinding) {
        if (tarikanReservasiUbahTransaksiActivity_ViewBinding.a.equals("Y")) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.2
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    ((CC8FormKartuKreditActivity) CC10PasporFormKartuKreditFragment.this.getActivity()).n.cascadeDelete();
                }
            ...
            if (view instanceof EditText) {
                ...
                switch (view.getId()) {
                    ...
                    case 2131297060:
                        ...
                        this.tilNamaPaspor.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    case 2131297062:
                    ...
                    case 2131297103:
                        ...
                        this.tilNoPaspor.setBackgroundResource(2131230870);
                        editText = editText2;
                        continue;
                    default:
                        editText = editText2;
    ...
    public void onValidationSucceeded() {
        this.a.b(new FotoActivity_ViewBinding(this.etNoIdentitas.getText().toString(), "PASSPORT"));
    }
        ...
        if (this.etNoHP.getVisibility() == 0) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x007f: INVOKE  
                  (r0v122 'validator2' com.mobsandgeeks.saripaar.Validator)
                  (r0v124 'editText' android.widget.EditText)
                  (wrap: com.mobsandgeeks.saripaar.QuickRule[] : ?: FILLED_NEW_ARRAY  (r2v9 com.mobsandgeeks.saripaar.QuickRule[] A[REMOVE]) = 
                  (wrap: o.getPromotion$2 : 0x007b: CONSTRUCTOR  
                  (r0v124 'editText' android.widget.EditText)
                  (r0v116 'confirmSubBCACardAdapter$ViewHolder' o.ConfirmSubBCACardAdapter$ViewHolder)
                 ...
                 type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC10PasporFormKartuKreditFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.CC10PasporFormKartuKreditFragment.onViewCreated(android.view.View, android.os.Bundle):void");
        }
    }
