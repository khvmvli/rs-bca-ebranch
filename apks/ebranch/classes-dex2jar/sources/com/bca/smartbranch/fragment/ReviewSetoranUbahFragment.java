...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class */
public class ReviewSetoranUbahFragment extends BaseFragment implements Validator.ValidationListener, showInfoValueTodayOR.MediaBrowserCompat.CustomActionResultReceiver, TextWatcher, AdapterView.OnItemClickListener, UpdateTxnTellerSetunDetailPresenter.read {
    ...
    private UpdateTxnTellerSetunDetailPresenter f;
    @BindView(2131297257)
    ...
    private void b() {
        this.i.put(this.etOrangJenisId, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.10
        ...
        this.etOrangNama.setTag(((FormUbahTellerActivity) getActivity()).f.getRepresentativeIdType());
        final EditText editText = this.etOrangNama;
        this.i.put(editText, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.4
            private boolean e() {
        ...
        this.etOrangNoID.setTag(((FormUbahTellerActivity) getActivity()).f.getRepresentativeIdType());
        final EditText editText2 = this.etOrangNoID;
        this.i.put(editText2, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.5
            private boolean e() {
    ...
    private void l() {
        ...
        if (((FormUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType().equalsIgnoreCase("Perusahaan")) {
            if (((FormUbahTellerActivity) getActivity()).f.getSenderIdType().equalsIgnoreCase("SIUP")) {
        ...
        } else if (((FormUbahTellerActivity) getActivity()).f.getSenderIdType().equalsIgnoreCase("Rekening")) {
            this.llDataPengirimDisabled.removeView(this.rlPengirimNoIdDisabled);
            this.llDataPengirimDisabled.removeView(this.rlPengirimAlamatDisabled);
        } else {
            this.llDataPengirimDisabled.removeView(this.rlPengirimNorekDisabled);
        }
        if (Double.parseDouble(((FormUbahTellerActivity) getActivity()).f.getTxnAmount().replace(",", ".")) < 1.0E8d) {
    ...
    public void n() {
        FormUbahTellerActivity formUbahTellerActivity = (FormUbahTellerActivity) getActivity();
        ArrayList arrayList = new ArrayList();
        UpdateTxnTellerSetunDetailRequest updateTxnTellerSetunDetailRequest = new UpdateTxnTellerSetunDetailRequest();
        String upperCase = "Rekening".toUpperCase();
        if (this.etJenisId.getText().toString().equalsIgnoreCase(this.labelKtp)) {
            upperCase = "KTP".toUpperCase();
        } else if (this.etJenisId.getText().toString().equalsIgnoreCase(this.labelPaspor)) {
            upperCase = "Paspor".toUpperCase();
        } else if (this.etJenisId.getText().toString().equalsIgnoreCase(this.labelSiupNib)) {
            upperCase = "SIUP".toUpperCase();
        }
        updateTxnTellerSetunDetailRequest.e = upperCase;
        if (this.tilNorekPengirim.getVisibility() == 0) {
            updateTxnTellerSetunDetailRequest.c = this.etNorekPengirim.getText().toString();
        } else {
            updateTxnTellerSetunDetailRequest.c = this.etNoIDPengirim.getText().toString();
        }
        updateTxnTellerSetunDetailRequest.b = this.etAlamatPengirim.getText().toString();
        updateTxnTellerSetunDetailRequest.d = this.etNoHpPengirim.getText().toString();
        updateTxnTellerSetunDetailRequest.a = this.etNamaPengirim.getText().toString();
        UpdateTxnTellerSetunDetailRequest.TxnData txnData = new UpdateTxnTellerSetunDetailRequest.TxnData();
        txnData.c = formUbahTellerActivity.f.getTxnAmount();
        txnData.q = formUbahTellerActivity.f.getType();
        txnData.j = this.etNamaPenerima.getText().toString();
        txnData.g = this.etSimpanNama.getText().toString();
        txnData.h = this.etNoRekPenerima.getText().toString();
        txnData.s = this.etBeritaSetoran.getText().toString();
        txnData.t = this.etPengirimSumberDana.getText().toString();
        txnData.r = this.etPengirimTujuanTransaksi.getText().toString();
        txnData.a = formUbahTellerActivity.f.getCurrency();
        txnData.l = ((FormUbahTellerActivity) getActivity()).f.getRecurringVar();
        txnData.k = ((FormUbahTellerActivity) getActivity()).f.getRecurringValue();
        txnData.i = ((FormUbahTellerActivity) getActivity()).f.getRecurringEndDate();
        if ("Tidak".equalsIgnoreCase(this.etOrangSamaDenganPemilik.getText().toString())) {
            txnData.b = "Y";
            UpdateTxnTellerSetunDetailRequest.RemoteActionCompatParcelizer remoteActionCompatParcelizer = new UpdateTxnTellerSetunDetailRequest.RemoteActionCompatParcelizer();
            remoteActionCompatParcelizer.c = this.etOrangNama.getText().toString();
            remoteActionCompatParcelizer.b = this.etOrangJenisId.getText().toString();
            remoteActionCompatParcelizer.d = this.etOrangNoID.getText().toString();
            remoteActionCompatParcelizer.a = "";
            txnData.m = remoteActionCompatParcelizer;
        } else {
            txnData.b = "N";
        }
        if (this.etPengirimPemilikSumberDana.getText().toString().equalsIgnoreCase("Saya Sendiri")) {
            txnData.n = "MSF";
        } else if (this.etPengirimPemilikSumberDana.getText().toString().equalsIgnoreCase("Orang Lain")) {
            txnData.n = "OTH";
        } else if (this.etPengirimPemilikSumberDana.getText().toString().equalsIgnoreCase("Perusahaan")) {
            txnData.n = "ORG";
        } else {
            txnData.n = this.etPengirimPemilikSumberDana.getText().toString();
        }
        arrayList.add(txnData);
        updateTxnTellerSetunDetailRequest.h = arrayList;
        this.f.b(updateTxnTellerSetunDetailRequest, this.e, formUbahTellerActivity.q);
    }
    ...
    @Override // com.bca.smartbranch.presenter.UpdateTxnTellerSetunDetailPresenter.read
    public final void a() {
        h();
        Intent intent = new Intent(getContext(), TransactionActivity.class);
        intent.putExtra("is_update", true);
        startActivity(intent);
        setOnHierarchyChangeListener.d((Activity) ((FormUbahTellerActivity) getActivity()));
    }
    ...
    public void afterTextChanged(Editable editable) {
        if (editable == this.etNamaPenerima.getEditableText()) {
            if (this.tvErrorsPenerima.get(this.viewGroupPenerima.indexOf(this.etNamaPenerima)).getVisibility() == 0 && !this.etNamaPenerima.getText().toString().isEmpty()) {
                d(this.viewGroupPenerima.indexOf(this.etNamaPenerima));
            }
            ...
            if (this.tvErrorsPenerima.get(this.viewGroupPenerima.indexOf(this.etNoRekPenerima)).getText().toString().equalsIgnoreCase(getString(2131820920))) {
                if (!this.etNoRekPenerima.getText().toString().isEmpty()) {
                    d(this.viewGroupPenerima.indexOf(this.etNoRekPenerima));
                }
            ...
            if (this.tvErrorsPenerima.get(this.viewGroupPenerima.indexOf(this.etSimpanNama)).getVisibility() == 0 && !this.etSimpanNama.getText().toString().isEmpty()) {
                d(this.viewGroupPenerima.indexOf(this.etSimpanNama));
            }
            ...
            if (this.tvErrorsOrangDatangKeCabang.get(this.viewGroupOrangDatangKeCabang.indexOf(this.etOrangNama)).getVisibility() == 0 && !this.etOrangNama.getText().toString().isEmpty()) {
                a(this.viewGroupOrangDatangKeCabang.indexOf(this.etOrangNama));
            }
            ...
            if (this.tvErrorsOrangDatangKeCabang.get(this.viewGroupOrangDatangKeCabang.indexOf(this.etOrangNoID)).getVisibility() == 0 && !this.etOrangNoID.getText().toString().isEmpty()) {
                a(this.viewGroupOrangDatangKeCabang.indexOf(this.etOrangNoID));
            }
    ...
    public final void c(String str) {
        h();
        KeluarFormReservationDialog_ViewBinding.a(null, ((FormUbahTellerActivity) getActivity()).llMain, str, -1).g();
    }
    ...
    public void clickJenisIdentitasPemilikSumberDana(View view) {
        ...
        bundle.putString("owner_id_type", ((FormUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType());
    ...
    public void clickView(View view) {
        ...
        switch (id) {
            case 2131297153:
                ...
                bundle.putStringArray(CollectionUtils.LIST_TYPE, ((FormUbahTellerActivity) getActivity()).t);
            ...
            case 2131297154:
                ...
                bundle.putStringArray(CollectionUtils.LIST_TYPE, ((FormUbahTellerActivity) getActivity()).s);
    ...
    public final void d(String str) {
        h();
        KeluarFormReservationDialog_ViewBinding.a(null, this.svMain, str, 0).e(2131822092, new View.OnClickListener() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ReviewSetoranUbahFragment.this.n();
            }
        }).g();
    }
    ...
    public final void d(showInfoValueTodayOR showinfovaluetodayor, int i, int i2, int i3) {
        ...
        ((FormUbahTellerActivity) getActivity()).f.setRecurringEndDate(getAnnualFeeBasicAmount.d(i, i2, i3));
    }
    ...
    public void eventJenisIdentitasPemilikSumberDana(ReservasiCSOActivity reservasiCSOActivity) {
        if (!reservasiCSOActivity.d.equalsIgnoreCase(this.etJenisId.getText().toString())) {
            ...
            if (reservasiCSOActivity.d.equalsIgnoreCase(this.labelKtp)) {
                ...
                this.i.put(editText, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.5
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                this.i.put(editText2, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.3
                    public final String getMessage(Context context) {
                ...
                this.i.put(editText3, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.5
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                this.i.put(editText4, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.3
                    public final String getMessage(Context context) {
                        return (!r0.getTag().toString().equalsIgnoreCase("KTP") || !r0.getText().toString().isEmpty()) ? (!r0.getTag().toString().equalsIgnoreCase("Paspor") || !r0.getText().toString().isEmpty()) ? context.getString(2131820730) : context.getString(2131820734) : context.getString(2131820733);
                    }
                ...
                this.i.put(editText5, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.5
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                } else if (((FormUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType().equalsIgnoreCase("Perusahaan")) {
                    this.etNamaPengirim.setHint(this.namaPerusahaan);
                } else {
                    this.etNamaPengirim.setHint(this.namaRekening);
                }
                final EditText editText6 = this.etNorekPengirim;
                this.i.put(editText6, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.5
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x05fc: INVOKE  
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.eventJenisIdentitasPemilikSumberDana(o.ReservasiCSOActivity):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.eventJenisIdentitasPemilikSumberDana(o.ReservasiCSOActivity):void");
            }
            ...
            public void onClickUbahDataOrangDatangKeCabang(View view) {
                ...
                getCountryName getcountryname = new Runnable() { // from class: o.getCountryName
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranUbahFragment reviewSetoranUbahFragment = ReviewSetoranUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranUbahFragment.viewGroupOrangDatangKeCabang.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranUbahFragment.viewGroupPengirim.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranUbahFragment.viewGroupOrangDatangKeCabang.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranUbahFragment.viewGroupOrangDatangKeCabang.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranUbahFragment.viewGroupOrangDatangKeCabang.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutDataOrangDatangKeCabang.getVisibility() == 8) {
                    ...
                    new Handler().postDelayed(getcountryname, 300);
                    return;
                }
                getcountryname.run();
            }
            ...
            public void onClickUbahDataPenerima(View view) {
                ...
                BranchResponse branchResponse = new Runnable() { // from class: o.BranchResponse
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranUbahFragment reviewSetoranUbahFragment = ReviewSetoranUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranUbahFragment.viewGroupPenerima.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranUbahFragment.viewGroupPenerima.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranUbahFragment.viewGroupPenerima.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranUbahFragment.viewGroupPenerima.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranUbahFragment.viewGroupPenerima.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutDataPenerima.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(branchResponse, 300);
                    return;
                }
                branchResponse.run();
            }
            ...
            public void onClickUbahDataPengirim(View view) {
                ...
                setBankId setbankid = new Runnable() { // from class: o.setBankId
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranUbahFragment reviewSetoranUbahFragment = ReviewSetoranUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranUbahFragment.viewGroupPengirim.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranUbahFragment.viewGroupPengirim.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranUbahFragment.viewGroupPengirim.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranUbahFragment.viewGroupPengirim.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranUbahFragment.viewGroupPengirim.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutPengirim.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(setbankid, 300);
                    return;
                }
                setbankid.run();
            }
            ...
            public void onClickUbahTransaksiSetoran(View view) {
                ...
                getNatidCode getnatidcode = new Runnable() { // from class: o.getNatidCode
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranUbahFragment reviewSetoranUbahFragment = ReviewSetoranUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranUbahFragment.viewGroupTransaksiSetoran.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranUbahFragment.viewGroupTransaksiSetoran.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranUbahFragment.viewGroupTransaksiSetoran.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranUbahFragment.viewGroupTransaksiSetoran.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranUbahFragment.viewGroupTransaksiSetoran.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutTransaksiSetoran.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(getnatidcode, 300);
                    return;
                }
                getnatidcode.run();
            }
            ...
            public void onClickUbahTransferBerkala(View view) {
                ...
                getBankId getbankid = new Runnable() { // from class: o.getBankId
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranUbahFragment reviewSetoranUbahFragment = ReviewSetoranUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranUbahFragment.viewGroupTransaksiBerkala.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranUbahFragment.viewGroupTransaksiBerkala.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranUbahFragment.viewGroupTransaksiBerkala.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranUbahFragment.viewGroupTransaksiBerkala.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranUbahFragment.viewGroupTransaksiBerkala.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutTransferBerkala.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(getbankid, 300);
                    return;
                }
                getbankid.run();
            }
            ...
            public void onDestroyView() {
                onDestroyView();
                UpdateTxnTellerSetunDetailPresenter updateTxnTellerSetunDetailPresenter = this.f;
                Call<OpenAccountSuccessActivity<Object>> call = updateTxnTellerSetunDetailPresenter.c;
                if (call != null) {
                    call.cancel();
                }
                updateTxnTellerSetunDetailPresenter.a = null;
                this.c.close();
            ...
            public void onViewCreated(View view, Bundle bundle) {
                ...
                UpdateTxnTellerSetunDetailPresenter updateTxnTellerSetunDetailPresenter = new UpdateTxnTellerSetunDetailPresenter();
                this.f = updateTxnTellerSetunDetailPresenter;
                updateTxnTellerSetunDetailPresenter.a = this;
                Validator validator = new Validator(this);
                this.i = validator;
                validator.setValidationListener(this);
                this.i.validateInvisibleViews(true);
                ((FormUbahTellerActivity) getActivity()).f.setCurrentPage("ReviewSetoranUbahFragment");
                int i = 0;
                ...
                this.etNamaPenerima.setText(((FormUbahTellerActivity) getActivity()).f.getReceiverName());
                this.etNoRekPenerima.setText(((FormUbahTellerActivity) getActivity()).f.getReceiverAccount());
                ...
                String txnAmount = ((FormUbahTellerActivity) getActivity()).f.getTxnAmount();
                EditText editText = this.etJumlahSetoran;
                StringBuilder sb = new StringBuilder();
                sb.append(getPromotion.g(txnAmount));
                sb.append(" IDR");
                editText.setText(sb.toString());
                this.etBeritaSetoran.setText(((FormUbahTellerActivity) getActivity()).f.getTxnNotes());
                this.etBeritaSetoran.setOnTouchListener(
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x016e: INVOKE  
                      (wrap: android.widget.EditText : 0x0164: IGET  (r0v49 android.widget.EditText A[REMOVE]) = (r10v0 'this' com.bca.smartbranch.fragment.ReviewSetoranUbahFragment A[IMMUTABLE_TYPE, THIS]) com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.etBeritaSetoran android.widget.EditText)
                      (wrap: o.getPromotion$4 : 0x016b: CONSTRUCTOR  (r1v43 o.getPromotion$4 A[REMOVE]) =  call: o.getPromotion.4.<init>():void type: CONSTRUCTOR)
                     type: VIRTUAL call: android.view.View.setOnTouchListener(android.view.View$OnTouchListener):void in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
            ...
            public void showDataOrangDatangKeCabang(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                     ...
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataOrangDatangKeCabang(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataOrangDatangKeCabang(android.view.View):void");
            }
            ...
            public void showDataPenerima(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataPenerima(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataPenerima(android.view.View):void");
            }
            ...
            public void showDataPengirim(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataPengirim(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataPengirim(android.view.View):void");
            }
            ...
            public void showDataTransaksiBerkala(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataTransaksiBerkala(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataTransaksiBerkala(android.view.View):void");
            }
            ...
            public void showDataTransaksiSetoran(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataTransaksiSetoran(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranUbahFragment.showDataTransaksiSetoran(android.view.View):void");
            }
            ...
            public void subsriberChooseValueHariEvent(register register) {
                ...
                ((FormUbahTellerActivity) getActivity()).f.setRecurringValue(String.valueOf(register.d + 1));
            }
            ...
            public void subsriberChooseValueSetiapTanggalEvent(onExitTransaction onexittransaction) {
                ...
                ((FormUbahTellerActivity) getActivity()).f.setRecurringValue(onexittransaction.a);
            }
            ...
            public void updateDaftarTransfer(View view) {
                int id = view.getId();
                if (id == 2131297178) {
                    String recurringVar = ((FormUbahTellerActivity) getActivity()).f.getRecurringVar();
