...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC26CFormKartuKreditFragment.class */
public class CC26CFormKartuKreditFragment extends BaseFragment implements showInfoValueTodayOR.MediaBrowserCompat.CustomActionResultReceiver, Validator.ValidationListener, TextWatcher {
    private Calendar a;
    ...
    static /* synthetic */ void c(CC26CFormKartuKreditFragment cC26CFormKartuKreditFragment, EditText editText) {
        getPromotion.b(cC26CFormKartuKreditFragment.tvErrors, cC26CFormKartuKreditFragment.tilForms, cC26CFormKartuKreditFragment.etFields, editText);
    }
    ...
    public void afterTextChanged(final Editable editable) {
        ...
        if (!this.c.isInTransaction()) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC26CFormKartuKreditFragment.9
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    if (editable == CC26CFormKartuKreditFragment.this.etFullName.getEditableText()) {
                        CC26CFormKartuKreditFragment.this.d.setCustomerName(editable.toString());
                        CC26CFormKartuKreditFragment cC26CFormKartuKreditFragment = CC26CFormKartuKreditFragment.this;
                        CC26CFormKartuKreditFragment.c(cC26CFormKartuKreditFragment, cC26CFormKartuKreditFragment.etFullName);
                    } else if (editable == CC26CFormKartuKreditFragment.this.etNoHP.getEditableText()) {
                        CC26CFormKartuKreditFragment.this.d.setMobileNumber(editable.toString());
                        CC26CFormKartuKreditFragment cC26CFormKartuKreditFragment2 = CC26CFormKartuKreditFragment.this;
                        CC26CFormKartuKreditFragment.c(cC26CFormKartuKreditFragment2, cC26CFormKartuKreditFragment2.etNoHP);
                    } else if (editable == CC26CFormKartuKreditFragment.this.etLimit.getEditableText()) {
                        CC26CFormKartuKreditFragment.this.etLimit.removeTextChangedListener(CC26CFormKartuKreditFragment.this);
                        int length = CC26CFormKartuKreditFragment.this.etLimit.length();
                        CC26CFormKartuKreditFragment.this.etLimit.setText(getPromotion.i(CC26CFormKartuKreditFragment.this.etLimit.getText().toString()));
                        int length2 = CC26CFormKartuKreditFragment.this.etLimit.length();
                        if ((CC26CFormKartuKreditFragment.this.n + length2) - length > 0) {
                            CC26CFormKartuKreditFragment.this.etLimit.setSelection((CC26CFormKartuKreditFragment.this.n + length2) - length);
                        } else {
                            CC26CFormKartuKreditFragment.this.etLimit.setSelection(0);
                        }
                        CC26CFormKartuKreditFragment.this.etLimit.addTextChangedListener(CC26CFormKartuKreditFragment.this);
                        CC26CFormKartuKreditFragment.this.d.setSupplementCardLimit(CC26CFormKartuKreditFragment.this.etLimit.getText().toString().replaceAll("\\.", ""));
                        if (CC26CFormKartuKreditFragment.this.tvErrors.get(CC26CFormKartuKreditFragment.this.etFields.indexOf(CC26CFormKartuKreditFragment.this.etLimit)).getVisibility() != 0) {
                            return;
                        }
                        if (CC26CFormKartuKreditFragment.this.tvErrors.get(CC26CFormKartuKreditFragment.this.etFields.indexOf(CC26CFormKartuKreditFragment.this.etLimit)).getText().toString().equals(CC26CFormKartuKreditFragment.this.errorMinimalLimitBlackPlatinum)) {
                            if (Long.parseLong(CC26CFormKartuKreditFragment.this.etLimit.getText().toString().replaceAll("\\.", "")) >= 5000000) {
                                List<TextView> list = CC26CFormKartuKreditFragment.this.tvErrors;
                                List<LogoutDialog_ViewBinding> list2 = CC26CFormKartuKreditFragment.this.tilForms;
                                int indexOf = CC26CFormKartuKreditFragment.this.etFields.indexOf(CC26CFormKartuKreditFragment.this.etLimit);
                                list.get(indexOf).setVisibility(8);
                                list2.get(indexOf).setBackgroundResource(2131230847);
                            }
                        } else if (!CC26CFormKartuKreditFragment.this.tvErrors.get(CC26CFormKartuKreditFragment.this.etFields.indexOf(CC26CFormKartuKreditFragment.this.etLimit)).getText().toString().equals(CC26CFormKartuKreditFragment.this.errorMinimalLimitOrdinary)) {
                            CC26CFormKartuKreditFragment cC26CFormKartuKreditFragment3 = CC26CFormKartuKreditFragment.this;
                            CC26CFormKartuKreditFragment.c(cC26CFormKartuKreditFragment3, cC26CFormKartuKreditFragment3.etLimit);
                        } else if (Long.parseLong(CC26CFormKartuKreditFragment.this.etLimit.getText().toString().replaceAll("\\.", "")) >= 1000000) {
                            List<TextView> list3 = CC26CFormKartuKreditFragment.this.tvErrors;
                            List<LogoutDialog_ViewBinding> list4 = CC26CFormKartuKreditFragment.this.tilForms;
                            int indexOf2 = CC26CFormKartuKreditFragment.this.etFields.indexOf(CC26CFormKartuKreditFragment.this.etLimit);
    ...
    public final void d(showInfoValueTodayOR showinfovaluetodayor, int i, int i2, int i3) {
        ...
        this.c.executeTransaction(new Realm.Transaction(i, i2, i3) { // from class: o.setTotalWarkat
            ...
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                CC26CFormKartuKreditFragment.this.d.setBirthDate(getAnnualFeeBasicAmount.c(this.d, this.b, this.c));
            }
        });
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC26CFormKartuKreditFragment.4
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                CC26CFormKartuKreditFragment.this.d.setCustomerName("");
                CC26CFormKartuKreditFragment.this.d.setBirthDate("");
                CC26CFormKartuKreditFragment.this.d.setGender("");
                if (CC26CFormKartuKreditFragment.this.d.getRelationship() != null) {
                    CC26CFormKartuKreditFragment.this.d.getRelationship().deleteFromRealm();
                }
                CC26CFormKartuKreditFragment.this.d.setMobileNumber("");
                if (CC26CFormKartuKreditFragment.this.d.getJobSector() != null) {
                    CC26CFormKartuKreditFragment.this.d.getJobSector().deleteFromRealm();
                }
                if (CC26CFormKartuKreditFragment.this.d.getOccupation() != null) {
                    CC26CFormKartuKreditFragment.this.d.getOccupation().deleteFromRealm();
                }
                CC26CFormKartuKreditFragment.this.d.setSupplementCardLimit("");
            }
        });
        e(2131296811, new CC25CFormKartuKreditFragment(), "CC25CFormKartuKreditFragment");
    }
    ...
    public void onChooseCategoryEvent(CategoryListDialog.write write) {
        if (write.c.equals("relationship")) {
            ...
            this.tilHubungan.setHintEnabled(true);
            this.c.executeTransaction(new Realm.Transaction(write) { // from class: o.setToken
                ...
                public final void execute(Realm realm) {
                    ...
                    if (cC26CFormKartuKreditFragment.d.getRelationship() != null) {
                        cC26CFormKartuKreditFragment.d.getRelationship().deleteFromRealm();
                    }
                    ...
                    cC26CFormKartuKreditFragment.d.setRelationship(category);
                }
            });
            ...
            this.c.executeTransaction(new Realm.Transaction(write) { // from class: o.setTransactionPurposeType
                ...
                public final void execute(Realm realm) {
                    ...
                    if (cC26CFormKartuKreditFragment.d.getJobSector() != null) {
                        cC26CFormKartuKreditFragment.d.getJobSector().deleteFromRealm();
                    }
                    Category category = (Category) realm.createObject(Category.class);
                    category.setCode(write2.a.getCode());
                    category.setDescription(write2.a.getDescription());
                    cC26CFormKartuKreditFragment.d.setJobSector(category);
                }
            });
            ...
            this.c.executeTransaction(new Realm.Transaction(write) { // from class: o.setTransactionPurpose
                ...
                public final void execute(Realm realm) {
                    ...
                    if (cC26CFormKartuKreditFragment.d.getOccupation() != null) {
                        cC26CFormKartuKreditFragment.d.getOccupation().deleteFromRealm();
                    }
                    Category category = (Category) realm.createObject(Category.class);
                    category.setCode(write2.a.getCode());
                    category.setDescription(write2.a.getDescription());
                    cC26CFormKartuKreditFragment.d.setOccupation(category);
                }
            });
    ...
    public void onChooseValueSimpanDraft(ReservasiSuccessEChannelActivity_ViewBinding reservasiSuccessEChannelActivity_ViewBinding) {
        if (reservasiSuccessEChannelActivity_ViewBinding.d.equals("N")) {
            this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.CC26CFormKartuKreditFragment.10
                @Override // io.realm.Realm.Transaction
                public final void execute(Realm realm) {
                    ((CC8FormKartuKreditActivity) CC26CFormKartuKreditFragment.this.getActivity()).n.cascadeDelete();
                }
            });
    ...
    public void onClickBidangUsaha() {
        ...
        bundle.putParcelable("list_data", ListUtil.OneItemImmutableList.e(this.i));
        ...
        if (this.etNoHP.getVisibility() == 0) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x006d: INVOKE  
                 ...
                 type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.CC26CFormKartuKreditFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/CC26CFormKartuKreditFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.CC26CFormKartuKreditFragment.onViewCreated(android.view.View, android.os.Bundle):void");
        }
    }
