...
import com.bca.smartbranch.activity.FormReservasiUbahTellerActivity;
...
import o.BeneficiaryBankResponse;
import o.BeneficiaryBankResponse$$Parcelable;
...
import o.onRetry;
import o.register;
import o.setAbanoCode;
import o.setListData;
import o.setMessage;
import o.showInfoValueTodayOR;
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class */
public class ReviewSetoranReservasiUbahFragment extends BaseFragment implements Validator.ValidationListener, showInfoValueTodayOR.MediaBrowserCompat.CustomActionResultReceiver, TextWatcher, AdapterView.OnItemClickListener, CheckDaftarTransferPresenter.read {
    ...
    private CheckDaftarTransferPresenter j;
    ...
    @BindViews({2131297138, 2131298680, 2131297137, 2131297136})
    @Order(19)
    ...
    private void a() {
        this.j.e(this.e, "Setoran Tunai", ((FormReservasiUbahTellerActivity) getActivity()).f.getReceiverAccount(), "");
    }
    ...
    static /* synthetic */ void d(ReviewSetoranReservasiUbahFragment reviewSetoranReservasiUbahFragment) {
        reviewSetoranReservasiUbahFragment.j.e(reviewSetoranReservasiUbahFragment.e, "Setoran Tunai", ((FormReservasiUbahTellerActivity) reviewSetoranReservasiUbahFragment.getActivity()).f.getReceiverAccount(), "");
    }

    private void e() {
        this.h.put(this.etOrangJenisId, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.8
        ...
        this.etOrangNama.setTag(((FormReservasiUbahTellerActivity) getActivity()).f.getRepresentativeIdType());
        final EditText editText = this.etOrangNama;
        this.h.put(editText, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.4
            private boolean b() {
        ...
        this.etOrangNoID.setTag(((FormReservasiUbahTellerActivity) getActivity()).f.getRepresentativeIdType());
        final EditText editText2 = this.etOrangNoID;
        this.h.put(editText2, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.2
            private boolean e() {
    ...
    private void f() {
        this.h.removeRules(this.etOrangJenisId);
        this.h.removeRules(this.etOrangNama);
        this.h.removeRules(this.etOrangNoID);
    }
    ...
    private void j() {
        ...
        if (!((FormReservasiUbahTellerActivity) getActivity()).f.getFlagDaftarTransfer().equals("Y")) {
    ...
    public void k() {
        ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderName(this.etNamaPengirim.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderIdType(this.etJenisId.getText().toString().equalsIgnoreCase(this.labelSiupNib) ? "SIUP" : this.etJenisId.getText().toString());
        if (((FormReservasiUbahTellerActivity) getActivity()).f.getSenderIdType().equalsIgnoreCase("Rekening")) {
            ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderIdNumber(this.etNorekPengirim.getText().toString());
        } else {
            ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderIdNumber(this.etNoIDPengirim.getText().toString());
        }
        ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderAddress(this.etAlamatPengirim.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setSenderPhone(this.etNoHpPengirim.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setReceiverName(this.etNamaPenerima.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setReceiverAccount(this.etNoRekPenerima.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setReceiverAlias(this.etSimpanNama.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setTxnSource(this.etPengirimSumberDana.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setTxnPurpose(this.etPengirimTujuanTransaksi.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setTxnNotes(this.etBeritaSetoran.getText().toString());
        if ("Y".equalsIgnoreCase(((FormReservasiUbahTellerActivity) getActivity()).f.getFlagTxnBerkala()) && "Hari".equalsIgnoreCase(((FormReservasiUbahTellerActivity) getActivity()).f.getRecurringVar())) {
            ((FormReservasiUbahTellerActivity) getActivity()).f.setRecurringValue(this.etSetiapBeberapaHari.getText().toString());
        }
        ((FormReservasiUbahTellerActivity) getActivity()).f.setFlagSameReceiverSenderData(this.etOrangSamaDenganPemilik.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setSourceAccountOwnerType(this.etPengirimPemilikSumberDana.getText().toString());
        if ("Ya".equalsIgnoreCase(this.etOrangSamaDenganPemilik.getText().toString())) {
            ((FormReservasiUbahTellerActivity) getActivity()).f.setFlagRepresentativeTransaction("Y");
        } else {
            ((FormReservasiUbahTellerActivity) getActivity()).f.setFlagRepresentativeTransaction("N");
        }
        ((FormReservasiUbahTellerActivity) getActivity()).f.setRepresentativeIdType(this.etOrangJenisId.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setRepresentativeIdNumber(this.etOrangNoID.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setRepresentativeName(this.etOrangNama.getText().toString());
        ((FormReservasiUbahTellerActivity) getActivity()).f.setFlagRepresentativeTransaction("Y");
        ((FormReservasiUbahTellerActivity) getActivity()).t();
    }
    ...
    private void o() {
        ...
        if (((FormReservasiUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType().equalsIgnoreCase("Perusahaan")) {
            if (((FormReservasiUbahTellerActivity) getActivity()).f.getSenderIdType().equalsIgnoreCase("SIUP")) {
        ...
        } else if (((FormReservasiUbahTellerActivity) getActivity()).f.getSenderIdType().equalsIgnoreCase("Rekening")) {
            this.llDataPengirimDisabled.removeView(this.rlPengirimNoIdDisabled);
            this.llDataPengirimDisabled.removeView(this.rlPengirimAlamatDisabled);
        } else {
            this.llDataPengirimDisabled.removeView(this.rlPengirimNorekDisabled);
        }
        if (Double.parseDouble(((FormReservasiUbahTellerActivity) getActivity()).f.getTxnAmount().replace(",", ".")) < 1.0E8d) {
    ...
    public final void a_(String str) {
        h();
        KeluarFormReservationDialog_ViewBinding.a(null, this.svMain, str, 0).e(2131822092, new View.OnClickListener() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                if (((FormReservasiUbahTellerActivity) ReviewSetoranReservasiUbahFragment.this.getActivity()).f.getFlagDaftarTransfer().equals("Y")) {
                    ReviewSetoranReservasiUbahFragment.d(ReviewSetoranReservasiUbahFragment.this);
                } else {
                    ReviewSetoranReservasiUbahFragment.this.k();
                }
            }
        }).g();
    }
    ...
    public void afterTextChanged(Editable editable) {
        if (editable == this.etNamaPenerima.getEditableText()) {
            ...
            if (this.tvErrorsPenerima.get(this.viewGroupPenerima.indexOf(this.etNoRekPenerima)).getText().toString().equalsIgnoreCase(getString(2131820920))) {
                if (!this.etNoRekPenerima.getText().toString().isEmpty()) {
                    c(this.viewGroupPenerima.indexOf(this.etNoRekPenerima));
                }
            } else if (this.tvErrorsPenerima.get(this.viewGroupPenerima.indexOf(this.etNoRekPenerima)).getText().toString().equalsIgnoreCase(getString(2131820948)) && this.etNoRekPenerima.getText().toString().length() >= 10) {
                c(this.viewGroupPenerima.indexOf(this.etNoRekPenerima));
            }
            ...
            if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNoIDPengirim)).getVisibility() == 0 && getPromotion.d(getContext(), this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNoIDPengirim)).getText().toString(), this.etNoIDPengirim)) {
                a(this.viewGroupPengirim.indexOf(this.etNoIDPengirim));
            }
            ...
            if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNamaPengirim)).getVisibility() == 0 && !this.etNamaPengirim.getText().toString().isEmpty()) {
                a(this.viewGroupPengirim.indexOf(this.etNamaPengirim));
            }
            ...
            if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNorekPengirim)).getText().toString().equalsIgnoreCase(getString(2131820920))) {
                if (!this.etNorekPengirim.getText().toString().isEmpty()) {
                    a(this.viewGroupPengirim.indexOf(this.etNorekPengirim));
                }
            } else if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNorekPengirim)).getText().toString().equalsIgnoreCase(getString(2131820948)) && this.etNorekPengirim.getText().toString().length() >= 10) {
                a(this.viewGroupPengirim.indexOf(this.etNorekPengirim));
            }
            ...
            if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etAlamatPengirim)).getVisibility() == 0 && !this.etAlamatPengirim.getText().toString().isEmpty()) {
                a(this.viewGroupPengirim.indexOf(this.etAlamatPengirim));
            }
            ...
            if (this.tvErrorsPengirim.get(this.viewGroupPengirim.indexOf(this.etNoHpPengirim)).getVisibility() == 0 && !this.etNoHpPengirim.getText().toString().isEmpty()) {
                a(this.viewGroupPengirim.indexOf(this.etNoHpPengirim));
            }
            ...
            if (this.etSetiapBeberapaHari.getText().toString().equalsIgnoreCase("0")) {
    ...
    public void clickJenisIdentitasPemilikSumberDana(View view) {
        ...
        bundle.putString("owner_id_type", ((FormReservasiUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType());
    ...
    public void clickView(View view) {
        ...
        switch (id) {
            case 2131297153:
                ...
                bundle.putStringArray(CollectionUtils.LIST_TYPE, ((FormReservasiUbahTellerActivity) getActivity()).q);
            ...
            case 2131297154:
                ...
                bundle.putStringArray(CollectionUtils.LIST_TYPE, ((FormReservasiUbahTellerActivity) getActivity()).p);
    ...
    public final void d(showInfoValueTodayOR showinfovaluetodayor, int i, int i2, int i3) {
        ...
        ((FormReservasiUbahTellerActivity) getActivity()).f.setRecurringEndDate(getAnnualFeeBasicAmount.d(i, i2, i3));
    }
    ...
    public void eventJenisIdentitas(onRetry onretry) {
        ...
        int indexOf = this.viewGroupOrangDatangKeCabang.indexOf(this.etOrangJenisId);
        this.tvErrorsOrangDatangKeCabang.get(indexOf).setVisibility(8);
        this.tilFormsOrangDatangKeCabang.get(indexOf).setBackgroundResource(2131230847);
    }
    ...
    public void eventJenisIdentitasPemilikSumberDana(ReservasiCSOActivity reservasiCSOActivity) {
        if (!reservasiCSOActivity.d.equalsIgnoreCase(this.etJenisId.getText().toString())) {
            ...
            if (reservasiCSOActivity.d.equalsIgnoreCase(this.labelKtp)) {
                ...
                this.h.removeRules(this.viewGroupPengirim.get(3));
                ...
                this.h.put(editText, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.2
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                this.h.put(editText2, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.9
                    public final String getMessage(Context context) {
                ...
                this.h.put(editText3, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.2
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                this.h.put(editText4, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.9
                    public final String getMessage(Context context) {
                        return (!r0.getTag().toString().equalsIgnoreCase("KTP") || !r0.getText().toString().isEmpty()) ? (!r0.getTag().toString().equalsIgnoreCase("Paspor") || !r0.getText().toString().isEmpty()) ? context.getString(2131820730) : context.getString(2131820734) : context.getString(2131820733);
                    }
                ...
                this.h.removeRules(this.viewGroupPengirim.get(3));
                this.h.removeRules(this.viewGroupPengirim.get(5));
                ...
                this.h.put(editText5, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.2
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                this.h.removeRules(this.viewGroupPengirim.get(1));
                this.h.removeRules(this.viewGroupPengirim.get(4));
                ...
                } else if (((FormReservasiUbahTellerActivity) getActivity()).f.getSourceAccountOwnerType().equalsIgnoreCase("Perusahaan")) {
                    this.etNamaPengirim.setHint(this.namaPerusahaan);
                } else {
                    this.etNamaPengirim.setHint(this.namaRekening);
                }
                final EditText editText6 = this.etNorekPengirim;
                this.h.put(editText6, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.2
                    private boolean e() {
                        return r0.getTag().toString().equalsIgnoreCase("KTP") ? r0.getText().length() == 16 : r0.getTag().toString().equalsIgnoreCase("Paspor") ? !r0.getText().toString().isEmpty() : r0.getTag().toString().equalsIgnoreCase("Rekening") ? r0.getText().length() == 10 : !r0.getTag().toString().equalsIgnoreCase("SIUP") || !r0.getText().toString().isEmpty();
                    }
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x05fc: INVOKE  
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.eventJenisIdentitasPemilikSumberDana(o.ReservasiCSOActivity):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.eventJenisIdentitasPemilikSumberDana(o.ReservasiCSOActivity):void");
            }
            ...
            public void onClickUbahDataOrangDatangKeCabang(View view) {
                ...
                setAbanoCode setabanocode = new Runnable() { // from class: o.setAbanoCode
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranReservasiUbahFragment reviewSetoranReservasiUbahFragment = ReviewSetoranReservasiUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranReservasiUbahFragment.viewGroupOrangDatangKeCabang.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranReservasiUbahFragment.viewGroupPengirim.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranReservasiUbahFragment.viewGroupOrangDatangKeCabang.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranReservasiUbahFragment.viewGroupOrangDatangKeCabang.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranReservasiUbahFragment.viewGroupOrangDatangKeCabang.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutDataOrangDatangKeCabang.getVisibility() == 8) {
                    ...
                    new Handler().postDelayed(setabanocode, 300);
                    return;
                }
                setabanocode.run();
            }
            ...
            public void onClickUbahDataPenerima(View view) {
                ...
                BeneficiaryBankResponse.BeneficiaryBank beneficiaryBank = new BeneficiaryBankResponse.BeneficiaryBank(this);
                ...
                if (this.llLayoutDataPenerima.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(beneficiaryBank, 300);
                    return;
                }
                beneficiaryBank.run();
            }
            ...
            public void onClickUbahDataPengirim(View view) {
                ...
                BeneficiaryBankResponse$$Parcelable beneficiaryBankResponse$$Parcelable = new Runnable() { // from class: o.BeneficiaryBankResponse$$Parcelable
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranReservasiUbahFragment reviewSetoranReservasiUbahFragment = ReviewSetoranReservasiUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranReservasiUbahFragment.viewGroupPengirim.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranReservasiUbahFragment.viewGroupPengirim.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranReservasiUbahFragment.viewGroupPengirim.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranReservasiUbahFragment.viewGroupPengirim.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranReservasiUbahFragment.viewGroupPengirim.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutPengirim.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(beneficiaryBankResponse$$Parcelable, 300);
                    return;
                }
                beneficiaryBankResponse$$Parcelable.run();
            }
            ...
            public void onClickUbahTransaksiSetoran(View view) {
                ...
                getListData getlistdata = new Runnable() { // from class: o.getListData
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranReservasiUbahFragment reviewSetoranReservasiUbahFragment = ReviewSetoranReservasiUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranReservasiUbahFragment.viewGroupTransaksiSetoran.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiSetoran.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiSetoran.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiSetoran.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranReservasiUbahFragment.viewGroupTransaksiSetoran.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutTransaksiSetoran.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(getlistdata, 300);
                    return;
                }
                getlistdata.run();
            }
            ...
            public void onClickUbahTransferBerkala(View view) {
                ...
                setListData setlistdata = new Runnable() { // from class: o.setListData
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReviewSetoranReservasiUbahFragment reviewSetoranReservasiUbahFragment = ReviewSetoranReservasiUbahFragment.this;
                        EditText editText = null;
                        for (int size = reviewSetoranReservasiUbahFragment.viewGroupTransaksiBerkala.size() - 1; size >= 0; size--) {
                            editText = editText;
                            if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiBerkala.get(size).getVisibility() == 0) {
                                editText = editText;
                                if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiBerkala.get(size).isFocusable()) {
                                    editText = editText;
                                    if (reviewSetoranReservasiUbahFragment.viewGroupTransaksiBerkala.get(size).isEnabled()) {
                                        editText = (EditText) reviewSetoranReservasiUbahFragment.viewGroupTransaksiBerkala.get(size);
                                    }
                                }
                            }
                        }
                ...
                if (this.llLayoutTransferBerkala.getVisibility() == 8) {
                    ...
                    setmessage.e(imageView);
                    transitionDrawable.startTransition(0);
                    new Handler().postDelayed(setlistdata, 300);
                    return;
                }
                setlistdata.run();
            }
            ...
            public void onViewCreated(View view, Bundle bundle) {
                ...
                this.j = checkDaftarTransferPresenter;
                checkDaftarTransferPresenter.c = this;
                Validator validator = new Validator(this);
                this.h = validator;
                validator.setValidationListener(this);
                this.h.validateInvisibleViews(true);
                ((FormReservasiUbahTellerActivity) getActivity()).f.setCurrentPage("ReviewSetoranReservasiUbahFragment");
                int i = 0;
                ...
                this.etNamaPenerima.setText(((FormReservasiUbahTellerActivity) getActivity()).f.getReceiverName());
                this.etNoRekPenerima.setText(((FormReservasiUbahTellerActivity) getActivity()).f.getReceiverAccount());
                this.etSimpanNama.setText(((FormReservasiUbahTellerActivity) getActivity()).f.getReceiverAlias());
                if (!((FormReservasiUbahTellerActivity) getActivity()).f.getFlagDaftarTransfer().equalsIgnoreCase("Y")) {
                    this.tilSimpanNama.setVisibility(8);
                    this.h.removeRules(this.etSimpanNama);
                } else {
                    this.h.put(this.etSimpanNama, new QuickRule<EditText>() { // from class: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.5
                        /* renamed from: e */
                        public boolean isValid(EditText editText) {
                            if (editText.getText().toString().isEmpty()) {
                                return false;
                            }
                            for (DaftarTransfer daftarTransfer : ReviewSetoranReservasiUbahFragment.this.f) {
                                if (daftarTransfer.getAliasName().equalsIgnoreCase(ReviewSetoranReservasiUbahFragment.this.etSimpanNama.getText().toString()) && daftarTransfer.getAccountName().equalsIgnoreCase(ReviewSetoranReservasiUbahFragment.this.etNamaPenerima.getText().toString())) {
                                    return false;
                                }
                            }
                            return true;
                        ...
                        public final String getMessage(Context context) {
                            return ReviewSetoranReservasiUbahFragment.this.etSimpanNama.getText().toString().isEmpty() ? ReviewSetoranReservasiUbahFragment.this.getString(2131820999) : ReviewSetoranReservasiUbahFragment.this.getString(2131820764);
                        }
                    });
                }
                ...
                String txnAmount = ((FormReservasiUbahTellerActivity) getActivity()).f.getTxnAmount();
                EditText editText = this.etJumlahSetoran;
                StringBuilder sb = new StringBuilder();
                sb.append(getPromotion.i(txnAmount));
                sb.append(" IDR");
                editText.setText(sb.toString());
                this.etBeritaSetoran.setText(((FormReservasiUbahTellerActivity) getActivity()).f.getTxnNotes());
                this.etBeritaSetoran.setOnTouchListener(
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x01b5: INVOKE  
                      (wrap: android.widget.EditText : 0x01ab: IGET  (r0v53 android.widget.EditText A[REMOVE]) = (r10v0 'this' com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment A[IMMUTABLE_TYPE, THIS]) com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.etBeritaSetoran android.widget.EditText)
                      (wrap: o.getPromotion$4 : 0x01b2: CONSTRUCTOR  (r1v46 o.getPromotion$4 A[REMOVE]) =  call: o.getPromotion.4.<init>():void type: CONSTRUCTOR)
                     type: VIRTUAL call: android.view.View.setOnTouchListener(android.view.View$OnTouchListener):void in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
            ...
            public void showDataOrangDatangKeCabang(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                     ...
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataOrangDatangKeCabang(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataOrangDatangKeCabang(android.view.View):void");
            }
            ...
            public void showDataPenerima(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataPenerima(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataPenerima(android.view.View):void");
            }
            ...
            public void showDataPengirim(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataPengirim(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataPengirim(android.view.View):void");
            }
            ...
            public void showDataTransaksiBerkala(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataTransaksiBerkala(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataTransaksiBerkala(android.view.View):void");
            }
            ...
            public void showDataTransaksiSetoran(View view) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0076: IPUT  
                      (wrap: o.setMessage$1 : 0x0073: CONSTRUCTOR  (r1v4 o.setMessage$1 A[REMOVE]) = (r0v11 'setmessage2' o.setMessage), (r0v13 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                      (r0v11 'setmessage2' o.setMessage)
                     o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataTransaksiSetoran(android.view.View):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/ReviewSetoranReservasiUbahFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                L_0x005a:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.ReviewSetoranReservasiUbahFragment.showDataTransaksiSetoran(android.view.View):void");
            }
            ...
            public void subsriberChooseValueHariEvent(register register) {
                ...
                ((FormReservasiUbahTellerActivity) getActivity()).f.setRecurringValue(String.valueOf(register.d + 1));
            }
            ...
            public void subsriberChooseValueSetiapTanggalEvent(onExitTransaction onexittransaction) {
                ...
                ((FormReservasiUbahTellerActivity) getActivity()).f.setRecurringValue(onexittransaction.a);
            }

            @Stetho$Initializer$RealSocketHandlerFactory
            public void sumberDanaEvent(ReservasiTellerOActivity_ViewBinding reservasiTellerOActivity_ViewBinding) {
                a(this.viewGroupPengirim.indexOf(this.etPengirimSumberDana));
            ...
            public void tujuanTransaksiEvent(SyaratKetentuanActivity syaratKetentuanActivity) {
                a(this.viewGroupPengirim.indexOf(this.etPengirimTujuanTransaksi));
            ...
            public void updateDaftarTransfer(View view) {
                int id = view.getId();
                if (id == 2131297178) {
                    String recurringVar = ((FormReservasiUbahTellerActivity) getActivity()).f.getRecurringVar();
