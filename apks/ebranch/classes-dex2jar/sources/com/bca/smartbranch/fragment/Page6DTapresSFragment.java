...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTapresSFragment.class */
public class Page6DTapresSFragment extends BaseFragment implements Validator.ValidationListener, CompoundButton.OnCheckedChangeListener, TextWatcher, RadioGroup.OnCheckedChangeListener, CheckUserPresenter.RemoteActionCompatParcelizer {
    ...
    public void fragmentBackPressedEvent(clickOrangSamaDenganPemilik clickorangsamadenganpemilik) {
        this.c.executeTransaction(new Realm.Transaction() { // from class: com.bca.smartbranch.fragment.Page6DTapresSFragment.4
            @Override // io.realm.Realm.Transaction
            public final void execute(Realm realm) {
                ((FormActivity) Page6DTapresSFragment.this.getActivity()).n.setLanguage("");
                ((FormActivity) Page6DTapresSFragment.this.getActivity()).n.setFlagIB("");
                ((FormActivity) Page6DTapresSFragment.this.getActivity()).n.setEmailIB("");
                ((FormActivity) Page6DTapresSFragment.this.getActivity()).n.setFlagMB("");
                ((FormActivity) Page6DTapresSFragment.this.getActivity()).n.setHphoneMB("");
            }
        });
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        if (id != 2131298443) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00da: IPUT  
                  (wrap: o.setMessage$1 : 0x00d7: CONSTRUCTOR  (r1v7 o.setMessage$1 A[REMOVE]) = (r0v24 'setmessage' o.setMessage), (r0v26 'linearLayout' android.widget.LinearLayout) call: o.setMessage.1.<init>(o.setMessage, android.view.View):void type: CONSTRUCTOR)
                  (r0v24 'setmessage' o.setMessage)
                 o.setMessage.b android.view.animation.Animation in method: com.bca.smartbranch.fragment.Page6DTapresSFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTapresSFragment.class
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTapresSFragment.onCheckedChanged(android.widget.CompoundButton, boolean):void");
        }
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            this.d = checkUserPresenter;
            checkUserPresenter.b = this;
            ((FormActivity) getActivity()).n.setCurrentPage("Page6DTapresSFragment");
            ...
            if (this.etNoHp.getVisibility() == 0) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x00d8: INVOKE  
                      (r0v156 'validator2' com.mobsandgeeks.saripaar.Validator)
                      (r0v158 'editText' android.widget.EditText)
                      (wrap: com.mobsandgeeks.saripaar.QuickRule[] : ?: FILLED_NEW_ARRAY  (r2v7 com.mobsandgeeks.saripaar.QuickRule[] A[REMOVE]) = 
                      (wrap: o.getPromotion$2 : 0x00d4: CONSTRUCTOR  
                      (r0v158 'editText' android.widget.EditText)
                      (r0v150 'confirmSubBCACardAdapter$ViewHolder' o.ConfirmSubBCACardAdapter$ViewHolder)
                     ...
                     type: VIRTUAL call: com.mobsandgeeks.saripaar.Validator.put(android.view.View, com.mobsandgeeks.saripaar.QuickRule[]):void in method: com.bca.smartbranch.fragment.Page6DTapresSFragment.onViewCreated(android.view.View, android.os.Bundle):void, file: classes-dex2jar.jar:com/bca/smartbranch/fragment/Page6DTapresSFragment.class
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bca.smartbranch.fragment.Page6DTapresSFragment.onViewCreated(android.view.View, android.os.Bundle):void");
            }
