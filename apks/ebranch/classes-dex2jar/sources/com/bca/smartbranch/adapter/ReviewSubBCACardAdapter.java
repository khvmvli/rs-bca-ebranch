...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubBCACardAdapter.class */
public final class ReviewSubBCACardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    Context b;
    private RealmResults<CreditCardOptions> e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubBCACardAdapter$ViewHolder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubBCACardAdapter$ViewHolder_ViewBinding.class */
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, final int i) {
        ...
        viewHolder2.ivCloase.setOnClickListener(new View.OnClickListener() { // from class: com.bca.smartbranch.adapter.ReviewSubBCACardAdapter.5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                documentProvider.b().d(new BranchMapItemAdapter$BranchMapItemVH_ViewBinding(((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) ReviewSubBCACardAdapter.this.e.get(i))).getCardID(), i));
            }
        });
    }
}
