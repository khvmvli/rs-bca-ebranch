...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewMastercardAdapter.class */
public final class ReviewMastercardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    Context b;
    public RealmResults<CreditCardOptions> e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewMastercardAdapter$ViewHolder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewMastercardAdapter$ViewHolder_ViewBinding.class */
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, final int i) {
        ...
        viewHolder2.ivCloase.setOnClickListener(new View.OnClickListener() { // from class: com.bca.smartbranch.adapter.ReviewMastercardAdapter.4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                documentProvider.b().d(new BenefitAdapter$MyViewHolder_ViewBinding(((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) ReviewMastercardAdapter.this.e.get(i))).getCardID(), i));
            }
        });
    }
}
