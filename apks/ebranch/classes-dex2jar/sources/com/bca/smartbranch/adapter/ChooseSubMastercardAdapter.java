...
import com.bca.smartbranch.activity.CC24SubMastercardInfoActivity;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseSubMastercardAdapter.class */
public final class ChooseSubMastercardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    public long b;
    public Context e;
    public List<CreditCardOptions> g;
    public String i;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseSubMastercardAdapter$ViewHolder.class */
    public class ViewHolder extends setOnStartEnterTransitionListener$OnBackPressedDispatcher$LifecycleOnBackPressedCancellable {
        ...
        public ViewHolder(View view) {
            super(view);
            ChooseSubMastercardAdapter.this = r4;
            ButterKnife.bind(this, view);
        }

        @OnClick({2131296844, 2131298890, 2131297351, 2131297341})
        public void onClickPilih(View view) {
            documentProvider.b().d(new onChooseProvinsiRes(d(), "type_mastercard", !ChooseSubMastercardAdapter.this.g.get(d()).isChecked()));
        }
    }

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseSubMastercardAdapter$ViewHolder_ViewBinding.class */
    public class ViewHolder_ViewBinding implements Unbinder {
        ...
        public ViewHolder_ViewBinding(final ViewHolder viewHolder, View view) {
            ...
            findRequiredView.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseSubMastercardAdapter.ViewHolder_ViewBinding.4
            ...
            findRequiredView2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseSubMastercardAdapter.ViewHolder_ViewBinding.3
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseSubMastercardAdapter.ViewHolder_ViewBinding.1
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseSubMastercardAdapter.ViewHolder_ViewBinding.2
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, int i) {
        ...
        if (this.g.get(i).getCardImageOrientation().equals("LANDSCAPE")) {
            ...
            showKtpPage e = onChooseTanggalJatuhTempo.d(this.e).a(this.g.get(i).getCardImagePath().replaceAll(" ", "%20")).e(2131231395);
            e.e = true;
            ...
            showKtpPage e2 = onChooseTanggalJatuhTempo.d(this.e).a(this.g.get(i).getCardImagePath().replaceAll(" ", "%20")).e(2131231395);
            e2.e = true;
        ...
        viewHolder2.tvInfo.setOnClickListener(new View.OnClickListener(i) { // from class: o.batal
            ...
            public final void onClick(View view) {
                ChooseSubMastercardAdapter chooseSubMastercardAdapter = ChooseSubMastercardAdapter.this;
                int i2 = this.e;
                Intent intent = new Intent(chooseSubMastercardAdapter.e, CC24SubMastercardInfoActivity.class);
                intent.putExtra("current_user_id", chooseSubMastercardAdapter.i);
                intent.putExtra("current_cc_id", chooseSubMastercardAdapter.b);
                intent.putExtra("card_name", chooseSubMastercardAdapter.g.get(i2).getCardName());
                intent.putExtra("card_image", chooseSubMastercardAdapter.g.get(i2).getCardImagePath());
                intent.putStringArrayListExtra("card_benefit", new ArrayList<>(chooseSubMastercardAdapter.g.get(i2).getBenefit()));
                intent.putExtra("is_checked", chooseSubMastercardAdapter.g.get(i2).isChecked());
                intent.putExtra("index", i2);
                intent.putExtra("card_orientation", chooseSubMastercardAdapter.g.get(i2).getCardImageOrientation());
                intent.putExtra("card_annual_fee_basic", chooseSubMastercardAdapter.g.get(i2).getAnnualFeeBasicDisplayAmount());
                intent.putExtra("card_income", chooseSubMastercardAdapter.g.get(i2).getIncomeDisplayAmount());
                chooseSubMastercardAdapter.e.startActivity(intent);
            }
        });
    }
}
