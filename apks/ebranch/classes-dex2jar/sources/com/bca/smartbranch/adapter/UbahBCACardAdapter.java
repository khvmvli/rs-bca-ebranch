...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahBCACardAdapter.class */
public final class UbahBCACardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    public Context b;
    public List<CreditCardOptions> e;
    SparseBooleanArray i = new SparseBooleanArray();

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahBCACardAdapter$ViewHolder.class */
    public class ViewHolder extends setOnStartEnterTransitionListener$OnBackPressedDispatcher$LifecycleOnBackPressedCancellable {
        ...
        public ViewHolder(View view) {
            super(view);
            UbahBCACardAdapter.this = r4;
            ButterKnife.bind(this, view);
        }

        @OnClick({2131296844, 2131298890, 2131297351, 2131297341})
        public void onClickPilih(View view) {
            documentProvider.b().d(new PilihProvinsiActivity_ViewBinding(d(), !((CreditCardOptions) UbahBCACardAdapter.this.e.get(d())).isChecked()));
        }
    }

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahBCACardAdapter$ViewHolder_ViewBinding.class */
    public class ViewHolder_ViewBinding implements Unbinder {
        ...
        public ViewHolder_ViewBinding(final ViewHolder viewHolder, View view) {
            ...
            findRequiredView.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahBCACardAdapter.ViewHolder_ViewBinding.5
            ...
            findRequiredView2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahBCACardAdapter.ViewHolder_ViewBinding.1
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahBCACardAdapter.ViewHolder_ViewBinding.2
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahBCACardAdapter.ViewHolder_ViewBinding.4
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, int i) {
        ...
        viewHolder2.tvInfo.setOnClickListener(new View.OnClickListener(i) { // from class: o.ForgotPassSuccessActivity
            ...
            public final void onClick(View view) {
                UbahBCACardAdapter ubahBCACardAdapter = UbahBCACardAdapter.this;
                int i2 = this.b;
                Intent intent = new Intent(ubahBCACardAdapter.b, CC4BCACardInfoActivity.class);
                intent.putExtra("card_name", ubahBCACardAdapter.e.get(i2).getCardName());
                intent.putExtra("card_image", ubahBCACardAdapter.e.get(i2).getCardImagePath());
                intent.putStringArrayListExtra("card_benefit", new ArrayList<>(ubahBCACardAdapter.e.get(i2).getBenefit()));
                intent.putExtra("is_checked", ubahBCACardAdapter.e.get(i2).isChecked());
                intent.putExtra("index", i2);
                intent.putExtra("card_orientation", ubahBCACardAdapter.e.get(i2).getCardImageOrientation());
                intent.putExtra("card_annual_fee_basic", ubahBCACardAdapter.e.get(i2).getAnnualFeeBasicDisplayAmount());
                intent.putExtra("card_income", ubahBCACardAdapter.e.get(i2).getIncomeDisplayAmount());
                ubahBCACardAdapter.b.startActivity(intent);
            }
        });
    }
}
