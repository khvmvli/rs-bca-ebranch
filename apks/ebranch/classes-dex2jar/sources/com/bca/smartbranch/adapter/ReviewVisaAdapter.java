...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewVisaAdapter.class */
public final class ReviewVisaAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    Context b;
    public RealmResults<CreditCardOptions> e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewVisaAdapter$ViewHolder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewVisaAdapter$ViewHolder_ViewBinding.class */
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, final int i) {
        ...
        viewHolder2.ivCloase.setOnClickListener(new View.OnClickListener() { // from class: com.bca.smartbranch.adapter.ReviewVisaAdapter.2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                documentProvider.b().d(new BidangPekerjaanAdapter$BidangPekerjaanVH(((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) ReviewVisaAdapter.this.e.get(i))).getCardID(), i));
            }
        });
    }
}
