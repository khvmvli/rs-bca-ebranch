...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ConfirmBCACardAdapter.class */
public final class ConfirmBCACardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    Context b;
    public RealmResults<CreditCardOptions> e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ConfirmBCACardAdapter$ViewHolder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ConfirmBCACardAdapter$ViewHolder_ViewBinding.class */
    ...
    public final void b(RealmResults<CreditCardOptions> realmResults) {
        this.e = realmResults;
    }
