...
import com.bca.smartbranch.activity.CC6MastercardInfoActivity;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseMastercardAdapter.class */
public final class ChooseMastercardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    SparseBooleanArray b = new SparseBooleanArray();
    public Context e;
    public List<CreditCardOptions> g;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseMastercardAdapter$ViewHolder.class */
    public class ViewHolder extends setOnStartEnterTransitionListener$OnBackPressedDispatcher$LifecycleOnBackPressedCancellable {
        ...
        public ViewHolder(View view) {
            super(view);
            ChooseMastercardAdapter.this = r4;
            ButterKnife.bind(this, view);
        }

        @OnClick({2131296844, 2131298890, 2131297351, 2131297341})
        public void onClickPilih(View view) {
            ChooseMastercardAdapter.this.b.put(c(), !ChooseMastercardAdapter.this.b.get(c()));
            documentProvider.b().d(new PilihKotaActivity(d(), "type_mastercard", !ChooseMastercardAdapter.this.g.get(d()).isChecked()));
        }
    }

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseMastercardAdapter$ViewHolder_ViewBinding.class */
    public class ViewHolder_ViewBinding implements Unbinder {
        ...
        public ViewHolder_ViewBinding(final ViewHolder viewHolder, View view) {
            ...
            findRequiredView.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseMastercardAdapter.ViewHolder_ViewBinding.3
            ...
            findRequiredView2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseMastercardAdapter.ViewHolder_ViewBinding.5
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseMastercardAdapter.ViewHolder_ViewBinding.4
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseMastercardAdapter.ViewHolder_ViewBinding.2
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, int i) {
        ...
        viewHolder2.tvInfo.setOnClickListener(new View.OnClickListener(i) { // from class: o.DetailStatusPengajuanCCNotificationActivity_ViewBinding
            ...
            public final void onClick(View view) {
                ChooseMastercardAdapter chooseMastercardAdapter = ChooseMastercardAdapter.this;
                int i2 = this.b;
                Intent intent = new Intent(chooseMastercardAdapter.e, CC6MastercardInfoActivity.class);
                intent.putExtra("card_name", chooseMastercardAdapter.g.get(i2).getCardName());
                intent.putExtra("card_image", chooseMastercardAdapter.g.get(i2).getCardImagePath());
                intent.putStringArrayListExtra("card_benefit", new ArrayList<>(chooseMastercardAdapter.g.get(i2).getBenefit()));
                intent.putExtra("is_checked", chooseMastercardAdapter.g.get(i2).isChecked());
                intent.putExtra("index", i2);
                intent.putExtra("card_orientation", chooseMastercardAdapter.g.get(i2).getCardImageOrientation());
                intent.putExtra("card_annual_fee_basic", chooseMastercardAdapter.g.get(i2).getAnnualFeeBasicDisplayAmount());
                intent.putExtra("card_income", chooseMastercardAdapter.g.get(i2).getIncomeDisplayAmount());
                chooseMastercardAdapter.e.startActivity(intent);
            }
        });
    }
}
