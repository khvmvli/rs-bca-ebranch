...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahSubVisaCardAdapter.class */
public final class UbahSubVisaCardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    public long b;
    public Context e;
    public String f;
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahSubVisaCardAdapter$ViewHolder.class */
    public class ViewHolder extends setOnStartEnterTransitionListener$OnBackPressedDispatcher$LifecycleOnBackPressedCancellable {
        ...
        public ViewHolder(View view) {
            super(view);
            UbahSubVisaCardAdapter.this = r4;
            ButterKnife.bind(this, view);
        }

        @OnClick({2131296844, 2131298890, 2131297351, 2131297341})
        public void onClickPilih(View view) {
            documentProvider.b().d(new PilihSumberSetoranActivity(d(), !((CreditCardOptions) UbahSubVisaCardAdapter.this.g.get(d())).isChecked()));
        }
    }

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/UbahSubVisaCardAdapter$ViewHolder_ViewBinding.class */
    public class ViewHolder_ViewBinding implements Unbinder {
        ...
        public ViewHolder_ViewBinding(final ViewHolder viewHolder, View view) {
            ...
            findRequiredView.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahSubVisaCardAdapter.ViewHolder_ViewBinding.2
            ...
            findRequiredView2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahSubVisaCardAdapter.ViewHolder_ViewBinding.3
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahSubVisaCardAdapter.ViewHolder_ViewBinding.4
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.UbahSubVisaCardAdapter.ViewHolder_ViewBinding.5
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, int i) {
        ...
        viewHolder2.tvInfo.setOnClickListener(new View.OnClickListener(i) { // from class: o.ForgotPassSuccessActivity_ViewBinding
            ...
            public final void onClick(View view) {
                UbahSubVisaCardAdapter ubahSubVisaCardAdapter = UbahSubVisaCardAdapter.this;
                int i2 = this.e;
                Intent intent = new Intent(ubahSubVisaCardAdapter.e, CC4BCACardInfoActivity.class);
                intent.putExtra("current_user_id", ubahSubVisaCardAdapter.f);
                intent.putExtra("current_cc_id", ubahSubVisaCardAdapter.b);
                intent.putExtra("card_name", ubahSubVisaCardAdapter.g.get(i2).getCardName());
                intent.putExtra("card_image", ubahSubVisaCardAdapter.g.get(i2).getCardImagePath());
                intent.putStringArrayListExtra("card_benefit", new ArrayList<>(ubahSubVisaCardAdapter.g.get(i2).getBenefit()));
                intent.putExtra("is_checked", ubahSubVisaCardAdapter.g.get(i2).isChecked());
                intent.putExtra("index", i2);
                intent.putExtra("card_orientation", ubahSubVisaCardAdapter.g.get(i2).getCardImageOrientation());
                intent.putExtra("card_annual_fee_basic", ubahSubVisaCardAdapter.g.get(i2).getAnnualFeeBasicDisplayAmount());
                intent.putExtra("card_income", ubahSubVisaCardAdapter.g.get(i2).getIncomeDisplayAmount());
                ubahSubVisaCardAdapter.e.startActivity(intent);
            }
        });
    }
}
