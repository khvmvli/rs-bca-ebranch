...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseBCACardAdapter.class */
public final class ChooseBCACardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    public List<CreditCardOptions> b;
    public Context e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseBCACardAdapter$ViewHolder.class */
    public class ViewHolder extends setOnStartEnterTransitionListener$OnBackPressedDispatcher$LifecycleOnBackPressedCancellable {
        ...
        public ViewHolder(View view) {
            super(view);
            ChooseBCACardAdapter.this = r4;
            ButterKnife.bind(this, view);
        }

        @OnClick({2131296844, 2131298890, 2131297351, 2131297341})
        public void onClickPilih(View view) {
            documentProvider.b().d(new PilihJenisMataUangActivity(d(), !((CreditCardOptions) ChooseBCACardAdapter.this.b.get(d())).isChecked()));
        }
    }

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ChooseBCACardAdapter$ViewHolder_ViewBinding.class */
    public class ViewHolder_ViewBinding implements Unbinder {
        ...
        public ViewHolder_ViewBinding(final ViewHolder viewHolder, View view) {
            ...
            findRequiredView.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseBCACardAdapter.ViewHolder_ViewBinding.1
            ...
            findRequiredView2.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseBCACardAdapter.ViewHolder_ViewBinding.4
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView3.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseBCACardAdapter.ViewHolder_ViewBinding.2
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
            ...
            findRequiredView4.setOnClickListener(new DebouncingOnClickListener() { // from class: com.bca.smartbranch.adapter.ChooseBCACardAdapter.ViewHolder_ViewBinding.5
                @Override // butterknife.internal.DebouncingOnClickListener
                public final void doClick(View view2) {
                    viewHolder.onClickPilih(view2);
                }
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, int i) {
        ...
        viewHolder2.tvData.setText(this.b.get(i).getCardName());
        ...
        viewHolder2.tvInfo.setOnClickListener(new View.OnClickListener(i) { // from class: o.DetailStatusPengajuanCCActivity
            ...
            public final void onClick(View view) {
                ChooseBCACardAdapter chooseBCACardAdapter = ChooseBCACardAdapter.this;
                int i2 = this.d;
                Intent intent = new Intent(chooseBCACardAdapter.e, CC4BCACardInfoActivity.class);
                intent.putExtra("card_name", chooseBCACardAdapter.b.get(i2).getCardName());
                intent.putExtra("card_image", chooseBCACardAdapter.b.get(i2).getCardImagePath());
                intent.putStringArrayListExtra("card_benefit", new ArrayList<>(chooseBCACardAdapter.b.get(i2).getBenefit()));
                intent.putExtra("is_checked", chooseBCACardAdapter.b.get(i2).isChecked());
                intent.putExtra("index", i2);
                intent.putExtra("card_orientation", chooseBCACardAdapter.b.get(i2).getCardImageOrientation());
                intent.putExtra("card_annual_fee_basic", chooseBCACardAdapter.b.get(i2).getAnnualFeeBasicDisplayAmount());
                intent.putExtra("card_income", chooseBCACardAdapter.b.get(i2).getIncomeDisplayAmount());
                chooseBCACardAdapter.e.startActivity(intent);
            }
        });
    }
}
