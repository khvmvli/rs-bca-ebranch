...
import o.BranchMapItemAdapter$BranchMapItemVH;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubMastercardAdapter.class */
public final class ReviewSubMastercardAdapter extends setOnStartEnterTransitionListener$MediaBrowserCompat$CustomActionResultReceiver<ViewHolder> {
    Context b;
    private RealmResults<CreditCardOptions> e;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubMastercardAdapter$ViewHolder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/adapter/ReviewSubMastercardAdapter$ViewHolder_ViewBinding.class */
    ...
    public final /* synthetic */ void e(ViewHolder viewHolder, final int i) {
        ...
        viewHolder2.ivCloase.setOnClickListener(new View.OnClickListener() { // from class: com.bca.smartbranch.adapter.ReviewSubMastercardAdapter.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                documentProvider.b().d(new BranchMapItemAdapter$BranchMapItemVH(((CreditCardOptions) Objects.requireNonNull((CreditCardOptions) ReviewSubMastercardAdapter.this.e.get(i))).getCardID(), i, false));
            }
        });
    }
}
