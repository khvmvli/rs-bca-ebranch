...
@Parcel
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/data/api/response/ActivateEChannelResponse.class */
public class ActivateEChannelResponse {
    @infoContactPersonDialogEvent(c = "TxnDataOutput")
    private TxnDataOutput txnDataOutput;

    @Parcel
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/data/api/response/ActivateEChannelResponse$Description.class */
    ...
    @Parcel
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/data/api/response/ActivateEChannelResponse$TxnDataOutput.class */
    public static class TxnDataOutput {
        ...
        @infoContactPersonDialogEvent(c = "Note")
        private String note;
