...
@Parcel
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/data/api/response/MasterFundSourcePurposeResponse.class */
public class MasterFundSourcePurposeResponse {
    @infoContactPersonDialogEvent(c = "categories")
    private List<Category> categories = null;
    @infoContactPersonDialogEvent(c = "FundSource")
    private String[] fundSource;
    @infoContactPersonDialogEvent(c = "TransactionPurpose")
    private String[] transactionPurpose;

    @Parcel
    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/data/api/response/MasterFundSourcePurposeResponse$Category.class */
    ...
    public void setFundSource(String[] strArr) {
        this.fundSource = strArr;
    }

    public void setTransactionPurpose(String[] strArr) {
        this.transactionPurpose = strArr;
    }
}
