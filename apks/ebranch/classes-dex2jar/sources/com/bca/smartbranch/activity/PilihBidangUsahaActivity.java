...
import com.bca.smartbranch.adapter.ListBidangUsahaAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/PilihBidangUsahaActivity.class */
public class PilihBidangUsahaActivity extends BaseActivityPostLogin implements TextWatcher, GetDaftarDetailPekerjaanPresenter.write {
    @BindView(2131296980)
    EditText etFilter;
    List<GetDaftarPekerjaanResponse.DataPekerjaanOutput> f = new ArrayList();
    private ListBidangUsahaAdapter n;
    private GetDaftarDetailPekerjaanPresenter q;
    @BindView(2131298328)
    ...
    public void afterTextChanged(Editable editable) {
        ...
        ListBidangUsahaAdapter listBidangUsahaAdapter = this.n;
        listBidangUsahaAdapter.b = arrayList;
        listBidangUsahaAdapter.a.b();
    }
    ...
    public final void b(GetDaftarPekerjaanResponse getDaftarPekerjaanResponse) {
        ...
        this.n = new ListBidangUsahaAdapter(this, daftarPekerjaanOutputList);
    ...
    public void onDestroy() {
        GetDaftarDetailPekerjaanPresenter getDaftarDetailPekerjaanPresenter = this.q;
