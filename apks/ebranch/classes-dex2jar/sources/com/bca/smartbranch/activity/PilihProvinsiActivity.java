...
import com.bca.smartbranch.adapter.ListProvinsiAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/PilihProvinsiActivity.class */
public class PilihProvinsiActivity extends BaseActivityPostLogin implements TextWatcher, GetAddressPresenter.IconCompatParcelizer {
    @BindView(2131296980)
    EditText etFilter;
    private ListProvinsiAdapter n;
    @BindView(2131298328)
    ...
    public void afterTextChanged(Editable editable) {
        ...
        ListProvinsiAdapter listProvinsiAdapter = this.n;
        listProvinsiAdapter.b = arrayList;
        listProvinsiAdapter.a.b();
    }
    ...
    public final void c(OpenAccountActivity openAccountActivity) {
        this.f.addAll(openAccountActivity.c);
        this.n = new ListProvinsiAdapter(this, this.f, this.r);
    ...
    public final void d(Bundle bundle) {
        ...
        i().d(true);
        i().d("");
        this.txtToolbarTitle.setText("Pilih Provinsi");
    ...
    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseProvinsiRes(o.PilihProvinsiActivity pilihProvinsiActivity) {
        getPromotion.d(this);
        finish();
    }
    ...
    protected final void p() {
        setCardSlogan.e().b = "PilihProvinsiActivity";
        this.j = "PilihProvinsiActivity";
    }
