...
import com.bca.smartbranch.adapter.DaftarTransferBTAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/DaftarTransferBTActivity.class */
public class DaftarTransferBTActivity extends BaseActivityPostLogin implements DaftarTransferPresenter.RemoteActionCompatParcelizer {
    @BindString(2131821439)
    String daftarTransfer;
    private DaftarTransferBTAdapter f;
    @BindView(2131297634)
    LinearLayout llEmpty;
    @BindView(2131297969)
    LinearLayout lnMain;
    private List<DaftarTransferResponse.DaftarTransferOutput> n = new ArrayList();
    private DaftarTransferPresenter q;
    ...
    public final void d(Bundle bundle) {
        ...
        this.q = daftarTransferPresenter;
        daftarTransferPresenter.c = this;
        this.f = new DaftarTransferBTAdapter(this, this.n);
    ...
    public final void e(List<DaftarTransferResponse.DaftarTransferOutput> list) {
        ...
        this.n = list;
        DaftarTransferBTAdapter daftarTransferBTAdapter = this.f;
        daftarTransferBTAdapter.b = list;
        daftarTransferBTAdapter.a.b();
    }
    ...
    public void onDestroy() {
        onDestroy();
        DaftarTransferPresenter daftarTransferPresenter = this.q;
    ...
    public void onResume() {
        onResume();
        this.q.d(new InfoProductActivity(this.m.getEmail(), this.m.getSessionId(), this.m.getImei(), "Transfer ke Bank Lain"), true);
    }

    @Override // com.bca.smartbranch.activity.BaseActivityPostLogin
    protected final void p() {
        setCardSlogan.e().b = "DaftarTransferBTActivity";
        this.j = "DaftarTransferBTActivity";
    }
