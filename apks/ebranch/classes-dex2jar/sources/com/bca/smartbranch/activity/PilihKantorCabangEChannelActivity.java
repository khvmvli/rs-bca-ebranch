...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/PilihKantorCabangEChannelActivity.class */
public class PilihKantorCabangEChannelActivity extends BaseActivityPostLogin implements TextWatcher {
    @BindView(2131296980)
    EditText etFilter;
    private boolean f;
    @BindView(2131297766)
    ...
    private Reservation q;
    @BindView(2131298328)
    setOnStartEnterTransitionListener rvKantorCabang;
    private List<GetBranchReservationResponse.ReservationBranch> s = new ArrayList();
    private Location t;
    ...
    public void afterTextChanged(Editable editable) {
        ...
        for (GetBranchReservationResponse.ReservationBranch reservationBranch : this.s) {
    ...
    public final void d(Bundle bundle) {
        ...
        this.s = (List) ListUtil.OneItemImmutableList.a(extras.getParcelable("listBranch"));
        Location location = new Location("");
        this.t = location;
        location.setLatitude(extras.getDouble("LAT"));
        this.t.setLongitude(extras.getDouble("LONG"));
        this.n = new KantorCabangAdapter(this, this.s, this.t);
        this.rvKantorCabang.setLayoutManager(new LinearLayoutManager(1, false));
        this.rvKantorCabang.setAdapter(this.n);
        this.q = (Reservation) ListUtil.OneItemImmutableList.a(extras.getParcelable("reservation_data"));
    ...
    protected final void p() {
        setCardSlogan.e().b = "PilihKantorCabangEChannelActivity";
        this.j = "PilihKantorCabangEChannelActivity";
    }
