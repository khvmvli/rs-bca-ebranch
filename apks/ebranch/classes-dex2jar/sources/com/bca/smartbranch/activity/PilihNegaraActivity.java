...
import com.bca.smartbranch.adapter.ListNegaraAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/PilihNegaraActivity.class */
public class PilihNegaraActivity extends BaseActivityPostLogin implements TextWatcher, GetCountriesPresenter$MediaBrowserCompat$CustomActionResultReceiver {
    @BindView(2131296980)
    EditText etFilter;
    List<OpenCCSuccessActivity_ViewBinding.read> f = new ArrayList();
    @BindView(2131297813)
    LinearLayout llNegaraTidakDitemukan;
    private ListNegaraAdapter n;
    private GetCountriesPresenter r;
    @BindView(2131298328)
    ...
    public void afterTextChanged(Editable editable) {
        ...
        ListNegaraAdapter listNegaraAdapter = this.n;
        listNegaraAdapter.b = arrayList;
        listNegaraAdapter.a.b();
        if (arrayList.size() <= 0) {
    ...
    public final void b(OpenCCSuccessActivity_ViewBinding openCCSuccessActivity_ViewBinding) {
        ...
        this.n = new ListNegaraAdapter(this, openCCSuccessActivity_ViewBinding.c);
    ...
    public void onDestroy() {
        onDestroy();
        GetCountriesPresenter getCountriesPresenter = this.r;
    ...
    protected final void p() {
        setCardSlogan.e().b = "PilihNegaraActivity";
        this.j = "PilihNegaraActivity";
    }
