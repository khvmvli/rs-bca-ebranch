...
import com.bca.smartbranch.adapter.DaftarTransferAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/DaftarTransferActivity.class */
public class DaftarTransferActivity extends BaseActivityPostLogin implements DaftarTransferPresenter.RemoteActionCompatParcelizer {
    @BindString(2131821439)
    String daftarTransfer;
    private DaftarTransferAdapter f;
    @BindView(2131297634)
    ...
    public final void d(Bundle bundle) {
        d(bundle);
        this.q = (ViewAnimator) findViewById(2131299749);
        b(this.toolbar);
        i();
        i().d(true);
        i().d("");
        ...
        this.f = new DaftarTransferAdapter(this, this.n);
    ...
    public final void e(List<DaftarTransferResponse.DaftarTransferOutput> list) {
        ...
        this.n = list;
        DaftarTransferAdapter daftarTransferAdapter = this.f;
        daftarTransferAdapter.b = list;
        daftarTransferAdapter.a.b();
    }
    ...
    public void onResume() {
        onResume();
        this.p.d(new InfoProductActivity(this.m.getEmail(), this.m.getSessionId(), this.m.getImei(), "Setoran Tunai"), true);
    }

    @Override // com.bca.smartbranch.activity.BaseActivityPostLogin
    protected final void p() {
        setCardSlogan.e().b = "DaftarTransferActivity";
        this.j = "DaftarTransferActivity";
    }
