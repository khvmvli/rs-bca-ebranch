...
import com.bca.smartbranch.adapter.ListKelurahanAdapter;
...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/activity/PilihKelurahanActivity.class */
public class PilihKelurahanActivity extends BaseActivityPostLogin implements TextWatcher, GetAddressPresenter.IconCompatParcelizer {
    @BindView(2131296980)
    EditText etFilter;
    private ListKelurahanAdapter n;
    @BindView(2131298328)
    setOnStartEnterTransitionListener rvListItem;
    private GetAddressPresenter t;
    ...
    public void afterTextChanged(Editable editable) {
        ...
        ListKelurahanAdapter listKelurahanAdapter = this.n;
        listKelurahanAdapter.b = arrayList;
        listKelurahanAdapter.a.b();
    }
    ...
    public final void c(OpenAccountActivity openAccountActivity) {
        this.f.addAll(openAccountActivity.d);
        this.n = new ListKelurahanAdapter(this, this.f, this.q);
    ...
    public final void d(Bundle bundle) {
        ...
        i().d(true);
        i().d("");
        this.txtToolbarTitle.setText("Pilih Kelurahan");
        GetAddressPresenter getAddressPresenter = new GetAddressPresenter();
        this.t = getAddressPresenter;
    ...
    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseKelurahanHome(o.PilihKelurahanActivity pilihKelurahanActivity) {
        getPromotion.d(this);
        finish();
    }

    @Stetho$Initializer$RealSocketHandlerFactory
    public void onChooseKelurahanHome(onChooseKodePos onchoosekodepos) {
        getPromotion.d(this);
        finish();
    }
    ...
    public void onDestroy() {
        onDestroy();
        GetAddressPresenter getAddressPresenter = this.t;
    ...
    protected final void p() {
        setCardSlogan.e().b = "PilihKelurahanActivity";
        this.j = "PilihKelurahanActivity";
    }
