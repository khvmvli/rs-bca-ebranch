...
/* loaded from: classes-dex2jar.jar:com/bca/smartbranch/presenter/RequestOTPPresenter.class */
public class RequestOTPPresenter {
    public Call<OpenAccountSuccessActivity> a;
    @onClickNegara
    public setIncomeDisplayAmount apiService;
    public IconCompatParcelizer b;

    /* loaded from: classes-dex2jar.jar:com/bca/smartbranch/presenter/RequestOTPPresenter$IconCompatParcelizer.class */
    ...
    public RequestOTPPresenter() {
        App.d().a(this);
    }

    public final void b(LandingActivity_ViewBinding landingActivity_ViewBinding) {
        this.b.b();
        Call<OpenAccountSuccessActivity> d = this.apiService.d(landingActivity_ViewBinding);
        this.a = d;
        d.enqueue(new Callback<OpenAccountSuccessActivity>() { // from class: com.bca.smartbranch.presenter.RequestOTPPresenter.3
            public final void onFailure(Call<OpenAccountSuccessActivity> call, Throwable th) {
                String str;
                if (RequestOTPPresenter.this.a != null && !RequestOTPPresenter.this.a.isCanceled()) {
                    IconCompatParcelizer iconCompatParcelizer = RequestOTPPresenter.this.b;
                    if (th != null) {
            ...
            public final void onResponse(Call<OpenAccountSuccessActivity> call, Response<OpenAccountSuccessActivity> response) {
                if (response.isSuccessful()) {
                    ...
                    if ((str3 != null ? str3 : detailrtgscny3.c).equals("MID-00-898")) {
                        IconCompatParcelizer iconCompatParcelizer2 = RequestOTPPresenter.this.b;
                        ...
                        iconCompatParcelizer2.e(detailrtgscny_mediabrowsercompat_customactionresultreceiver2 != null ? detailrtgscny_mediabrowsercompat_customactionresultreceiver2.c : detailrtgscny4.b);
                        return;
                    }
                    ...
                    if ((str4 != null ? str4 : detailrtgscny5.c).equals("MID-00-899")) {
                        IconCompatParcelizer iconCompatParcelizer3 = RequestOTPPresenter.this.b;
                    ...
                    IconCompatParcelizer iconCompatParcelizer4 = RequestOTPPresenter.this.b;
                    ...
                    iconCompatParcelizer4.c(detailrtgscny_mediabrowsercompat_customactionresultreceiver4 != null ? detailrtgscny_mediabrowsercompat_customactionresultreceiver4.c : detailrtgscny7.b);
                    return;
                }
                RequestOTPPresenter.this.b.d(response.message());
            }
        });
    }
}
