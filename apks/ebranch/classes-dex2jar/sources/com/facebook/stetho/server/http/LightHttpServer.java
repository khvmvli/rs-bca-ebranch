...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/server/http/LightHttpServer.class */
public class LightHttpServer {
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageReader.class */
    public static class HttpMessageReader {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes-dex2jar.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageReader$NewLineDetector.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageWriter.class */
        ...
        while (true) {
            ...
            if (readLine == null) {
                ...
                if (split.length == 2) {
                    ...
                    StringBuilder sb = new StringBuilder("Malformed header: ");
                    sb.append(readLine);
    ...
    private static LightHttpRequest readRequestMessage(LightHttpRequest lightHttpRequest, HttpMessageReader httpMessageReader) throws IOException {
        ...
        StringBuilder sb = new StringBuilder("Invalid request line: ");
        sb.append(readLine);
        throw new IOException(sb.toString());
    }
