...
public class StethoInterceptor implements Interceptor {
    ...
    static class ForwardingResponseBody extends ResponseBody {
        ...
        private final setTookMs mInterceptedSource;

        public ForwardingResponseBody(ResponseBody responseBody, InputStream inputStream) {
            this.mBody = responseBody;
            this.mInterceptedSource = ChuckerDatabase.b(ChuckerDatabase.d(inputStream));
        }
    ...
    static class OkHttpInspectorRequest implements NetworkEventReporter.InspectorRequest {
        ...
        public byte[] body() throws IOException {
            ...
            setScheme$com_github_ChuckerTeam_Chucker_library d = ChuckerDatabase.d(ChuckerDatabase.b(this.mRequestBodyHelper.createBodySink(firstHeaderValue("Content-Encoding"))));
            try {
                body.writeTo(d);
                d.close();
