...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/dumpapp/plugins/HprofDumperPlugin.class */
public class HprofDumperPlugin implements DumperPlugin {
    ...
    private void handlePipeOutput(OutputStream outputStream) throws DumpException {
        ...
        try {
            ...
            try {
                ...
                StringBuilder sb = new StringBuilder("Failure copying ");
    ...
    public void dump(DumperContext dumperContext) throws DumpException {
        ...
        if (next == null) {
            ...
            File file2 = file;
            if (!file.isAbsolute()) {
                file2 = this.mContext.getFileStreamPath(next);
            }
            writeHprof(file2);
            StringBuilder sb = new StringBuilder("Wrote to ");
            sb.append(file2);
