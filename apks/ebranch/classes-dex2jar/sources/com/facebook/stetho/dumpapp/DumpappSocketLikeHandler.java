...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/dumpapp/DumpappSocketLikeHandler.class */
    ...
    private String[] readArgs(Framer framer) throws IOException {
        ...
        synchronized (framer) {
            ...
            if (readFrameType == 33) {
                ...
                StringBuilder sb = new StringBuilder("Expected enter frame, got: ");
                sb.append((int) readFrameType);
