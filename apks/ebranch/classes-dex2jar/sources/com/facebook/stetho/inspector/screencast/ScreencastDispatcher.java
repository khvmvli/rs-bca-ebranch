...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/screencast/ScreencastDispatcher.class */
public final class ScreencastDispatcher {
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/screencast/ScreencastDispatcher$BitmapFetchRunnable.class */
            ...
            if (ScreencastDispatcher.this.mIsRunning && (tryGetTopActivity = ScreencastDispatcher.this.mActivityTracker.tryGetTopActivity()) != null) {
                ...
                try {
                    if (ScreencastDispatcher.this.mBitmap == null) {
                        ...
                        float f = (float) width;
                        float f2 = ((float) ScreencastDispatcher.this.mRequest.maxWidth) / f;
                        float f3 = (float) height;
                        float min = Math.min(f2, ((float) ScreencastDispatcher.this.mRequest.maxHeight) / f3);
                        int i = (int) (f * min);
                        int i2 = (int) (min * f3);
                        ...
                        ScreencastDispatcher.this.mTempSrc.set(0.0f, 0.0f, f, f3);
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/screencast/ScreencastDispatcher$CancellationRunnable.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/screencast/ScreencastDispatcher$EventDispatchRunnable.class */
