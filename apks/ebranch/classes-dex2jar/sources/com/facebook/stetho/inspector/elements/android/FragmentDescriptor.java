...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/elements/android/FragmentDescriptor.class */
final class FragmentDescriptor extends AbstractChainedDescriptor<Object> implements HighlightableDescriptor<Object> {
    ...
    public final Object getElementToHighlightAtPosition(Object obj, int i, int i2, Rect rect) {
        ...
        if (highlightableDescriptor != null) {
            obj2 = highlightableDescriptor.getElementToHighlightAtPosition(view, i, i2, rect);
        }
        return obj2;
    }
    ...
    public final void onGetAttributes(Object obj, AttributeAccumulator attributeAccumulator) {
    ...
    @Override // com.facebook.stetho.inspector.elements.AbstractChainedDescriptor
    public final void onGetChildren(Object obj, Accumulator<Object> accumulator) {
