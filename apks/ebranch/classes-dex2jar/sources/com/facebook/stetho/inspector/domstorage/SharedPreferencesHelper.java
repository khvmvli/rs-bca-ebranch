...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/domstorage/SharedPreferencesHelper.class */
public class SharedPreferencesHelper {
    ...
    private static Boolean parseBoolean(String str) throws IllegalArgumentException {
        ...
        StringBuilder sb = new StringBuilder("Expected boolean, got ");
        sb.append(str);
