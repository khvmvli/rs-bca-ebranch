...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/elements/android/AndroidDocumentProvider.class */
public final class AndroidDocumentProvider extends ThreadBoundProxy implements DocumentProvider, AndroidDescriptorHost {
    ...
    private final Runnable mReportChangesTimer = new Runnable() { // from class: com.facebook.stetho.inspector.elements.android.AndroidDocumentProvider.1
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/elements/android/AndroidDocumentProvider$InspectModeHandler.class */
    public final class InspectModeHandler {
        private List<View> mOverlays;
        private final Predicate<View> mViewSelector;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/elements/android/AndroidDocumentProvider$InspectModeHandler$OverlayView.class */
    ...
    @Nullable
    public final HighlightableDescriptor getHighlightableDescriptor(@Nullable Object obj) {
        if (obj == null) {
            return null;
        }
        ...
        while (highlightableDescriptor == null && cls != null) {
            ...
            if (descriptor2 != descriptor) {
                highlightableDescriptor = highlightableDescriptor;
                if (descriptor2 instanceof HighlightableDescriptor) {
