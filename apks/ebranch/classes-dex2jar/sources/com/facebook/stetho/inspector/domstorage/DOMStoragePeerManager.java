...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/domstorage/DOMStoragePeerManager.class */
public class DOMStoragePeerManager extends ChromePeerManager {
    private final Context mContext;
    private final PeerRegistrationListener mPeerListener;

    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/domstorage/DOMStoragePeerManager$DevToolsSharedPreferencesListener.class */
    ...
    public DOMStoragePeerManager(Context context) {
        AnonymousClass1 r0 = new PeersRegisteredListener() { // from class: com.facebook.stetho.inspector.domstorage.DOMStoragePeerManager.1
