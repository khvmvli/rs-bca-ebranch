...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage.class */
public class DOMStorage implements ChromeDevtoolsDomain {
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$DOMStorageAssignmentException.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$DomStorageItemAddedParams.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$DomStorageItemRemovedParams.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$DomStorageItemUpdatedParams.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$DomStorageItemsClearedParams.class */
    public static class DomStorageItemsClearedParams {
        @JsonProperty(required = true)
        public StorageId storageId;
    }

    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$GetDOMStorageItemsResult.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/inspector/protocol/module/DOMStorage$StorageId.class */
        ...
        if (storageId.isLocalStorage) {
            ...
            try {
                if (obj != null) {
                    ...
                    StringBuilder sb = new StringBuilder("Unsupported: cannot add new key ");
                    sb.append(string);
