...
public final class ApplicationDescriptor extends AbstractChainedDescriptor<Application> {
    ...
    protected final void onGetChildren2(Application application, Accumulator<Object> accumulator) {
    ...
    public final /* bridge */ /* synthetic */ void onGetChildren(Application application, Accumulator accumulator) {
        onGetChildren2(application, (Accumulator<Object>) accumulator);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final NodeType onGetNodeType(Application application) {
        return NodeType.ELEMENT_NODE;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final void onHook(Application application) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void onUnhook(Application application) {
