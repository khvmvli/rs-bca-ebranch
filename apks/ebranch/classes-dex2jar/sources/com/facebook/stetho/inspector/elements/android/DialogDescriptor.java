...
final class DialogDescriptor extends AbstractChainedDescriptor<Dialog> implements HighlightableDescriptor<Dialog> {
    ...
    protected final void onGetChildren2(Dialog dialog, Accumulator<Object> accumulator) {
    ...
    public final /* bridge */ /* synthetic */ void onGetChildren(Dialog dialog, Accumulator accumulator) {
