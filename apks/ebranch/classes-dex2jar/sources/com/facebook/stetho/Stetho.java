...
/* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho.class */
public class Stetho {

    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$BuilderBasedInitializer.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$DefaultDumperPluginsBuilder.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$DefaultInspectorModulesBuilder.class */
    public static final class DefaultInspectorModulesBuilder {
        ...
        private DocumentProviderFactory resolveDocumentProvider() {
            ...
            return documentProviderFactory != null ? documentProviderFactory : new AndroidDocumentProviderFactory(this.mContext, Collections.emptyList());
        }
        ...
        public final Iterable<ChromeDevtoolsDomain> finish() {
            ...
            RuntimeReplFactory runtimeReplFactory2 = runtimeReplFactory;
            if (runtimeReplFactory == null) {
                runtimeReplFactory2 = new RhinoDetectingRuntimeReplFactory(this.mContext);
            }
            provideIfDesired(new Runtime(runtimeReplFactory2));
            ...
            boolean z2 = false;
            if (list != null) {
                Iterator<DatabaseDriver2> it = list.iterator();
                while (true) {
                    z = z2;
                    if (!it.hasNext()) {
                        break;
                    }
                    DatabaseDriver2 next = it.next();
                    database.add(next);
            ...
            if (!z && !this.mExcludeSqliteDatabaseDriver) {
                ...
                DatabaseFilesProvider databaseFilesProvider2 = databaseFilesProvider;
                if (databaseFilesProvider == null) {
                    databaseFilesProvider2 = new DefaultDatabaseFilesProvider(application);
                }
                database.add(new SqliteDatabaseDriver(application, databaseFilesProvider2, new DefaultDatabaseConnectionProvider()));
            }
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$Initializer.class */
    public static abstract class Initializer {
        private final Context mContext;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$Initializer$RealSocketHandlerFactory.class */
    ...
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$InitializerBuilder.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes-dex2jar.jar:com/facebook/stetho/Stetho$PluginBuilder.class */
