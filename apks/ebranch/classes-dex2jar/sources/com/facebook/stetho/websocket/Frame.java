...
public class Frame {
    ...
    private long decodeLength(byte b, InputStream inputStream) throws IOException {
        ...
        StringBuilder sb = new StringBuilder("Unexpected length byte: ");
        sb.append((int) b);
    ...
    private byte encodeFirstByte() {
        byte b = this.fin ? Byte.MIN_VALUE : 0;
        byte b2 = b;
        if (this.rsv1) {
            b2 = (byte) (b | 64);
        }
    ...
    private static byte[] encodeLength(long j) {
        return j <= 125 ? new byte[]{(byte) ((int) j)} : j <= 65535 ? new byte[]{126, (byte) ((int) ((j >> 8) & 255)), (byte) ((int) (j & 255))} : new byte[]{Byte.MAX_VALUE, (byte) ((int) ((j >> 56) & 255)), (byte) ((int) ((j >> 48) & 255)), (byte) ((int) ((j >> 40) & 255)), (byte) ((int) ((j >> 32) & 255)), (byte) ((int) ((j >> 24) & 255)), (byte) ((int) ((j >> 16) & 255)), (byte) ((int) ((j >> 8) & 255)), (byte) ((int) (j & 255))};
    }
    ...
    public void readFrom(BufferedInputStream bufferedInputStream) throws IOException {
        ...
        int i = (int) this.payloadLen;
        byte[] bArr = new byte[i];
        this.payloadData = bArr;
        readBytesOrThrow(bufferedInputStream, bArr, 0, i);
    ...
    public void writeTo(BufferedOutputStream bufferedOutputStream) throws IOException {
        ...
        if (this.hasMask) {
            encodeLength[0] = (byte) ((byte) (encodeLength[0] | 128));
        }
