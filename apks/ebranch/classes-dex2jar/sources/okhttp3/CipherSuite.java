...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", setMinWidth$MediaBrowserCompat$CustomActionResultReceiver.ct);
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", 106);
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", setMinWidth$MediaBrowserCompat$CustomActionResultReceiver.cz);
    public static final CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", setMinWidth$MediaBrowserCompat$CustomActionResultReceiver.cy);
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", setMinWidth$MediaBrowserCompat$CustomActionResultReceiver.cB);
    ...
    public static CipherSuite forJavaName(String str) {
        ...
        synchronized (CipherSuite.class) {
            try {
                ...
                CipherSuite cipherSuite2 = map.get(str);
                cipherSuite = cipherSuite2;
                if (cipherSuite2 == null) {
                    CipherSuite cipherSuite3 = map.get(secondaryName(str));
