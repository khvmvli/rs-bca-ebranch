...
public abstract class ParameterHandler<T> {
    ...
    public static final class Field<T> extends ParameterHandler<T> {
        ...
        @Override // retrofit2.ParameterHandler
        final void apply(RequestBuilder requestBuilder, @Nullable T t) throws IOException {
            String convert;
    ...
    public static final class FieldMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        @Override // retrofit2.ParameterHandler
        final /* bridge */ /* synthetic */ void apply(RequestBuilder requestBuilder, @Nullable Object obj) throws IOException {
            apply(requestBuilder, (Map) ((Map) obj));
        }

        final void apply(RequestBuilder requestBuilder, @Nullable Map<String, T> map) throws IOException {
            if (map != null) {
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            sb.append(key);
                            sb.append("\"");
                            requestBuilder.addPart(Headers.of("Content-Disposition", sb.toString(), "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
