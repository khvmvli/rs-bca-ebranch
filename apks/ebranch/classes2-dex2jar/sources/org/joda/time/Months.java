...
/* loaded from: classes2-dex2jar.jar:org/joda/time/Months.class */
public final class Months extends BaseSingleFieldPeriod {
    ...
    public static Months monthsBetween(ReadablePartial readablePartial, ReadablePartial readablePartial2) {
        return (!(readablePartial instanceof LocalDate) || !(readablePartial2 instanceof LocalDate)) ? months(BaseSingleFieldPeriod.between(readablePartial, readablePartial2, ZERO)) : months(DateTimeUtils.getChronology(readablePartial.getChronology()).months().getDifference(((LocalDate) readablePartial2).getLocalMillis(), ((LocalDate) readablePartial).getLocalMillis()));
    }

    public static Months monthsIn(ReadableInterval readableInterval) {
        return readableInterval == null ? ZERO : months(BaseSingleFieldPeriod.between((ReadableInstant) readableInterval.getStart(), (ReadableInstant) readableInterval.getEnd(), DurationFieldType.months()));
    }
    ...
    public final Months dividedBy(int i) {
    ...
    public final boolean isGreaterThan(Months months) {
        boolean z = false;
        boolean z2 = false;
        if (months == null) {
            if (getValue() > 0) {
    ...
    public final boolean isLessThan(Months months) {
        boolean z = false;
        boolean z2 = false;
        if (months == null) {
            if (getValue() < 0) {
    ...
    public final Months minus(int i) {
        return plus(FieldUtils.safeNegate(i));
    }

    public final Months minus(Months months) {
        return months == null ? this : minus(months.getValue());
    }

    public final Months multipliedBy(int i) {
    ...
    public final Months plus(int i) {
        return i == 0 ? this : months(FieldUtils.safeAdd(getValue(), i));
    }

    public final Months plus(Months months) {
