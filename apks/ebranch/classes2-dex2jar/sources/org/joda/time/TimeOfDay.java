...
@Deprecated
/* loaded from: classes2-dex2jar.jar:org/joda/time/TimeOfDay.class */
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
    ...
    @Deprecated
    /* loaded from: classes2-dex2jar.jar:org/joda/time/TimeOfDay$Property.class */
    ...
    public final TimeOfDay minus(ReadablePeriod readablePeriod) {
        return withPeriodAdded(readablePeriod, -1);
    }

    public final TimeOfDay minusHours(int i) {
        return withFieldAdded(DurationFieldType.hours(), FieldUtils.safeNegate(i));
    }

    public final TimeOfDay minusMillis(int i) {
        return withFieldAdded(DurationFieldType.millis(), FieldUtils.safeNegate(i));
    }

    public final TimeOfDay minusMinutes(int i) {
        return withFieldAdded(DurationFieldType.minutes(), FieldUtils.safeNegate(i));
    }

    public final TimeOfDay minusSeconds(int i) {
    ...
    public final TimeOfDay plus(ReadablePeriod readablePeriod) {
        return withPeriodAdded(readablePeriod, 1);
    }

    public final TimeOfDay plusHours(int i) {
        return withFieldAdded(DurationFieldType.hours(), i);
    }

    public final TimeOfDay plusMillis(int i) {
        return withFieldAdded(DurationFieldType.millis(), i);
    }

    public final TimeOfDay plusMinutes(int i) {
        return withFieldAdded(DurationFieldType.minutes(), i);
    }

    public final TimeOfDay plusSeconds(int i) {
    ...
    public final TimeOfDay withChronologyRetainFields(Chronology chronology) {
    ...
    public final TimeOfDay withField(DateTimeFieldType dateTimeFieldType, int i) {
    ...
    public final TimeOfDay withFieldAdded(DurationFieldType durationFieldType, int i) {
    ...
    public final TimeOfDay withSecondOfMinute(int i) {
