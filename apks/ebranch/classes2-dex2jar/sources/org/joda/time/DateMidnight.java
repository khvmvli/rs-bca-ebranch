...
@Deprecated
/* loaded from: classes2-dex2jar.jar:org/joda/time/DateMidnight.class */
public final class DateMidnight extends BaseDateTime implements ReadableDateTime, Serializable {
    private static final long serialVersionUID;

    /* loaded from: classes2-dex2jar.jar:org/joda/time/DateMidnight$Property.class */
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public final DateMidnight setCopy(int i) {
            DateMidnight dateMidnight = this.iInstant;
            return dateMidnight.withMillis(this.iField.set(dateMidnight.getMillis(), i));
        }

        public final DateMidnight setCopy(String str) {
            return setCopy(str, null);
        }

        public final DateMidnight setCopy(String str, Locale locale) {
            DateMidnight dateMidnight = this.iInstant;
    ...
    public final DateMidnight minus(long j) {
    ...
    public final DateMidnight plus(long j) {
        return withDurationAdded(j, 1);
    }
    ...
    public final DateMidnight withCenturyOfEra(int i) {
    ...
    public final DateMidnight withDayOfMonth(int i) {
        return withMillis(getChronology().dayOfMonth().set(getMillis(), i));
    }

    public final DateMidnight withDayOfWeek(int i) {
        return withMillis(getChronology().dayOfWeek().set(getMillis(), i));
    }

    public final DateMidnight withDayOfYear(int i) {
        return withMillis(getChronology().dayOfYear().set(getMillis(), i));
    }

    public final DateMidnight withDurationAdded(long j, int i) {
        return (j == 0 || i == 0) ? this : withMillis(getChronology().add(getMillis(), j, i));
    }

    public final DateMidnight withDurationAdded(ReadableDuration readableDuration, int i) {
        return (readableDuration == null || i == 0) ? this : withDurationAdded(readableDuration.getMillis(), i);
    }

    public final DateMidnight withEra(int i) {
        return withMillis(getChronology().era().set(getMillis(), i));
    }

    public final DateMidnight withField(DateTimeFieldType dateTimeFieldType, int i) {
        if (dateTimeFieldType != null) {
    ...
    public final DateMidnight withFieldAdded(DurationFieldType durationFieldType, int i) {
