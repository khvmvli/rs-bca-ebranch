...
/* loaded from: classes2-dex2jar.jar:org/joda/time/field/DelegatedDurationField.class */
public class DelegatedDurationField extends DurationField implements Serializable {
    ...
    public String toString() {
        ...
        if (this.iType == null) {
            durationField = this.iField;
        } else {
            durationField = new StringBuilder("DurationField[");
            durationField.append(this.iType);
