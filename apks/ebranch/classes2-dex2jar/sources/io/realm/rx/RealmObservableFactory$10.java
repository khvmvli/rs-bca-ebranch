...
public class RealmObservableFactory$10 implements showPelajarPage<RealmList<E>> {
    ...
    RealmObservableFactory$10(RealmObservableFactory realmObservableFactory, RealmList realmList, RealmConfiguration realmConfiguration) {
    ...
    public void subscribe(final Page6DTapresSFragment<RealmList<E>> page6DTapresSFragment) {
        if (this.val$list.isValid()) {
            ...
            final AnonymousClass1 r0 = new RealmChangeListener<RealmList<E>>() { // from class: io.realm.rx.RealmObservableFactory$10.1
                public void onChange(RealmList<E> realmList) {
                    if (realmList.isValid() && !page6DTapresSFragment.a() && RealmObservableFactory.access$100(RealmObservableFactory$10.this.this$0)) {
                        realmList.freeze();
                    }
                }
            };
            this.val$list.addChangeListener(r0);
            AnonymousClass2 r02 = new Runnable() { // from class: io.realm.rx.RealmObservableFactory$10.2
                @Override // java.lang.Runnable
                public void run() {
                    if (!instance.isClosed()) {
                        RealmObservableFactory$10.this.val$list.removeChangeListener(r0);
                        instance.close();
                    }
                    ((RealmObservableFactory.StrongReferenceCounter) RealmObservableFactory.access$300(RealmObservableFactory$10.this.this$0).get()).releaseReference(RealmObservableFactory$10.this.val$list);
                }
            };
