...
public class RealmObservableFactory$13 implements Page6ELFragment_ViewBinding<CollectionChange<RealmList<E>>> {
    ...
    RealmObservableFactory$13(RealmObservableFactory realmObservableFactory, RealmList realmList, RealmConfiguration realmConfiguration) {
    ...
    public void subscribe(final Page6ELFragment<CollectionChange<RealmList<E>>> page6ELFragment) {
        if (this.val$list.isValid()) {
            ...
            final AnonymousClass1 r0 = new OrderedRealmCollectionChangeListener<RealmList<E>>() { // from class: io.realm.rx.RealmObservableFactory$13.1
                public void onChange(RealmList<E> realmList, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                    if (realmList.isValid() && !page6ELFragment.a()) {
                        ...
                        if (RealmObservableFactory.access$100(RealmObservableFactory$13.this.this$0)) {
            ...
            AnonymousClass2 r02 = new Runnable() { // from class: io.realm.rx.RealmObservableFactory$13.2
                @Override // java.lang.Runnable
                public void run() {
                    if (!instance.isClosed()) {
                        RealmObservableFactory$13.this.val$list.removeChangeListener(r0);
                        instance.close();
                    }
                    ((RealmObservableFactory.StrongReferenceCounter) RealmObservableFactory.access$300(RealmObservableFactory$13.this.this$0).get()).releaseReference(RealmObservableFactory$13.this.val$list);
                }
            };
