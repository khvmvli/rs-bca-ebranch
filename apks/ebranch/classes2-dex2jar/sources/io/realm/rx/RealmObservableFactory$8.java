...
public class RealmObservableFactory$8 implements showPelajarPage<RealmResults<E>> {
    ...
    RealmObservableFactory$8(RealmObservableFactory realmObservableFactory, RealmResults realmResults, RealmConfiguration realmConfiguration) {
    ...
    public void subscribe(final Page6DTapresSFragment<RealmResults<E>> page6DTapresSFragment) {
        if (this.val$results.isValid()) {
            ...
            final AnonymousClass1 r0 = new RealmChangeListener<RealmResults<E>>() { // from class: io.realm.rx.RealmObservableFactory$8.1
                public void onChange(RealmResults<E> realmResults) {
                    if (!page6DTapresSFragment.a() && RealmObservableFactory.access$100(RealmObservableFactory$8.this.this$0)) {
                        realmResults.freeze();
                    }
                }
            };
            this.val$results.addChangeListener(r0);
            AnonymousClass2 r02 = new Runnable() { // from class: io.realm.rx.RealmObservableFactory$8.2
                @Override // java.lang.Runnable
                public void run() {
                    if (!instance.isClosed()) {
                        RealmObservableFactory$8.this.val$results.removeChangeListener(r0);
                        instance.close();
                    }
                    ((RealmObservableFactory.StrongReferenceCounter) RealmObservableFactory.access$200(RealmObservableFactory$8.this.this$0).get()).releaseReference(RealmObservableFactory$8.this.val$results);
                }
            };
