...
public final class InternalFlowFactory$from$3 extends showSiupNibPage implements onClickInfo<getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library<? super RealmResults<T>>, ProsesTarikanFragment<? super onCLickStatusNpwp>, Object> {
    ...
    InternalFlowFactory$from$3(InternalFlowFactory internalFlowFactory, RealmResults realmResults, RealmConfiguration realmConfiguration, ProsesTarikanFragment prosesTarikanFragment) {
    ...
    public final ProsesTarikanFragment<onCLickStatusNpwp> create(Object obj, ProsesTarikanFragment<?> prosesTarikanFragment) {
        ...
        InternalFlowFactory$from$3 internalFlowFactory$from$3 = new InternalFlowFactory$from$3(this.this$0, this.$results, this.$config, prosesTarikanFragment);
        internalFlowFactory$from$3.p$ = (getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library) obj;
        return internalFlowFactory$from$3;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((InternalFlowFactory$from$3) create(obj, (ProsesTarikanFragment) obj2)).invokeSuspend(onCLickStatusNpwp.e);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            final RealmChangeListener internalFlowFactory$from$3$listener$1 = new RealmChangeListener<RealmResults<T>>(getformattedresponsebody_com_github_chuckerteam_chucker_library) { // from class: io.realm.internal.coroutines.InternalFlowFactory$from$3$listener$1
                ...
                public final void onChange(RealmResults<T> realmResults) {
                    ...
                    if (LoginPresenter.c(this.$this_callbackFlow) && InternalFlowFactory.access$getReturnFrozenObjects$p(InternalFlowFactory$from$3.this.this$0)) {
                        realmResults.freeze();
                    }
                }
            ...
            this.$results.addChangeListener(internalFlowFactory$from$3$listener$1);
            if (InternalFlowFactory.access$getReturnFrozenObjects$p(this.this$0)) {
                this.$results.freeze();
            }
            this.L$0 = getformattedresponsebody_com_github_chuckerteam_chucker_library;
            this.L$1 = instance;
            this.L$2 = internalFlowFactory$from$3$listener$1;
            this.label = 2;
            if (getFormattedPath$com_github_ChuckerTeam_Chucker_library.e(getformattedresponsebody_com_github_chuckerteam_chucker_library, new pilihNoRek<onCLickStatusNpwp>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$from$3.2
                public final void invoke() {
                    Realm realm = instance;
                    subscribeReservationRescheduleEvent.a(realm, "");
                    if (!realm.isClosed()) {
                        InternalFlowFactory$from$3.this.$results.removeChangeListener(internalFlowFactory$from$3$listener$1);
                        instance.close();
                    }
                }
