...
public final class InternalFlowFactory$changesetFrom$1 extends showSiupNibPage implements onClickInfo<getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library<? super CollectionChange<RealmResults<T>>>, ProsesTarikanFragment<? super onCLickStatusNpwp>, Object> {
    ...
    InternalFlowFactory$changesetFrom$1(InternalFlowFactory internalFlowFactory, RealmResults realmResults, RealmConfiguration realmConfiguration, ProsesTarikanFragment prosesTarikanFragment) {
    ...
    public final ProsesTarikanFragment<onCLickStatusNpwp> create(Object obj, ProsesTarikanFragment<?> prosesTarikanFragment) {
        ...
        InternalFlowFactory$changesetFrom$1 internalFlowFactory$changesetFrom$1 = new InternalFlowFactory$changesetFrom$1(this.this$0, this.$results, this.$config, prosesTarikanFragment);
        internalFlowFactory$changesetFrom$1.p$ = (getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library) obj;
        return internalFlowFactory$changesetFrom$1;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((InternalFlowFactory$changesetFrom$1) create(obj, (ProsesTarikanFragment) obj2)).invokeSuspend(onCLickStatusNpwp.e);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            final OrderedRealmCollectionChangeListener internalFlowFactory$changesetFrom$1$listener$1 = new OrderedRealmCollectionChangeListener<RealmResults<T>>(getformattedresponsebody_com_github_chuckerteam_chucker_library) { // from class: io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$1$listener$1
                ...
                public final void onChange(RealmResults<T> realmResults, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                    ...
                    if (InternalFlowFactory.access$getReturnFrozenObjects$p(InternalFlowFactory$changesetFrom$1.this.this$0)) {
            ...
            this.$results.addChangeListener(internalFlowFactory$changesetFrom$1$listener$1);
            ...
            this.L$0 = getformattedresponsebody_com_github_chuckerteam_chucker_library;
            this.L$1 = instance;
            this.L$2 = internalFlowFactory$changesetFrom$1$listener$1;
            this.label = 2;
            if (getFormattedPath$com_github_ChuckerTeam_Chucker_library.e(getformattedresponsebody_com_github_chuckerteam_chucker_library, new pilihNoRek<onCLickStatusNpwp>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$1.2
                public final void invoke() {
                    Realm realm = instance;
                    subscribeReservationRescheduleEvent.a(realm, "");
                    if (!realm.isClosed()) {
                        InternalFlowFactory$changesetFrom$1.this.$results.removeChangeListener(internalFlowFactory$changesetFrom$1$listener$1);
                        instance.close();
                    }
                }
