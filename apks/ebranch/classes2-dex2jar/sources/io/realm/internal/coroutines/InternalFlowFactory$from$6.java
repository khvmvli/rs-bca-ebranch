...
public final class InternalFlowFactory$from$6 extends showSiupNibPage implements onClickInfo<getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library<? super RealmList<T>>, ProsesTarikanFragment<? super onCLickStatusNpwp>, Object> {
    ...
    InternalFlowFactory$from$6(InternalFlowFactory internalFlowFactory, RealmList realmList, RealmConfiguration realmConfiguration, ProsesTarikanFragment prosesTarikanFragment) {
    ...
    public final ProsesTarikanFragment<onCLickStatusNpwp> create(Object obj, ProsesTarikanFragment<?> prosesTarikanFragment) {
        ...
        InternalFlowFactory$from$6 internalFlowFactory$from$6 = new InternalFlowFactory$from$6(this.this$0, this.$realmList, this.$config, prosesTarikanFragment);
        internalFlowFactory$from$6.p$ = (getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library) obj;
        return internalFlowFactory$from$6;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((InternalFlowFactory$from$6) create(obj, (ProsesTarikanFragment) obj2)).invokeSuspend(onCLickStatusNpwp.e);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            final RealmChangeListener internalFlowFactory$from$6$listener$1 = new RealmChangeListener<RealmList<T>>(getformattedresponsebody_com_github_chuckerteam_chucker_library) { // from class: io.realm.internal.coroutines.InternalFlowFactory$from$6$listener$1
                ...
                public final void onChange(RealmList<T> realmList) {
                    ...
                    } else if (InternalFlowFactory.access$getReturnFrozenObjects$p(InternalFlowFactory$from$6.this.this$0)) {
                        realmList.freeze();
                    }
                }
            ...
            this.$realmList.addChangeListener(internalFlowFactory$from$6$listener$1);
            if (InternalFlowFactory.access$getReturnFrozenObjects$p(this.this$0)) {
                this.$realmList.freeze();
            }
            this.L$0 = getformattedresponsebody_com_github_chuckerteam_chucker_library;
            this.L$1 = instance;
            this.L$2 = internalFlowFactory$from$6$listener$1;
            this.label = 2;
            if (getFormattedPath$com_github_ChuckerTeam_Chucker_library.e(getformattedresponsebody_com_github_chuckerteam_chucker_library, new pilihNoRek<onCLickStatusNpwp>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$from$6.2
                public final void invoke() {
                    DynamicRealm dynamicRealm = instance;
                    subscribeReservationRescheduleEvent.a(dynamicRealm, "");
                    if (!dynamicRealm.isClosed()) {
                        InternalFlowFactory$from$6.this.$realmList.removeChangeListener(internalFlowFactory$from$6$listener$1);
                        instance.close();
                    }
                }
