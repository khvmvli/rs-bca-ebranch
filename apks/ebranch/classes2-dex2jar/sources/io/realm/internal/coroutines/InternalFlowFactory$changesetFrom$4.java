...
public final class InternalFlowFactory$changesetFrom$4 extends showSiupNibPage implements onClickInfo<getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library<? super CollectionChange<RealmList<T>>>, ProsesTarikanFragment<? super onCLickStatusNpwp>, Object> {
    ...
    InternalFlowFactory$changesetFrom$4(InternalFlowFactory internalFlowFactory, RealmList realmList, RealmConfiguration realmConfiguration, ProsesTarikanFragment prosesTarikanFragment) {
    ...
    public final ProsesTarikanFragment<onCLickStatusNpwp> create(Object obj, ProsesTarikanFragment<?> prosesTarikanFragment) {
        ...
        InternalFlowFactory$changesetFrom$4 internalFlowFactory$changesetFrom$4 = new InternalFlowFactory$changesetFrom$4(this.this$0, this.$list, this.$config, prosesTarikanFragment);
        internalFlowFactory$changesetFrom$4.p$ = (getFormattedResponseBody$com_github_ChuckerTeam_Chucker_library) obj;
        return internalFlowFactory$changesetFrom$4;
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((InternalFlowFactory$changesetFrom$4) create(obj, (ProsesTarikanFragment) obj2)).invokeSuspend(onCLickStatusNpwp.e);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            final OrderedRealmCollectionChangeListener internalFlowFactory$changesetFrom$4$listener$1 = new OrderedRealmCollectionChangeListener<RealmList<T>>(getformattedresponsebody_com_github_chuckerteam_chucker_library) { // from class: io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$4$listener$1
                ...
                public final void onChange(RealmList<T> realmList, OrderedCollectionChangeSet orderedCollectionChangeSet) {
                    ...
                    } else if (InternalFlowFactory.access$getReturnFrozenObjects$p(InternalFlowFactory$changesetFrom$4.this.this$0)) {
            ...
            this.$list.addChangeListener(internalFlowFactory$changesetFrom$4$listener$1);
            ...
            this.L$0 = getformattedresponsebody_com_github_chuckerteam_chucker_library;
            this.L$1 = instance;
            this.L$2 = internalFlowFactory$changesetFrom$4$listener$1;
            this.label = 2;
            if (getFormattedPath$com_github_ChuckerTeam_Chucker_library.e(getformattedresponsebody_com_github_chuckerteam_chucker_library, new pilihNoRek<onCLickStatusNpwp>() { // from class: io.realm.internal.coroutines.InternalFlowFactory$changesetFrom$4.2
                public final void invoke() {
                    DynamicRealm dynamicRealm = instance;
                    subscribeReservationRescheduleEvent.a(dynamicRealm, "");
                    if (!dynamicRealm.isClosed()) {
                        InternalFlowFactory$changesetFrom$4.this.$list.removeChangeListener(internalFlowFactory$changesetFrom$4$listener$1);
                        instance.close();
                    }
                }
