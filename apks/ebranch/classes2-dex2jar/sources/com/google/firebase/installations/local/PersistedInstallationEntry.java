...
import o.Tarikan100JutaGuestDialog_ViewBinding;
/* loaded from: classes2-dex2jar.jar:com/google/firebase/installations/local/PersistedInstallationEntry.class */
public abstract class PersistedInstallationEntry {
    public static PersistedInstallationEntry INSTANCE = builder().build();

    /* loaded from: classes2-dex2jar.jar:com/google/firebase/installations/local/PersistedInstallationEntry$Builder.class */
    ...
    public static Builder builder() {
        return new Tarikan100JutaGuestDialog_ViewBinding.write().setTokenCreationEpochInSecs(0).setRegistrationStatus(PersistedInstallation.RegistrationStatus.ATTEMPT_MIGRATION).setExpiresInSecs(0);
    }
