...
import o.clickedLogin;
import o.getNamaPengirim;
import o.getPenerimaList;
import o.realmGet;
import org.json.JSONException;
import org.json.JSONObject;
/* loaded from: classes2-dex2jar.jar:com/google/firebase/installations/remote/FirebaseInstallationServiceClient.class */
public class FirebaseInstallationServiceClient {
    ...
    private final clickedLogin requestLimiter = new clickedLogin();
    ...
    private String getFingerprintHashForPackage() {
        ...
        try {
            ...
            PackageInfo d = realmGet.jenisWarkatTransaksi.a.e(context).d(context.getPackageName(), 64);
            byte[] digest = (d.signatures == null || d.signatures.length != 1 || (e = getNamaPengirim.e("SHA1")) == null) ? null : e.digest(d.signatures[0].toByteArray());
            if (digest != null) {
                return getPenerimaList.c(digest, false);
            }
            ...
            Log.e("ContentValues", sb2.toString(), e2);
            return null;
        }
    }
    ...
    private HttpURLConnection openHttpURLConnection(URL url, String str) throws FirebaseInstallationsException {
        ...
        try {
            ...
            if (!(this.heartbeatInfo.get() == null || this.userAgentPublisher.get() == null || (heartBeatCode = ((HeartBeatInfo) this.heartbeatInfo.get()).getHeartBeatCode(FIREBASE_INSTALLATIONS_ID_HEARTBEAT_TAG)) == HeartBeatInfo.HeartBeat.NONE)) {
                httpURLConnection.addRequestProperty(USER_AGENT_HEADER, ((UserAgentPublisher) this.userAgentPublisher.get()).getUserAgent());
            ...
            for (int i = 0; i <= 1; i++) {
                ...
                try {
                    try {
                        ...
                        this.requestLimiter.d(responseCode);
                    } finally {
