...
import o.realmSet;
/* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/reporting/MessagingClientEvent.class */
public final class MessagingClientEvent {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/reporting/MessagingClientEvent$Builder.class */
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/reporting/MessagingClientEvent$Event.class */
    public enum Event implements realmSet.tipeNasabahPenerima {
        UNKNOWN_EVENT(0),
        MESSAGE_DELIVERED(1),
        MESSAGE_OPEN(2);
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/reporting/MessagingClientEvent$MessageType.class */
    public enum MessageType implements realmSet.tipeNasabahPenerima {
        UNKNOWN(0),
        DATA_MESSAGE(1),
        TOPIC(2),
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/reporting/MessagingClientEvent$SDKPlatform.class */
    public enum SDKPlatform implements realmSet.tipeNasabahPenerima {
        UNKNOWN_OS(0),
        ANDROID(1),
        IOS(2),
        WEB(3);
