...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/messaging/NotificationParams.class */
public class NotificationParams {
    ...
    public Uri getLink() {
        ...
        String str = string;
        if (TextUtils.isEmpty(string)) {
            str = getString(Constants.MessageNotificationKeys.LINK);
        }
    ...
    public String getSoundResourceName() {
        ...
        String str = string;
        if (TextUtils.isEmpty(string)) {
            str = getString(Constants.MessageNotificationKeys.SOUND);
        }
        return str;
    }
