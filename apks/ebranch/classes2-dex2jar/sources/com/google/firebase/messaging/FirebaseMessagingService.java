...
import o.TermConditionKartuKreditDialog_ViewBinding;
...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private void dispatchMessage(Intent intent) {
        ...
        if (NotificationParams.isNotification(bundle)) {
            ...
            try {
                if (!new TermConditionKartuKreditDialog_ViewBinding(this, notificationParams, newSingleThreadExecutor).e()) {
    ...
    private void passMessageIntentToSdk(Intent intent) {
        ...
        if (c == 0) {
            ...
            Log.w(Constants.TAG, str.length() != 0 ? "Received message with unknown type: ".concat(str) : new String("Received message with unknown type: "));
        } else {
