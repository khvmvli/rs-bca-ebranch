...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/analytics/BreadcrumbAnalyticsEventReceiver.class */
    ...
    public void onEvent(String str, Bundle bundle) {
        ...
        if (breadcrumbHandler != null) {
            try {
                ...
                breadcrumbHandler.handleBreadcrumb(sb.toString());
