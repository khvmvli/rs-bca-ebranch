...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/model/serialization/CrashlyticsReportJsonTransform.class */
public class CrashlyticsReportJsonTransform {
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/model/serialization/CrashlyticsReportJsonTransform$read.class */
    ...
    private static <T> ImmutableList<T> parseArray(JsonReader jsonReader, read<T> read2) throws IOException {
        ArrayList arrayList = new ArrayList();
        jsonReader.beginArray();
        while (jsonReader.hasNext()) {
            arrayList.add(read2.parse(jsonReader));
        }
        jsonReader.endArray();
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                ...
                builder.setInternalKeys(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda5
                ...
                builder.setCustomAttributes(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda5
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.read
                    public final Object parse(JsonReader jsonReader2) {
                        return CrashlyticsReportJsonTransform.parseCustomAttribute(jsonReader2);
                    }
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution parseEventExecution(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                ...
                builder.setThreads(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.read
                    public final Object parse(JsonReader jsonReader2) {
                ...
                builder.setBinaries(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda3
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.read
                    public final Object parse(JsonReader jsonReader2) {
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("files")) {
                builder.setFiles(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda4
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.read
                    public final Object parse(JsonReader jsonReader2) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    builder.setEvents(parseArray(jsonReader, new read() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda1
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.read
                        public final Object parse(JsonReader jsonReader2) {
