...
/* loaded from: classes2-dex2jar.jar:com/google/firebase/crashlytics/internal/settings/network/DefaultSettingsSpiCall.class */
public class DefaultSettingsSpiCall implements SettingsSpiCall {
    ...
    protected HttpGetRequest createHttpGetRequest(Map<String, String> map) {
        ...
        return buildHttpGetRequest.header(HEADER_USER_AGENT, sb.toString()).header("X-CRASHLYTICS-DEVELOPER-TOKEN", "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
