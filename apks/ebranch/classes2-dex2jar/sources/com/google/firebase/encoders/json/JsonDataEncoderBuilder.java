...
import o.TahapanBerjangkaDialog;
/* loaded from: classes2-dex2jar.jar:com/google/firebase/encoders/json/JsonDataEncoderBuilder.class */
public final class JsonDataEncoderBuilder implements EncoderConfig<JsonDataEncoderBuilder> {
    ...
    private static final IconCompatParcelizer TIMESTAMP_ENCODER = new IconCompatParcelizer((byte) 0);
    ...
    /* loaded from: classes2-dex2jar.jar:com/google/firebase/encoders/json/JsonDataEncoderBuilder$IconCompatParcelizer.class */
    public static final class IconCompatParcelizer implements ValueEncoder<Date> {
        ...
        public final /* synthetic */ void encode(Object obj, ValueEncoderContext valueEncoderContext) throws IOException {
            valueEncoderContext.add(e.format((Date) obj));
        }
    }
    ...
    public final DataEncoder build() {
        return new DataEncoder() { // from class: com.google.firebase.encoders.json.JsonDataEncoderBuilder.4
            ...
            public final void encode(Object obj, Writer writer) throws IOException {
                TahapanBerjangkaDialog tahapanBerjangkaDialog = new TahapanBerjangkaDialog(writer, JsonDataEncoderBuilder.this.objectEncoders, JsonDataEncoderBuilder.this.valueEncoders, JsonDataEncoderBuilder.this.fallbackEncoder, JsonDataEncoderBuilder.this.ignoreNullValues);
                tahapanBerjangkaDialog.d(obj, false);
                tahapanBerjangkaDialog.e();
                tahapanBerjangkaDialog.b.flush();
            }
        };
    }
