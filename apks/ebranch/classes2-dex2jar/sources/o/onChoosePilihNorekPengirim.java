...
public class onChoosePilihNorekPengirim implements Serializable {
    ...
    private onChoosePilihNorekPengirim(boolean z) {
        this.f = z;
    }
    ...
    public static onChoosePilihNorekPengirim d(boolean z) {
        return z ? d : e;
    }

    private static final String e(String str) throws IllegalArgumentException {
        boolean z;
        Method method;
        if (str != null) {
        ...
        z = true;
        if (!z && (method = IconCompatParcelizer.b) != null) {
            try {
