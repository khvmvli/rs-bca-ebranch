...
public final class Cookie {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x023b, code lost:
        if (r0 > okhttp3.internal.http.HttpDate.MAX_DATE) goto L_0x0244;
     */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    private static long parseMaxAge(java.lang.String r5) {
        /*
            ...
            r6 = r0
            r0 = r5
            long r0 = java.lang.Long.parseLong(r0)     // Catch: NumberFormatException -> 0x0013
            r8 = r0
            r0 = r8
            r1 = 0
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
    ...
    public final int hashCode() {
        ...
        return ((((((((((((((((hashCode + 527) * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
