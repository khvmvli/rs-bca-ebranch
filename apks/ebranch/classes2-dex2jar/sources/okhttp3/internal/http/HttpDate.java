...
/* loaded from: classes2-dex2jar.jar:okhttp3/internal/http/HttpDate.class */
    ...
    public static Date parse(String str) {
        ...
        synchronized (strArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (dateFormat == null) {
                    dateFormat2 = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i], Locale.US);
                    dateFormat2.setTimeZone(Util.UTC);
