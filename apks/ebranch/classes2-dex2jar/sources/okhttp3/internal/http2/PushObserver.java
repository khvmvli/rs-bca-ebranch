...
public interface PushObserver {
    public static final PushObserver CANCEL = new PushObserver() { // from class: okhttp3.internal.http2.PushObserver.1
        ...
        public boolean onData(int i, setTookMs settookms, int i2, boolean z) throws IOException {
            settookms.f((long) i2);
            return true;
        }
    ...
    boolean onData(int i, setTookMs settookms, int i2, boolean z) throws IOException;
